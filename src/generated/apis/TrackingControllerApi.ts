...
export class TrackingControllerApi extends runtime.BaseAPI {
     ...
     */
    async createTrackingPixelRaw(requestParameters: CreateTrackingPixelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TrackingPixelDto>> {
     ...
     * Create tracking pixel
     */
    async createTrackingPixel(requestParameters: CreateTrackingPixelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TrackingPixelDto> {
     ...
     * Get tracking pixels
     */
    async getAllTrackingPixelsRaw(requestParameters: GetAllTrackingPixelsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PageTrackingPixelProjection>> {
        const queryParameters: any = {};
     ...
     * Get tracking pixels
     */
    async getAllTrackingPixels(requestParameters: GetAllTrackingPixelsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PageTrackingPixelProjection> {
     ...
     * Get pixel
     */
    async getTrackingPixelRaw(requestParameters: GetTrackingPixelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TrackingPixelDto>> {
     ...
     * Get pixel
     */
    async getTrackingPixel(requestParameters: GetTrackingPixelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TrackingPixelDto> {
 ...
 * @export
 */
export const GetAllTrackingPixelsSortEnum = {
    ASC: 'ASC',
    DESC: 'DESC'
} as const;
