...
export class ExpiredControllerApi extends runtime.BaseAPI {
     ...
     */
    async getExpirationDefaultsRaw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<ExpirationDefaults>> {
     ...
     * Get default expiration settings
     */
    async getExpirationDefaults(initOverrides?: RequestInit): Promise<ExpirationDefaults> {
     ...
     */
    async getExpiredInboxByInboxIdRaw(requestParameters: GetExpiredInboxByInboxIdRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ExpiredInboxDto>> {
     ...
     * Get expired inbox record for a previously existing inbox
     */
    async getExpiredInboxByInboxId(requestParameters: GetExpiredInboxByInboxIdRequest, initOverrides?: RequestInit): Promise<ExpiredInboxDto> {
     ...
     */
    async getExpiredInboxRecordRaw(requestParameters: GetExpiredInboxRecordRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ExpiredInboxDto>> {
     ...
     * Get an expired inbox record
     */
    async getExpiredInboxRecord(requestParameters: GetExpiredInboxRecordRequest, initOverrides?: RequestInit): Promise<ExpiredInboxDto> {
     ...
     */
    async getExpiredInboxesRaw(requestParameters: GetExpiredInboxesRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<PageExpiredInboxRecordProjection>> {
        const queryParameters: any = {};
     ...
     * List records of expired inboxes
     */
    async getExpiredInboxes(requestParameters: GetExpiredInboxesRequest, initOverrides?: RequestInit): Promise<PageExpiredInboxRecordProjection> {
