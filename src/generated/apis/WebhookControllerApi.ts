...
export class WebhookControllerApi extends runtime.BaseAPI {
   ...
   */
  async createWebhookForAITransformerRaw(
    requestParameters: CreateWebhookForAITransformerRequest,
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<WebhookDto>> {
    if (
      requestParameters.transformerId === null ||
      requestParameters.transformerId === undefined
    ) {
      throw new runtime.RequiredError(
        'transformerId',
        'Required parameter requestParameters.transformerId was null or undefined when calling createWebhookForAITransformer.'
      );
    }
    ...
    if (
      ...
      throw new runtime.RequiredError(
        'createWebhookOptions',
        'Required parameter requestParameters.createWebhookOptions was null or undefined when calling createWebhookForAITransformer.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/ai-transformers/{transformerId}/webhooks`.replace(
          `{${'transformerId'}}`,
          encodeURIComponent(String(requestParameters.transformerId))
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
   ...
   * Attach a WebHook URL to an AI transformer
   */
  async createWebhookForAITransformer(
    requestParameters: CreateWebhookForAITransformerRequest,
    initOverrides?: RequestInit
  ): Promise<WebhookDto> {
    const response = await this.createWebhookForAITransformerRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   */
  async getTestWebhookPayloadNewAITransformResultRaw(
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<WebhookNewAITransformResultPayload>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      WebhookNewAITransformResultPayloadFromJSON(jsonValue)
    );
  }
   ...
   * Get webhook test payload for new ai transform result event
   */
  async getTestWebhookPayloadNewAITransformResult(
    initOverrides?: RequestInit
  ): Promise<WebhookNewAITransformResultPayload> {
    const response = await this.getTestWebhookPayloadNewAITransformResultRaw(
      initOverrides
    );
    return await response.value();
  }
