...
export class InboxControllerApi extends runtime.BaseAPI {
     ...
     */
    async createInboxRulesetRaw(requestParameters: CreateInboxRulesetRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<RulesetDto>> {
     ...
     * Create an inbox ruleset
     */
    async createInboxRuleset(requestParameters: CreateInboxRulesetRequest, initOverrides?: RequestInit): Promise<RulesetDto> {
     ...
     * List inbox rulesets
     */
    async listInboxRulesetsRaw(requestParameters: ListInboxRulesetsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<PageRulesetDto>> {
        if (requestParameters.inboxId === null || requestParameters.inboxId === undefined) {
     ...
     * List inbox rulesets
     */
    async listInboxRulesets(requestParameters: ListInboxRulesetsRequest, initOverrides?: RequestInit): Promise<PageRulesetDto> {
