...
export class GroupControllerApi extends runtime.BaseAPI {
     ...
     */
    async addContactsToGroupRaw(requestParameters: AddContactsToGroupRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<GroupContactsDto>> {
     ...
     * Add contacts to a group
     */
    async addContactsToGroup(requestParameters: AddContactsToGroupRequest, initOverrides?: RequestInit): Promise<GroupContactsDto> {
     ...
     * Create a group
     */
    async createGroupRaw(requestParameters: CreateGroupRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<GroupDto>> {
     ...
     * Create a group
     */
    async createGroup(requestParameters: CreateGroupRequest, initOverrides?: RequestInit): Promise<GroupDto> {
     ...
     */
    async getAllGroupsRaw(requestParameters: GetAllGroupsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<PageGroupProjection>> {
        const queryParameters: any = {};
     ...
     * Get all Contact Groups in paginated format
     */
    async getAllGroups(requestParameters: GetAllGroupsRequest, initOverrides?: RequestInit): Promise<PageGroupProjection> {
     ...
     * Get group
     */
    async getGroupRaw(requestParameters: GetGroupRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<GroupDto>> {
        if (requestParameters.groupId === null || requestParameters.groupId === undefined) {
     ...
     * Get group
     */
    async getGroup(requestParameters: GetGroupRequest, initOverrides?: RequestInit): Promise<GroupDto> {
     ...
     */
    async getGroupWithContactsRaw(requestParameters: GetGroupWithContactsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<GroupContactsDto>> {
        if (requestParameters.groupId === null || requestParameters.groupId === undefined) {
     ...
     * Get group and contacts belonging to it
     */
    async getGroupWithContacts(requestParameters: GetGroupWithContactsRequest, initOverrides?: RequestInit): Promise<GroupContactsDto> {
     ...
     */
    async getGroupWithContactsPaginatedRaw(requestParameters: GetGroupWithContactsPaginatedRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<PageContactProjection>> {
        if (requestParameters.groupId === null || requestParameters.groupId === undefined) {
     ...
     * Get group and paginated contacts belonging to it
     */
    async getGroupWithContactsPaginated(requestParameters: GetGroupWithContactsPaginatedRequest, initOverrides?: RequestInit): Promise<PageContactProjection> {
     ...
     * Get all groups
     */
    async getGroupsRaw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<Array<GroupProjection>>> {
        const queryParameters: any = {};
     ...
     * Get all groups
     */
    async getGroups(initOverrides?: RequestInit): Promise<Array<GroupProjection>> {
     ...
     */
    async removeContactsFromGroupRaw(requestParameters: RemoveContactsFromGroupRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<GroupContactsDto>> {
        if (requestParameters.groupId === null || requestParameters.groupId === undefined) {
     ...
     * Remove contacts from a group
     */
    async removeContactsFromGroup(requestParameters: RemoveContactsFromGroupRequest, initOverrides?: RequestInit): Promise<GroupContactsDto> {
