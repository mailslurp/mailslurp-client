...
export class BulkActionsControllerApi extends runtime.BaseAPI {
     ...
     */
    async bulkCreateInboxesRaw(requestParameters: BulkCreateInboxesRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Array<InboxDto>>> {
     ...
     * Bulk create Inboxes (email addresses)
     */
    async bulkCreateInboxes(requestParameters: BulkCreateInboxesRequest, initOverrides?: RequestInit): Promise<Array<InboxDto>> {
     ...
     * Bulk Delete Inboxes
     */
    async bulkDeleteInboxesRaw(requestParameters: BulkDeleteInboxesRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
     ...
     * Bulk Delete Inboxes
     */
    async bulkDeleteInboxes(requestParameters: BulkDeleteInboxesRequest, initOverrides?: RequestInit): Promise<void> {
     ...
     * Bulk Send Emails
     */
    async bulkSendEmailsRaw(requestParameters: BulkSendEmailsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
     ...
     * Bulk Send Emails
     */
    async bulkSendEmails(requestParameters: BulkSendEmailsRequest, initOverrides?: RequestInit): Promise<void> {
