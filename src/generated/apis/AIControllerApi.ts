...
export class AIControllerApi extends runtime.BaseAPI {
  ...
  async createTransformerRaw(
    ...
    if (
      requestParameters.aITransformCreateOptions === null ||
      requestParameters.aITransformCreateOptions === undefined
    ) {
      throw new runtime.RequiredError(
        'aITransformCreateOptions',
        'Required parameter requestParameters.aITransformCreateOptions was null or undefined when calling createTransformer.'
      );
    }
    ...
    const response = await this.request(
      {
        ...
        body: AITransformCreateOptionsToJSON(
          requestParameters.aITransformCreateOptions
        ),
      },
      initOverrides
    );
   ...
   */
  async deleteAllTransformerMappingsRaw(
    initOverrides?: RequestInit
   ...
   * Delete all transformer mapping
   */
  async deleteAllTransformerMappings(
    initOverrides?: RequestInit
  ): Promise<void> {
   ...
   * List transformers
   */
  async getTransformersRaw(
    requestParameters: GetTransformersRequest,
    initOverrides?: RequestInit
  ...
  async getTransformers(
    ...
    const response = await this.getTransformersRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   */
  async invokeTransformerRaw(
    requestParameters: InvokeTransformerRequest,
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<ConditionalStructuredContentResult>> {
    if (
      requestParameters.invokeTransformerOptions === null ||
      requestParameters.invokeTransformerOptions === undefined
    ) {
      throw new runtime.RequiredError(
        'invokeTransformerOptions',
        'Required parameter requestParameters.invokeTransformerOptions was null or undefined when calling invokeTransformer.'
      );
    }
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: InvokeTransformerOptionsToJSON(
          requestParameters.invokeTransformerOptions
        ),
      },
      initOverrides
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ConditionalStructuredContentResultFromJSON(jsonValue)
    );
  }
   ...
   * Invoke a transformer
   */
  async invokeTransformer(
    requestParameters: InvokeTransformerRequest,
    initOverrides?: RequestInit
  ): Promise<ConditionalStructuredContentResult> {
    const response = await this.invokeTransformerRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
