...
export class ImapControllerApi extends runtime.BaseAPI {
     ...
     */
    async imapServerFetchRaw(requestParameters: ImapServerFetchRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ImapServerFetchResult>> {
     ...
     * Fetch message in an inbox
     */
    async imapServerFetch(requestParameters: ImapServerFetchRequest, initOverrides?: RequestInit): Promise<ImapServerFetchResult> {
     ...
     */
    async imapServerGetRaw(requestParameters: ImapServerGetRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ImapServerGetResult>> {
     ...
     * Get a message by email ID
     */
    async imapServerGet(requestParameters: ImapServerGetRequest, initOverrides?: RequestInit): Promise<ImapServerGetResult> {
     ...
     */
    async imapServerListRaw(requestParameters: ImapServerListRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ImapServerListResult>> {
     ...
     * List messages in an inbox
     */
    async imapServerList(requestParameters: ImapServerListRequest, initOverrides?: RequestInit): Promise<ImapServerListResult> {
     ...
     */
    async imapServerMailboxRaw(requestParameters: ImapServerMailboxRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ImapServerMailboxResult>> {
     ...
     * Create a new mailbox if possible
     */
    async imapServerMailbox(requestParameters: ImapServerMailboxRequest, initOverrides?: RequestInit): Promise<ImapServerMailboxResult> {
     ...
     */
    async imapServerSearchRaw(requestParameters: ImapServerSearchRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ImapServerSearchResult>> {
     ...
     * Search messages in an inbox
     */
    async imapServerSearch(requestParameters: ImapServerSearchRequest, initOverrides?: RequestInit): Promise<ImapServerSearchResult> {
     ...
     */
    async imapServerStatusRaw(requestParameters: ImapServerStatusRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ImapServerStatusResult>> {
     ...
     * Get status for mailbox
     */
    async imapServerStatus(requestParameters: ImapServerStatusRequest, initOverrides?: RequestInit): Promise<ImapServerStatusResult> {
     ...
     */
    async imapServerUpdateFlagsRaw(requestParameters: ImapServerUpdateFlagsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
     ...
     * Update message flags
     */
    async imapServerUpdateFlags(requestParameters: ImapServerUpdateFlagsRequest, initOverrides?: RequestInit): Promise<void> {
