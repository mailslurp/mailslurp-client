...
export class WaitForControllerApi extends runtime.BaseAPI {
     ...
     */
    async waitForMatchingEmailRaw(
        requestParameters: WaitForMatchingEmailRequest
    ): Promise<runtime.ApiResponse<Array<EmailPreview>>> {
        if (
            ...
            throw new runtime.RequiredError(
                'matchOptions',
                'Required parameter requestParameters.matchOptions was null or undefined when calling waitForMatchingEmail.'
            );
        }
