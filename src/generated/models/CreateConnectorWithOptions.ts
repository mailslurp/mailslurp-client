...
export function CreateConnectorWithOptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateConnectorWithOptions {
    ...
    return {
        ...
        'createConnectorImapConnectionOptions': !exists(json, 'createConnectorImapConnectionOptions') ? undefined : CreateConnectorImapConnectionOptionsFromJSON(json['createConnectorImapConnectionOptions']),
        'createConnectorSmtpConnectionOptions': !exists(json, 'createConnectorSmtpConnectionOptions') ? undefined : CreateConnectorSmtpConnectionOptionsFromJSON(json['createConnectorSmtpConnectionOptions']),
        'createConnectorSyncSettingsOptions': !exists(json, 'createConnectorSyncSettingsOptions') ? undefined : CreateConnectorSyncSettingsOptionsFromJSON(json['createConnectorSyncSettingsOptions']),
    };
}

export function CreateConnectorWithOptionsToJSON(value?: CreateConnectorWithOptions | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
