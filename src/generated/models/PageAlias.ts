...
import {
    ...
    AliasProjectionToJSONTyped,
} from './AliasProjection';
 ...
 */
export function instanceOfPageAlias(value: object): value is PageAlias {
...
export function PageAliasFromJSONTyped(json: any, ignoreDiscriminator: boolean): PageAlias {
    ...
    return {
        ...
        'content': json['content'] == null ? undefined : ((json['content'] as Array<any>).map(AliasProjectionFromJSON)),
...
export function PageAliasToJSON(json: any): PageAlias {
    return PageAliasToJSONTyped(json, false);
}

export function PageAliasToJSONTyped(value?: PageAlias | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'content': value['content'] == null ? undefined : ((value['content'] as Array<any>).map(AliasProjectionToJSON)),
