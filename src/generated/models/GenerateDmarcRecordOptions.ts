...
export function GenerateDmarcRecordOptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): GenerateDmarcRecordOptions {
    ...
    return {
        ...
        'policy': json['policy'],
        'subdomainPolicy': !exists(json, 'subdomainPolicy') ? undefined : json['subdomainPolicy'],
        'reportEmailAddress': !exists(json, 'reportEmailAddress') ? undefined : json['reportEmailAddress'],
        'forensicEmailAddress': !exists(json, 'forensicEmailAddress') ? undefined : json['forensicEmailAddress'],
        'percentage': !exists(json, 'percentage') ? undefined : json['percentage'],
        'reportFormat': !exists(json, 'reportFormat') ? undefined : json['reportFormat'],
        'secondsBetweenReports': !exists(json, 'secondsBetweenReports') ? undefined : json['secondsBetweenReports'],
...
export function GenerateDmarcRecordOptionsToJSON(value?: GenerateDmarcRecordOptions | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
