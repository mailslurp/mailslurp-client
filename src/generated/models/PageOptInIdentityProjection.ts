...
export function PageOptInIdentityProjectionFromJSON(json: any): PageOptInIdentityProjection {
    return PageOptInIdentityProjectionFromJSONTyped(json, false);
}

export function PageOptInIdentityProjectionFromJSONTyped(json: any, ignoreDiscriminator: boolean): PageOptInIdentityProjection {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'content': !exists(json, 'content') ? undefined : ((json['content'] as Array<any>).map(OptInIdentityProjectionFromJSON)),
...
export function PageOptInIdentityProjectionToJSON(value?: PageOptInIdentityProjection | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'content': value.content === undefined ? undefined : ((value.content as Array<any>).map(OptInIdentityProjectionToJSON)),
