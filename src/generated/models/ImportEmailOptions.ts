...
export function ImportEmailOptionsFromJSON(json: any): ImportEmailOptions {
  return ImportEmailOptionsFromJSONTyped(json, false);
}

export function ImportEmailOptionsFromJSONTyped(
  json: any,
  ...
  return {
    ...
    runPipeline: !exists(json, 'runPipeline') ? undefined : json['runPipeline'],
    overrideMessageId: !exists(json, 'overrideMessageId')
      ? undefined
      : json['overrideMessageId'],
  };
}

export function ImportEmailOptionsToJSON(
  value?: ImportEmailOptions | null
): any {
  if (value === undefined) {
    return undefined;
  }
