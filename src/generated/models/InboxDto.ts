 ...
 * @export
 */
export const InboxDtoInboxTypeEnum = {
 ...
 * @export
 */
export const InboxDtoFunctionsAsEnum = {
    ALIAS: 'ALIAS',
    THREAD: 'THREAD',
    CATCH_ALL: 'CATCH_ALL',
    CONNECTOR: 'CONNECTOR',
 ...
 */
export function instanceOfInboxDto(value: object): value is InboxDto {
...
export function InboxDtoToJSON(json: any): InboxDto {
    return InboxDtoToJSONTyped(json, false);
}

export function InboxDtoToJSONTyped(value?: InboxDto | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
