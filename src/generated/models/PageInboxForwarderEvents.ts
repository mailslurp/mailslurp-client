...
export function PageInboxForwarderEventsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PageInboxForwarderEvents {
    ...
    return {
        ...
        'content': !exists(json, 'content') ? undefined : ((json['content'] as Array<any>).map(InboxForwarderEventProjectionFromJSON)),
...
export function PageInboxForwarderEventsToJSON(value?: PageInboxForwarderEvents | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'content': value.content === undefined ? undefined : ((value.content as Array<any>).map(InboxForwarderEventProjectionToJSON)),
