...
import type { EmailFeatureFamilyStatistics } from './EmailFeatureFamilyStatistics';
import {
    EmailFeatureFamilyStatisticsFromJSON,
    EmailFeatureFamilyStatisticsFromJSONTyped,
    EmailFeatureFamilyStatisticsToJSON,
    EmailFeatureFamilyStatisticsToJSONTyped,
} from './EmailFeatureFamilyStatistics';
 ...
 * @export
 */
export const EmailFeatureOverviewFeatureEnum = {
    amp: 'amp',
...
export type EmailFeatureOverviewFeatureEnum = typeof EmailFeatureOverviewFeatureEnum[keyof typeof EmailFeatureOverviewFeatureEnum];

/**
 * @export
 */
export const EmailFeatureOverviewCategoryEnum = {
    css: 'css',
    html: 'html',
    image: 'image',
    others: 'others'
} as const;
export type EmailFeatureOverviewCategoryEnum = typeof EmailFeatureOverviewCategoryEnum[keyof typeof EmailFeatureOverviewCategoryEnum];

/**
 * @export
 */
export const EmailFeatureOverviewStatusesEnum = {
    SUPPORTED: 'SUPPORTED',
    PARTIAL: 'PARTIAL',
    NOT_SUPPORTED: 'NOT_SUPPORTED',
    UNKNOWN: 'UNKNOWN'
} as const;
export type EmailFeatureOverviewStatusesEnum = typeof EmailFeatureOverviewStatusesEnum[keyof typeof EmailFeatureOverviewStatusesEnum];


/**
 * Check if a given object implements the EmailFeatureOverview interface.
 */
export function instanceOfEmailFeatureOverview(value: object): value is EmailFeatureOverview {
...
export function EmailFeatureOverviewFromJSONTyped(json: any, ignoreDiscriminator: boolean): EmailFeatureOverview {
    if (json == null) {
        return json;
    }
    return {
        ...
        'notesNumbers': json['notesNumbers'] == null ? undefined : json['notesNumbers'],
        'featureStatistics': json['featureStatistics'] == null ? undefined : ((json['featureStatistics'] as Array<any>).map(EmailFeatureFamilyStatisticsFromJSON)),
        'statuses': new Set(json['statuses']),
    };
}

export function EmailFeatureOverviewToJSON(json: any): EmailFeatureOverview {
    return EmailFeatureOverviewToJSONTyped(json, false);
}

export function EmailFeatureOverviewToJSONTyped(value?: EmailFeatureOverview | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'featureStatistics': value['featureStatistics'] == null ? undefined : ((value['featureStatistics'] as Array<any>).map(EmailFeatureFamilyStatisticsToJSON)),
        'statuses': Array.from(value['statuses'] as Set<any>),
    };
}
