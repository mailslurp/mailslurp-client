...
export function EmailFeatureOverviewFromJSONTyped(json: any, ignoreDiscriminator: boolean): EmailFeatureOverview {
    ...
    return {
        ...
        'notesNumbers': !exists(json, 'notesNumbers') ? undefined : json['notesNumbers'],
        'featureStatistics': !exists(json, 'featureStatistics') ? undefined : ((json['featureStatistics'] as Array<any>).map(EmailFeatureFamilyStatisticsFromJSON)),
        'statuses': json['statuses'],
    };
}

export function EmailFeatureOverviewToJSON(value?: EmailFeatureOverview | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'featureStatistics': value.featureStatistics === undefined ? undefined : ((value.featureStatistics as Array<any>).map(EmailFeatureFamilyStatisticsToJSON)),
