...
export function PagePlusAddressProjectionFromJSONTyped(json: any, ignoreDiscriminator: boolean): PagePlusAddressProjection {
    ...
    return {
        ...
        'content': !exists(json, 'content') ? undefined : ((json['content'] as Array<any>).map(PlusAddressProjectionFromJSON)),
...
export function PagePlusAddressProjectionToJSON(value?: PagePlusAddressProjection | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'content': value.content === undefined ? undefined : ((value.content as Array<any>).map(PlusAddressProjectionToJSON)),
