...
import type { GroupProjection } from './GroupProjection';
import {
    GroupProjectionFromJSON,
    GroupProjectionFromJSONTyped,
    GroupProjectionToJSON,
    GroupProjectionToJSONTyped,
 ...
 */
export function instanceOfPageGroupProjection(value: object): value is PageGroupProjection {
...
export function PageGroupProjectionFromJSONTyped(json: any, ignoreDiscriminator: boolean): PageGroupProjection {
    ...
    return {
        ...
        'content': json['content'] == null ? undefined : ((json['content'] as Array<any>).map(GroupProjectionFromJSON)),
...
export function PageGroupProjectionToJSON(json: any): PageGroupProjection {
    return PageGroupProjectionToJSONTyped(json, false);
}

export function PageGroupProjectionToJSONTyped(value?: PageGroupProjection | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'content': value['content'] == null ? undefined : ((value['content'] as Array<any>).map(GroupProjectionToJSON)),
