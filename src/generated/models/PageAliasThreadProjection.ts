...
import {
    ...
    AliasThreadProjectionToJSONTyped,
} from './AliasThreadProjection';
 ...
 */
export function instanceOfPageAliasThreadProjection(value: object): value is PageAliasThreadProjection {
...
export function PageAliasThreadProjectionFromJSONTyped(json: any, ignoreDiscriminator: boolean): PageAliasThreadProjection {
    ...
    return {
        ...
        'content': json['content'] == null ? undefined : ((json['content'] as Array<any>).map(AliasThreadProjectionFromJSON)),
...
export function PageAliasThreadProjectionToJSON(json: any): PageAliasThreadProjection {
    return PageAliasThreadProjectionToJSONTyped(json, false);
}

export function PageAliasThreadProjectionToJSONTyped(value?: PageAliasThreadProjection | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'content': value['content'] == null ? undefined : ((value['content'] as Array<any>).map(AliasThreadProjectionToJSON)),
