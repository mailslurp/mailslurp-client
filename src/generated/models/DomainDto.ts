...
export function DomainDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): DomainDto {
    ...
    return {
        ...
        'duplicateRecordsMessage': !exists(json, 'duplicateRecordsMessage') ? undefined : json['duplicateRecordsMessage'],
        'hasDuplicateRecords': json['hasDuplicateRecords'],
        'missingRecordsMessage': !exists(json, 'missingRecordsMessage') ? undefined : json['missingRecordsMessage'],
