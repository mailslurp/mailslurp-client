...
export function SendEmailOptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): SendEmailOptions {
    ...
    return {
        ...
        'filterBouncedRecipients': !exists(json, 'filterBouncedRecipients') ? undefined : json['filterBouncedRecipients'],
        'validateEmailAddresses': !exists(json, 'validateEmailAddresses') ? undefined : json['validateEmailAddresses'],
        'ignoreEmptyRecipients': !exists(json, 'ignoreEmptyRecipients') ? undefined : json['ignoreEmptyRecipients'],
        'isXAmpHtml': !exists(json, 'isXAmpHtml') ? undefined : json['isXAmpHtml'],
        'bodyParts': !exists(json, 'bodyParts') ? undefined : (json['bodyParts'] === null ? null : (json['bodyParts'] as Array<any>).map(SendEmailBodyPartFromJSON)),
    };
}
...
export function SendEmailOptionsToJSON(value?: SendEmailOptions | null): any {
    ...
    return {
        ...
        'bodyParts': value.bodyParts === undefined ? undefined : (value.bodyParts === null ? null : (value.bodyParts as Array<any>).map(SendEmailBodyPartToJSON)),
    };
}
