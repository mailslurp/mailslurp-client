...
import {
    ...
    EmailFeaturePlatformStatisticsToJSONTyped,
} from './EmailFeaturePlatformStatistics';
 ...
 * @export
 */
export const EmailFeatureFamilyStatisticsFeatureEnum = {
    amp: 'amp',
 ...
 * @export
 */
export const EmailFeatureFamilyStatisticsFamilyEnum = {
    aol: 'aol',
 ...
 */
export function instanceOfEmailFeatureFamilyStatistics(value: object): value is EmailFeatureFamilyStatistics {
...
export function EmailFeatureFamilyStatisticsFromJSON(json: any): EmailFeatureFamilyStatistics {
    return EmailFeatureFamilyStatisticsFromJSONTyped(json, false);
}

export function EmailFeatureFamilyStatisticsFromJSONTyped(json: any, ignoreDiscriminator: boolean): EmailFeatureFamilyStatistics {
    if (json == null) {
        return json;
    }
    return {
        ...
        'family': json['family'],
        'platforms': ((json['platforms'] as Array<any>).map(EmailFeaturePlatformStatisticsFromJSON)),
    };
}

export function EmailFeatureFamilyStatisticsToJSON(json: any): EmailFeatureFamilyStatistics {
    return EmailFeatureFamilyStatisticsToJSONTyped(json, false);
}

export function EmailFeatureFamilyStatisticsToJSONTyped(value?: EmailFeatureFamilyStatistics | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'family': value['family'],
        'platforms': ((value['platforms'] as Array<any>).map(EmailFeaturePlatformStatisticsToJSON)),
    };
}
