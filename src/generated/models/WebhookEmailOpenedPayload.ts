 ...
 * @export
 */
export const WebhookEmailOpenedPayloadEventNameEnum = {
...
export type WebhookEmailOpenedPayloadEventNameEnum = typeof WebhookEmailOpenedPayloadEventNameEnum[keyof typeof WebhookEmailOpenedPayloadEventNameEnum];


/**
 * Check if a given object implements the WebhookEmailOpenedPayload interface.
 */
export function instanceOfWebhookEmailOpenedPayload(value: object): value is WebhookEmailOpenedPayload {
    ...
    if (!('pixelId' in value) || value['pixelId'] === undefined) return false;
    if (!('sentEmailId' in value) || value['sentEmailId'] === undefined) return false;
...
export function WebhookEmailOpenedPayloadToJSON(json: any): WebhookEmailOpenedPayload {
    return WebhookEmailOpenedPayloadToJSONTyped(json, false);
}

export function WebhookEmailOpenedPayloadToJSONTyped(value?: WebhookEmailOpenedPayload | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
