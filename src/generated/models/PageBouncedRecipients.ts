...
import {
    ...
    BounceRecipientProjectionToJSONTyped,
} from './BounceRecipientProjection';
 ...
 */
export function instanceOfPageBouncedRecipients(value: object): value is PageBouncedRecipients {
...
export function PageBouncedRecipientsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PageBouncedRecipients {
    ...
    return {
        ...
        'content': json['content'] == null ? undefined : ((json['content'] as Array<any>).map(BounceRecipientProjectionFromJSON)),
...
export function PageBouncedRecipientsToJSON(json: any): PageBouncedRecipients {
    return PageBouncedRecipientsToJSONTyped(json, false);
}

export function PageBouncedRecipientsToJSONTyped(value?: PageBouncedRecipients | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'content': value['content'] == null ? undefined : ((value['content'] as Array<any>).map(BounceRecipientProjectionToJSON)),
