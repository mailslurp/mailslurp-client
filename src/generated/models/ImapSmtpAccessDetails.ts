...
export function ImapSmtpAccessDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ImapSmtpAccessDetails {
    ...
    return {
        ...
        'mailFromDomain': !exists(json, 'mailFromDomain') ? undefined : json['mailFromDomain'],
    };
}

export function ImapSmtpAccessDetailsToJSON(value?: ImapSmtpAccessDetails | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
