 ...
 */
export function instanceOfPageContactProjection(value: object): value is PageContactProjection {
...
export function PageContactProjectionFromJSONTyped(json: any, ignoreDiscriminator: boolean): PageContactProjection {
    ...
    return {
        ...
        'content': json['content'] == null ? undefined : ((json['content'] as Array<any>).map(ContactProjectionFromJSON)),
...
export function PageContactProjectionToJSON(json: any): PageContactProjection {
    return PageContactProjectionToJSONTyped(json, false);
}

export function PageContactProjectionToJSONTyped(value?: PageContactProjection | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'content': value['content'] == null ? undefined : ((value['content'] as Array<any>).map(ContactProjectionToJSON)),
