...
export function ImapServerSearchOptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ImapServerSearchOptions {
    ...
    return {
        ...
        'sentSince': !exists(json, 'sentSince') ? undefined : (json['sentSince'] === null ? null : new Date(json['sentSince'])),
        'sentBefore': !exists(json, 'sentBefore') ? undefined : (json['sentBefore'] === null ? null : new Date(json['sentBefore'])),
        'header': !exists(json, 'header') ? undefined : json['header'],
        'body': !exists(json, 'body') ? undefined : json['body'],
        'text': !exists(json, 'text') ? undefined : json['text'],
        'withFlags': !exists(json, 'withFlags') ? undefined : json['withFlags'],
        'withoutFlags': !exists(json, 'withoutFlags') ? undefined : json['withoutFlags'],
    };
}

export function ImapServerSearchOptionsToJSON(value?: ImapServerSearchOptions | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
