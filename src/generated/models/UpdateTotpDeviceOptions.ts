...
export function UpdateTotpDeviceOptionsFromJSON(
  json: any
): UpdateTotpDeviceOptions {
  return UpdateTotpDeviceOptionsFromJSONTyped(json, false);
}

export function UpdateTotpDeviceOptionsFromJSONTyped(
  json: any,
...
export function UpdateTotpDeviceOptionsToJSON(
  value?: UpdateTotpDeviceOptions | null
): any {
  if (value === undefined) {
    return undefined;
  }
