 ...
 * @export
 */
export const DNSLookupResultRecordTypeEnum = {
    A: 'A',
    NS: 'NS',
    MD: 'MD',
    MF: 'MF',
 ...
 */
export function instanceOfDNSLookupResult(value: object): value is DNSLookupResult {
...
export function DNSLookupResultToJSON(json: any): DNSLookupResult {
    return DNSLookupResultToJSONTyped(json, false);
}

export function DNSLookupResultToJSONTyped(value?: DNSLookupResult | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
