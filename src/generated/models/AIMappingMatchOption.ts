 ...
 * @enum {string}
 */
export enum AIMappingMatchOptionFieldEnum {
  SUBJECT = 'SUBJECT',
  TO = 'TO',
  BCC = 'BCC',
  CC = 'CC',
 ...
 * @enum {string}
 */
export enum AIMappingMatchOptionShouldEnum {
  MATCH = 'MATCH',
  CONTAIN = 'CONTAIN',
  EQUAL = 'EQUAL',
}

export function AIMappingMatchOptionFromJSON(json: any): AIMappingMatchOption {
  return AIMappingMatchOptionFromJSONTyped(json, false);
}

export function AIMappingMatchOptionFromJSONTyped(
  json: any,
...
export function AIMappingMatchOptionToJSON(
