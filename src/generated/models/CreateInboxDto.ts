 ...
 * @export
 */
export const CreateInboxDtoInboxTypeEnum = {
 ...
 */
export function instanceOfCreateInboxDto(value: object): value is CreateInboxDto {
    return true;
}
...
export function CreateInboxDtoToJSON(json: any): CreateInboxDto {
    return CreateInboxDtoToJSONTyped(json, false);
}

export function CreateInboxDtoToJSONTyped(value?: CreateInboxDto | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
