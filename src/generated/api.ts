...
export class CommonActionsControllerApi extends BaseAPI {
    ...
    public createNewEmailAddress(
        ...
        return CommonActionsControllerApiFp(
            this.configuration
        ).createNewEmailAddress(expiresAt, expiresIn, useDomainPool, options)(
            this.fetch,
            this.basePath
        );
    }
    ...
    public createNewEmailAddress1(
        ...
        return CommonActionsControllerApiFp(
            this.configuration
        ).createNewEmailAddress1(expiresAt, expiresIn, useDomainPool, options)(
            this.fetch,
            this.basePath
        );
    }
    ...
    return {
        ...
        getExpiredInboxRecordById(
            ...
            if (expiredId === null || expiredId === undefined) {
                throw new RequiredError(
                    'expiredId',
                    'Required parameter expiredId was null or undefined when calling getExpiredInboxRecordById.'
                );
            }
            const localVarPath = `/inboxes/expired-records/{expiredId}`.replace(
                `{${'expiredId'}}`,
        ...
        getExpiredInboxRecordByInboxId(
            ...
            if (inboxId === null || inboxId === undefined) {
                throw new RequiredError(
                    'inboxId',
                    'Required parameter inboxId was null or undefined when calling getExpiredInboxRecordByInboxId.'
                );
            }
            const localVarPath = `/inboxes/{inboxId}/expired-record`.replace(
                `{${'inboxId'}}`,
                encodeURIComponent(String(inboxId))
            );
            const localVarUrlObj = url.parse(localVarPath, true);
        ...
        getExpiredInboxRecords(
            ...
            const localVarPath = `/inboxes/expired-records`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign(
                { method: 'GET' },
                options
...
export const InboxControllerApiFp = function(configuration?: Configuration) {
    return {
        ...
        getExpiredInboxRecordById(
            ...
            const localVarFetchArgs = InboxControllerApiFetchParamCreator(
                configuration
            ).getExpiredInboxRecordById(expiredId, options);
            return (
                fetch: FetchAPI = portableFetch,
                basePath: string = BASE_PATH
            ) => {
        ...
        getExpiredInboxRecordByInboxId(
            ...
            const localVarFetchArgs = InboxControllerApiFetchParamCreator(
                configuration
            ).getExpiredInboxRecordByInboxId(inboxId, options);
            return (
                fetch: FetchAPI = portableFetch,
                basePath: string = BASE_PATH
            ) => {
        ...
        getExpiredInboxRecords(
            ...
            const localVarFetchArgs = InboxControllerApiFetchParamCreator(
                configuration
            ).getExpiredInboxRecords(page, size, sort, options);
            return (
                fetch: FetchAPI = portableFetch,
                basePath: string = BASE_PATH
            ) => {
...
export const InboxControllerApiFactory = function(
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getExpiredInboxRecordById(expiredId: string, options?: any) {
            return InboxControllerApiFp(
                configuration
            ).getExpiredInboxRecordById(expiredId, options)(fetch, basePath);
        },
        /**
         * Use the inboxId to return an ExpiredInboxRecord if an inbox has expired. Inboxes expire and are disabled if an expiration date is set or plan requires. Returns 404 if no expired inbox is found for the inboxId
         * @summary Get expired inbox record for a previously existing inbox
         ...
         * @throws {RequiredError}
         */
        getExpiredInboxRecordByInboxId(inboxId: string, options?: any) {
            return InboxControllerApiFp(
                configuration
            ).getExpiredInboxRecordByInboxId(inboxId, options)(fetch, basePath);
        },
        /**
         * Inboxes created with an expiration date will expire after the given date. An ExpiredInboxRecord is created that records the inboxes old ID and email address. You can still read emails in the inbox (using the inboxes old ID) but the email address associated with the inbox can no longer send or receive emails. Fetch expired inbox records to view the old inboxes properties
         * @summary List records of expired inboxes
        ...
        getExpiredInboxRecords(
            ...
            return InboxControllerApiFp(configuration).getExpiredInboxRecords(
                page,
                size,
                sort,
                options
...
export class InboxControllerApi extends BaseAPI {
     ...
     * @memberof InboxControllerApi
     */
    public getExpiredInboxRecordById(expiredId: string, options?: any) {
        return InboxControllerApiFp(
            this.configuration
        ).getExpiredInboxRecordById(expiredId, options)(
            this.fetch,
     ...
     * @memberof InboxControllerApi
     */
    public getExpiredInboxRecordByInboxId(inboxId: string, options?: any) {
        return InboxControllerApiFp(
            this.configuration
        ).getExpiredInboxRecordByInboxId(inboxId, options)(
            this.fetch,
     ...
     * @memberof InboxControllerApi
     */
    public getExpiredInboxRecords(
        page?: number,
        size?: number,
        sort?: 'ASC' | 'DESC',
        options?: any
    ) {
        return InboxControllerApiFp(this.configuration).getExpiredInboxRecords(
            page,
            size,
            sort,
            options
