 ...
 */
export namespace ConditionOption {
    /**
     * @export
     * @enum {string}
     */
    export enum ConditionEnum {
        HASATTACHMENTS = <any>'HAS_ATTACHMENTS',
    }
    /**
     * @export
     * @enum {string}
 ...
 */
export namespace CreateInboxRulesetOptions {
    /**
     * @export
     * @enum {string}
     */
    export enum ActionEnum {
        BLOCK = <any>'BLOCK',
        ALLOW = <any>'ALLOW',
        FILTERREMOVE = <any>'FILTER_REMOVE',
    }
    /**
     * @export
     * @enum {string}
    ...
    export enum ScopeEnum {
        RECEIVINGEMAILS = <any>'RECEIVING_EMAILS',
        SENDINGEMAILS = <any>'SENDING_EMAILS',
    }
}
 ...
 */
export namespace InboxRulesetDto {
    /**
     * @export
     * @enum {string}
     */
 ...
 */
export namespace WebhookNewAttachmentPayload {
    /**
     * @export
     * @enum {string}
     */
 ...
 */
export namespace WebhookNewContactPayload {
    /**
     * @export
     * @enum {string}
     */
 ...
 */
export namespace WebhookNewEmailPayload {
    /**
     * @export
     * @enum {string}
     */
...
export const EmailControllerApiFactory = function(
    ...
    return {
        ...
        sendEmailSourceOptional(
            ...
            return EmailControllerApiFp(configuration).sendEmailSourceOptional(
                inboxId,
                sendEmailOptions,
                useDomainPool,
                options
...
export class EmailControllerApi extends BaseAPI {
     ...
     * @memberof EmailControllerApi
     */
    public sendEmailSourceOptional(
        inboxId?: string,
        sendEmailOptions?: SendEmailOptions,
        useDomainPool?: boolean,
        options?: any
    ) {
        return EmailControllerApiFp(this.configuration).sendEmailSourceOptional(
            inboxId,
            sendEmailOptions,
            useDomainPool,
            options
 ...
 * @export
 */
export const ExportControllerApiFetchParamCreator = function(
    configuration?: Configuration
) {
    return {
        /**
        ...
        exportEntities(
            ...
            if (createdEarliestTime !== undefined) {
                localVarQueryParameter[
                    'createdEarliestTime'
                ] = (createdEarliestTime as any).toISOString();
            }

            if (createdOldestTime !== undefined) {
                localVarQueryParameter[
                    'createdOldestTime'
                ] = (createdOldestTime as any).toISOString();
            }
...
export const ExportControllerApiFp = function(configuration?: Configuration) {
    return {
        ...
        exportEntities(
            ...
            const localVarFetchArgs = ExportControllerApiFetchParamCreator(
                configuration
            ).exportEntities(
                apiKey,
                exportType,
        ...
        getExportLink(
            ...
            apiKey?: string,
            options?: any
        ): (fetch?: FetchAPI, basePath?: string) => Promise<ExportLink> {
            const localVarFetchArgs = ExportControllerApiFetchParamCreator(
                configuration
            ).getExportLink(exportOptions, exportType, apiKey, options);
            return (
                fetch: FetchAPI = portableFetch,
                basePath: string = BASE_PATH
            ) => {
...
export const ExportControllerApiFactory = function(
    ...
    return {
        ...
        exportEntities(
            ...
            return ExportControllerApiFp(configuration).exportEntities(
                apiKey,
                exportType,
                outputFormat,
                createdEarliestTime,
        ...
        getExportLink(
            ...
            return ExportControllerApiFp(configuration).getExportLink(
                exportOptions,
                exportType,
                apiKey,
                options
...
export class ExportControllerApi extends BaseAPI {
    ...
    public exportEntities(
        ...
        return ExportControllerApiFp(this.configuration).exportEntities(
            apiKey,
            exportType,
            outputFormat,
            createdEarliestTime,
    ...
    public getExportLink(
        ...
        return ExportControllerApiFp(this.configuration).getExportLink(
            exportOptions,
            exportType,
            apiKey,
            options
...
export const InboxControllerApiFetchParamCreator = function(
    ...
    return {
        ...
        createInboxRuleset(
            ...
            const localVarPath = `/inboxes/{inboxId}/rulesets`.replace(
                `{${'inboxId'}}`,
                encodeURIComponent(String(inboxId))
            );
            const localVarUrlObj = url.parse(localVarPath, true);
            ...
            const needsSerialization =
                <any>'CreateInboxRulesetOptions' !== 'string' ||
                localVarRequestOptions.headers['Content-Type'] ===
                    'application/json';
            localVarRequestOptions.body = needsSerialization
...
export const InboxControllerApiFactory = function(
    ...
    return {
        ...
        createInboxRuleset(
            ...
            return InboxControllerApiFp(configuration).createInboxRuleset(
                createInboxRulesetOptions,
                inboxId,
                options
            )(fetch, basePath);
...
export class InboxControllerApi extends BaseAPI {
     ...
     * @memberof InboxControllerApi
     */
    public createInboxRuleset(
        createInboxRulesetOptions: CreateInboxRulesetOptions,
        inboxId: string,
        options?: any
    ) {
        return InboxControllerApiFp(this.configuration).createInboxRuleset(
            createInboxRulesetOptions,
            inboxId,
            options
        )(this.fetch, this.basePath);
 ...
 * @export
 */
export const InboxRulesetControllerApiFetchParamCreator = function(
    configuration?: Configuration
) {
    return {
        /**
        ...
        deleteInboxRuleset(id: string, options: any = {}): FetchArgs {
            ...
            const localVarPath = `/rulesets/{id}`.replace(
                `{${'id'}}`,
                encodeURIComponent(String(id))
            );
            const localVarUrlObj = url.parse(localVarPath, true);
        ...
        testInboxRuleset(
            ...
            const localVarPath = `/rulesets/{id}/test`.replace(
                `{${'id'}}`,
                encodeURIComponent(String(id))
            );
            const localVarUrlObj = url.parse(localVarPath, true);
            ...
            const needsSerialization =
                <any>'InboxRulesetTestOptions' !== 'string' ||
                localVarRequestOptions.headers['Content-Type'] ===
                    'application/json';
            localVarRequestOptions.body = needsSerialization
        ...
        testNewInboxRuleset(
            ...
            if (
                testNewInboxRulesetOptions === null ||
            ...
            const needsSerialization =
                <any>'TestNewInboxRulesetOptions' !== 'string' ||
                localVarRequestOptions.headers['Content-Type'] ===
                    'application/json';
            localVarRequestOptions.body = needsSerialization
 ...
 * @export
 */
export const InboxRulesetControllerApiFp = function(
    configuration?: Configuration
) {
    return {
        /**
        ...
        deleteInboxRulesets(
            ...
            const localVarFetchArgs = InboxRulesetControllerApiFetchParamCreator(
                configuration
            ).deleteInboxRulesets(inboxId, options);
            return (
                fetch: FetchAPI = portableFetch,
                basePath: string = BASE_PATH
            ) => {
        ...
        testInboxRuleset(
            ...
            const localVarFetchArgs = InboxRulesetControllerApiFetchParamCreator(
                configuration
            ).testInboxRuleset(id, inboxRulesetTestOptions, options);
            return (
                fetch: FetchAPI = portableFetch,
                basePath: string = BASE_PATH
            ) => {
        ...
        testNewInboxRuleset(
            ...
            const localVarFetchArgs = InboxRulesetControllerApiFetchParamCreator(
                configuration
            ).testNewInboxRuleset(testNewInboxRulesetOptions, options);
            return (
                fetch: FetchAPI = portableFetch,
                basePath: string = BASE_PATH
            ) => {
 ...
 * @export
 */
export const InboxRulesetControllerApiFactory = function(
    configuration?: Configuration,
    fetch?: FetchAPI,
    basePath?: string
) {
    return {
         ...
         * @throws {RequiredError}
         */
        deleteInboxRuleset(id: string, options?: any) {
            return InboxRulesetControllerApiFp(
                configuration
            ).deleteInboxRuleset(id, options)(fetch, basePath);
        },
        /**
         * Delete inbox rulesets. Accepts optional inboxId filter.
         * @summary Delete inbox rulesets
         ...
         * @throws {RequiredError}
         */
        deleteInboxRulesets(inboxId?: string, options?: any) {
            return InboxRulesetControllerApiFp(
                configuration
            ).deleteInboxRulesets(inboxId, options)(fetch, basePath);
        },
        /**
         * Get inbox ruleset
         * @summary Get an inbox ruleset
         ...
         * @throws {RequiredError}
         */
        getInboxRuleset(id: string, options?: any) {
            return InboxRulesetControllerApiFp(configuration).getInboxRuleset(
                id,
                options
            )(fetch, basePath);
        },
        ...
        testInboxRuleset(
            ...
            return InboxRulesetControllerApiFp(configuration).testInboxRuleset(
                id,
                inboxRulesetTestOptions,
                options
            )(fetch, basePath);
 ...
 * @extends {BaseAPI}
 */
export class InboxRulesetControllerApi extends BaseAPI {
    /**
     * Create a new inbox rule for forwarding, blocking, and allowing emails when sending and receiving
     * @summary Create an inbox ruleset
     * @param {CreateInboxRulesetOptions} createInboxRulesetOptions createInboxRulesetOptions
     ...
     * @memberof InboxRulesetControllerApi
     */
    public deleteInboxRuleset(id: string, options?: any) {
        return InboxRulesetControllerApiFp(
            this.configuration
        ).deleteInboxRuleset(id, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof InboxRulesetControllerApi
     */
    public deleteInboxRulesets(inboxId?: string, options?: any) {
        return InboxRulesetControllerApiFp(
            this.configuration
        ).deleteInboxRulesets(inboxId, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof InboxRulesetControllerApi
     */
    public getInboxRuleset(id: string, options?: any) {
        return InboxRulesetControllerApiFp(this.configuration).getInboxRuleset(
            id,
            options
        )(this.fetch, this.basePath);
    }
     ...
     * @memberof InboxRulesetControllerApi
     */
    public testInboxRuleset(
        id: string,
        inboxRulesetTestOptions: InboxRulesetTestOptions,
        options?: any
    ) {
        return InboxRulesetControllerApiFp(this.configuration).testInboxRuleset(
            id,
            inboxRulesetTestOptions,
            options
        )(this.fetch, this.basePath);
     ...
     * @memberof InboxRulesetControllerApi
     */
    public testInboxRulesetsForInbox(
        inboxId: string,
        inboxRulesetTestOptions: InboxRulesetTestOptions,
        options?: any
    ) {
 ...
 * @export
 */
export const TrackingControllerApiFetchParamCreator = function(
    configuration?: Configuration
) {
    return {
        /**
        ...
        createTrackingPixel(
            ...
            if (
                createTrackingPixelOptions === null ||
                createTrackingPixelOptions === undefined
            ) {
                throw new RequiredError(
                    'createTrackingPixelOptions',
                    'Required parameter createTrackingPixelOptions was null or undefined when calling createTrackingPixel.'
                );
            }
            ...
            const needsSerialization =
                <any>'CreateTrackingPixelOptions' !== 'string' ||
                localVarRequestOptions.headers['Content-Type'] ===
                    'application/json';
            localVarRequestOptions.body = needsSerialization
        ...
        getTrackingPixel(id: string, options: any = {}): FetchArgs {
            ...
            if (id === null || id === undefined) {
                throw new RequiredError(
                    'id',
                    'Required parameter id was null or undefined when calling getTrackingPixel.'
                );
            }
            const localVarPath = `/tracking/pixels/{id}`.replace(
                `{${'id'}}`,
                encodeURIComponent(String(id))
            );
            const localVarUrlObj = url.parse(localVarPath, true);
...
export const TrackingControllerApiFp = function(configuration?: Configuration) {
    return {
        ...
        createTrackingPixel(
            createTrackingPixelOptions: CreateTrackingPixelOptions,
            options?: any
        ): (fetch?: FetchAPI, basePath?: string) => Promise<TrackingPixelDto> {
            const localVarFetchArgs = TrackingControllerApiFetchParamCreator(
                configuration
            ).createTrackingPixel(createTrackingPixelOptions, options);
            return (
                fetch: FetchAPI = portableFetch,
                basePath: string = BASE_PATH
            ) => {
 ...
 * @export
 */
export const TrackingControllerApiFactory = function(
    configuration?: Configuration,
    fetch?: FetchAPI,
    basePath?: string
) {
    return {
        ...
        createTrackingPixel(
            ...
            return TrackingControllerApiFp(configuration).createTrackingPixel(
                createTrackingPixelOptions,
                options
            )(fetch, basePath);
        },
         ...
         * @throws {RequiredError}
         */
        getTrackingPixel(id: string, options?: any) {
            return TrackingControllerApiFp(configuration).getTrackingPixel(
                id,
                options
            )(fetch, basePath);
        },
...
export class TrackingControllerApi extends BaseAPI {
     ...
     */
    public createTrackingPixel(
        createTrackingPixelOptions: CreateTrackingPixelOptions,
        options?: any
    ) {
        return TrackingControllerApiFp(this.configuration).createTrackingPixel(
            createTrackingPixelOptions,
            options
        )(this.fetch, this.basePath);
    }
     ...
     * @memberof TrackingControllerApi
     */
    public getTrackingPixel(id: string, options?: any) {
        return TrackingControllerApiFp(this.configuration).getTrackingPixel(
            id,
            options
        )(this.fetch, this.basePath);
    }
...
export const WebhookControllerApiFetchParamCreator = function(
    ...
    return {
        ...
        getInboxWebhooksPaginated(
            ...
            const localVarPath = `/inboxes/{inboxId}/webhooks/paginated`.replace(
                `{${'inboxId'}}`,
                encodeURIComponent(String(inboxId))
            );
            const localVarUrlObj = url.parse(localVarPath, true);
        ...
        getWebhookResult(
            ...
            const localVarPath = `/webhooks/results/{webhookResultId}`.replace(
                `{${'webhookResultId'}}`,
        ...
        getWebhookResults(
            ...
            const localVarPath = `/webhooks/{webhookId}/results`.replace(
                `{${'webhookId'}}`,
                encodeURIComponent(String(webhookId))
            );
            const localVarUrlObj = url.parse(localVarPath, true);
...
export const WebhookControllerApiFp = function(configuration?: Configuration) {
    return {
        ...
        getTestWebhookPayloadNewAttachment(
            ...
            const localVarFetchArgs = WebhookControllerApiFetchParamCreator(
                configuration
            ).getTestWebhookPayloadNewAttachment(options);
            return (
                fetch: FetchAPI = portableFetch,
                basePath: string = BASE_PATH
            ) => {
        ...
        getTestWebhookPayloadNewContact(
            ...
            const localVarFetchArgs = WebhookControllerApiFetchParamCreator(
                configuration
            ).getTestWebhookPayloadNewContact(options);
            return (
                fetch: FetchAPI = portableFetch,
                basePath: string = BASE_PATH
            ) => {
        ...
        getTestWebhookPayloadNewEmail(
            ...
            const localVarFetchArgs = WebhookControllerApiFetchParamCreator(
                configuration
            ).getTestWebhookPayloadNewEmail(options);
            return (
                fetch: FetchAPI = portableFetch,
                basePath: string = BASE_PATH
            ) => {
...
export const WebhookControllerApiFactory = function(
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getTestWebhookPayloadNewAttachment(options?: any) {
            return WebhookControllerApiFp(
                configuration
            ).getTestWebhookPayloadNewAttachment(options)(fetch, basePath);
        },
        /**
         *
         * @summary Get webhook test payload for new contact event
         ...
         * @throws {RequiredError}
         */
        getTestWebhookPayloadNewContact(options?: any) {
            return WebhookControllerApiFp(
                configuration
            ).getTestWebhookPayloadNewContact(options)(fetch, basePath);
        },
        /**
         *
         * @summary Get webhook test payload for new email event
         ...
         * @throws {RequiredError}
         */
        getTestWebhookPayloadNewEmail(options?: any) {
            return WebhookControllerApiFp(
                configuration
            ).getTestWebhookPayloadNewEmail(options)(fetch, basePath);
        },
        /**
         *
         * @summary Get a webhook for an Inbox
         ...
         * @throws {RequiredError}
         */
        getWebhookResult(webhookResultId: string, options?: any) {
            return WebhookControllerApiFp(configuration).getWebhookResult(
                webhookResultId,
                options
            )(fetch, basePath);
        },
...
export class WebhookControllerApi extends BaseAPI {
     ...
     * @memberof WebhookControllerApi
     */
    public getTestWebhookPayloadNewAttachment(options?: any) {
        return WebhookControllerApiFp(
            this.configuration
        ).getTestWebhookPayloadNewAttachment(options)(
            this.fetch,
     ...
     * @memberof WebhookControllerApi
     */
    public getTestWebhookPayloadNewContact(options?: any) {
        return WebhookControllerApiFp(
            this.configuration
        ).getTestWebhookPayloadNewContact(options)(this.fetch, this.basePath);
    }
     ...
     * @memberof WebhookControllerApi
     */
    public getTestWebhookPayloadNewEmail(options?: any) {
        return WebhookControllerApiFp(
            this.configuration
        ).getTestWebhookPayloadNewEmail(options)(this.fetch, this.basePath);
    }
     ...
     * @memberof WebhookControllerApi
     */
    public getWebhookResult(webhookResultId: string, options?: any) {
        return WebhookControllerApiFp(this.configuration).getWebhookResult(
            webhookResultId,
            options
        )(this.fetch, this.basePath);
    }
