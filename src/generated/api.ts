 ...
 */
export namespace InboxRulesetProjection {
    /**
     * @export
     * @enum {string}
     */
...
export const InboxControllerApiFp = function(configuration?: Configuration) {
    return {
        ...
        listInboxRulesets(
            ...
            const localVarFetchArgs = InboxControllerApiFetchParamCreator(
                configuration
            ).listInboxRulesets(inboxId, page, size, sort, options);
            return (
                fetch: FetchAPI = portableFetch,
                basePath: string = BASE_PATH
            ) => {
...
export const InboxRulesetControllerApiFp = function(
    ...
    return {
        ...
        getInboxRulesets(
            ...
            fetch?: FetchAPI,
            basePath?: string
        ) => Promise<PageInboxRulesetProjection> {
            const localVarFetchArgs = InboxRulesetControllerApiFetchParamCreator(
                configuration
            ).getInboxRulesets(inboxId, page, size, sort, options);
            return (
                fetch: FetchAPI = portableFetch,
                basePath: string = BASE_PATH
            ) => {
    ...
    return {
        ...
        getAllMissedEmails(
            ...
            const localVarFetchArgs = MissedEmailControllerApiFetchParamCreator(
                configuration
            ).getAllMissedEmails(page, searchFilter, size, sort, options);
            return (
                fetch: FetchAPI = portableFetch,
                basePath: string = BASE_PATH
            ) => {
