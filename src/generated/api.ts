...
export const AliasControllerApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        createAlias(createOwnedAliasOptions: CreateOwnedAliasOptions, options: any = {}): FetchArgs {
            ...
            const needsSerialization = (<any>"CreateOwnedAliasOptions" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
        ...
        createAnonymousAlias(createAnonymousAliasOptions: CreateAnonymousAliasOptions, options: any = {}): FetchArgs {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"CreateAnonymousAliasOptions" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
...
export const AliasControllerApiFp = function(configuration?: Configuration) {
    return {
        ...
        createAlias(createOwnedAliasOptions: CreateOwnedAliasOptions, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
            const localVarFetchArgs = AliasControllerApiFetchParamCreator(configuration).createAlias(createOwnedAliasOptions, options);
        ...
        createAnonymousAlias(createAnonymousAliasOptions: CreateAnonymousAliasOptions, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Alias> {
            const localVarFetchArgs = AliasControllerApiFetchParamCreator(configuration).createAnonymousAlias(createAnonymousAliasOptions, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
        ...
        updateAlias(aliasId: string, createOwnedAliasOptions: CreateOwnedAliasOptions, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
            const localVarFetchArgs = AliasControllerApiFetchParamCreator(configuration).updateAlias(aliasId, createOwnedAliasOptions, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response;
...
export const AliasControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        createAlias(createOwnedAliasOptions: CreateOwnedAliasOptions, options?: any) {
            return AliasControllerApiFp(configuration).createAlias(createOwnedAliasOptions, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Create an anonymous email alias
         ...
         * @throws {RequiredError}
         */
        createAnonymousAlias(createAnonymousAliasOptions: CreateAnonymousAliasOptions, options?: any) {
            return AliasControllerApiFp(configuration).createAnonymousAlias(createAnonymousAliasOptions, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Delete an owned alias
         ...
         * @throws {RequiredError}
         */
        updateAlias(aliasId: string, createOwnedAliasOptions: CreateOwnedAliasOptions, options?: any) {
            return AliasControllerApiFp(configuration).updateAlias(aliasId, createOwnedAliasOptions, options)(fetch, basePath);
        },
    };
};
...
export class AliasControllerApi extends BaseAPI {
     ...
     */
    public createAlias(createOwnedAliasOptions: CreateOwnedAliasOptions, options?: any) {
        return AliasControllerApiFp(this.configuration).createAlias(createOwnedAliasOptions, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof AliasControllerApi
     */
    public createAnonymousAlias(createAnonymousAliasOptions: CreateAnonymousAliasOptions, options?: any) {
        return AliasControllerApiFp(this.configuration).createAnonymousAlias(createAnonymousAliasOptions, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof AliasControllerApi
     */
    public updateAlias(aliasId: string, createOwnedAliasOptions: CreateOwnedAliasOptions, options?: any) {
        return AliasControllerApiFp(this.configuration).updateAlias(aliasId, createOwnedAliasOptions, options)(this.fetch, this.basePath);
    }
...
export const CommonActionsControllerApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createNewEmailAddress1(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Inbox> {
            const localVarFetchArgs = CommonActionsControllerApiFetchParamCreator(configuration).createNewEmailAddress1(options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const CommonActionsControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        ...
        createNewEmailAddress1(options?: any) {
            return CommonActionsControllerApiFp(configuration).createNewEmailAddress1(options)(fetch, basePath);
        },
        /**
         * Deletes all emails
         * @summary Delete all emails in an inbox
...
export class CommonActionsControllerApi extends BaseAPI {
    ...
    public createNewEmailAddress1(options?: any) {
        return CommonActionsControllerApiFp(this.configuration).createNewEmailAddress1(options)(this.fetch, this.basePath);
    }
...
export const EmailControllerApiFp = function(configuration?: Configuration) {
    return {
        ...
        getAttachments(emailId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<AttachmentMetaData>> {
            const localVarFetchArgs = EmailControllerApiFetchParamCreator(configuration).getAttachments(emailId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const EmailControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        ...
        getAttachments(emailId: string, options?: any) {
            return EmailControllerApiFp(configuration).getAttachments(emailId, options)(fetch, basePath);
        },
        /**
         * Returns a email summary object with headers and content. To retrieve the raw unparsed email use the getRawEmail endpoints
         * @summary Get email content
...
export class EmailControllerApi extends BaseAPI {
    ...
    public getAttachments(emailId: string, options?: any) {
        return EmailControllerApiFp(this.configuration).getAttachments(emailId, options)(this.fetch, this.basePath);
    }
...
export const FormControllerApiFp = function(configuration?: Configuration) {
    return {
        ...
        submitForm(emailAddress?: string, redirectTo?: string, spamCheck?: string, subject?: string, successMessage?: string, to?: string, toAlias?: string, otherParameters?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<string> {
            const localVarFetchArgs = FormControllerApiFetchParamCreator(configuration).submitForm(emailAddress, redirectTo, spamCheck, subject, successMessage, to, toAlias, otherParameters, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const FormControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        submitForm(emailAddress?: string, redirectTo?: string, spamCheck?: string, subject?: string, successMessage?: string, to?: string, toAlias?: string, otherParameters?: string, options?: any) {
            return FormControllerApiFp(configuration).submitForm(emailAddress, redirectTo, spamCheck, subject, successMessage, to, toAlias, otherParameters, options)(fetch, basePath);
        },
    };
};
...
export class FormControllerApi extends BaseAPI {
     ...
     */
    public submitForm(emailAddress?: string, redirectTo?: string, spamCheck?: string, subject?: string, successMessage?: string, to?: string, toAlias?: string, otherParameters?: string, options?: any) {
        return FormControllerApiFp(this.configuration).submitForm(emailAddress, redirectTo, spamCheck, subject, successMessage, to, toAlias, otherParameters, options)(this.fetch, this.basePath);
    }
...
export const InboxControllerApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createInbox(description?: string, emailAddress?: string, expiresAt?: Date, favourite?: boolean, name?: string, tags?: Array<string>, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Inbox> {
            const localVarFetchArgs = InboxControllerApiFetchParamCreator(configuration).createInbox(description, emailAddress, expiresAt, favourite, name, tags, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getAllInboxes(favourite?: boolean, page?: number, search?: string, size?: number, sort?: 'ASC' | 'DESC', tag?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PageInboxProjection> {
            const localVarFetchArgs = InboxControllerApiFetchParamCreator(configuration).getAllInboxes(favourite, page, search, size, sort, tag, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getEmails(inboxId: string, limit?: number, minCount?: number, retryTimeout?: number, since?: Date, sort?: 'ASC' | 'DESC', options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<EmailPreview>> {
            const localVarFetchArgs = InboxControllerApiFetchParamCreator(configuration).getEmails(inboxId, limit, minCount, retryTimeout, since, sort, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const InboxControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        createInbox(description?: string, emailAddress?: string, expiresAt?: Date, favourite?: boolean, name?: string, tags?: Array<string>, options?: any) {
            return InboxControllerApiFp(configuration).createInbox(description, emailAddress, expiresAt, favourite, name, tags, options)(fetch, basePath);
        },
        /**
         * Permanently delete all inboxes and associated email addresses. This will also delete all emails within the inboxes. Be careful as inboxes cannot be recovered once deleted. Note: deleting inboxes will not impact your usage limits. Monthly inbox creation limits are based on how many inboxes were created in the last 30 days, not how many inboxes you currently have.
         * @summary Delete all inboxes
         ...
         * @throws {RequiredError}
         */
        getAllInboxes(favourite?: boolean, page?: number, search?: string, size?: number, sort?: 'ASC' | 'DESC', tag?: string, options?: any) {
            return InboxControllerApiFp(configuration).getAllInboxes(favourite, page, search, size, sort, tag, options)(fetch, basePath);
        },
        /**
         * List emails that an inbox has received. Only emails that are sent to the inbox's email address will appear in the inbox. It may take several seconds for any email you send to an inbox's email address to appear in the inbox. To make this endpoint wait for a minimum number of emails use the `minCount` parameter. The server will retry the inbox database until the `minCount` is satisfied or the `retryTimeout` is reached
         * @summary Get emails in an Inbox
         ...
         * @throws {RequiredError}
         */
        getEmails(inboxId: string, limit?: number, minCount?: number, retryTimeout?: number, since?: Date, sort?: 'ASC' | 'DESC', options?: any) {
            return InboxControllerApiFp(configuration).getEmails(inboxId, limit, minCount, retryTimeout, since, sort, options)(fetch, basePath);
        },
        /**
         * Returns an inbox's properties, including its email address and ID.
         * @summary Get Inbox
...
export class InboxControllerApi extends BaseAPI {
     ...
     */
    public createInbox(description?: string, emailAddress?: string, expiresAt?: Date, favourite?: boolean, name?: string, tags?: Array<string>, options?: any) {
        return InboxControllerApiFp(this.configuration).createInbox(description, emailAddress, expiresAt, favourite, name, tags, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof InboxControllerApi
     */
    public getAllInboxes(favourite?: boolean, page?: number, search?: string, size?: number, sort?: 'ASC' | 'DESC', tag?: string, options?: any) {
        return InboxControllerApiFp(this.configuration).getAllInboxes(favourite, page, search, size, sort, tag, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof InboxControllerApi
     */
    public getEmails(inboxId: string, limit?: number, minCount?: number, retryTimeout?: number, since?: Date, sort?: 'ASC' | 'DESC', options?: any) {
        return InboxControllerApiFp(this.configuration).getEmails(inboxId, limit, minCount, retryTimeout, since, sort, options)(this.fetch, this.basePath);
    }
