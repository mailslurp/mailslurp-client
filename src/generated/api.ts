 ...
 * @export
 */
export const ApiFormControllerApiFetchParamCreator = function(
    configuration?: Configuration
) {
    return {
        /**
        ...
        submitForm(
            ...
            if (to === null || to === undefined) {
                throw new RequiredError(
                    'to',
                    'Required parameter to was null or undefined when calling submitForm.'
                );
            }
            ...
            if (redirectTo !== undefined) {
                localVarFormParams.set('redirectTo', redirectTo as any);
            }
            ...
            if (spamCheck !== undefined) {
                localVarFormParams.set('spamCheck', spamCheck as any);
            }
 ...
 * @export
 */
export const ApiFormControllerApiFp = function(configuration?: Configuration) {
    return {
        /**
         * Submit a URL encoded form to be used to send an email
         * @summary Send email from form inputs
        ...
        submitForm(
            ...
            const localVarFetchArgs = ApiFormControllerApiFetchParamCreator(
                configuration
            ).submitForm(
                to,
                bcc,
 ...
 * @export
 */
export const ApiFormControllerApiFactory = function(
    configuration?: Configuration,
    fetch?: FetchAPI,
    basePath?: string
) {
    return {
        ...
        submitForm(
            ...
            return ApiFormControllerApiFp(configuration).submitForm(
                to,
                bcc,
                body,
                cc,
 ...
 * @extends {BaseAPI}
 */
export class ApiFormControllerApi extends BaseAPI {
    /**
     * Submit a URL encoded form to be used to send an email
     * @summary Send email from form inputs
     * @param {string} to Email recipient email address
    ...
    public submitForm(
        ...
        return ApiFormControllerApiFp(this.configuration).submitForm(
            to,
            bcc,
            body,
            cc,
...
export const AttachmentControllerApiFp = function(
    ...
    return {
        ...
        uploadMultipartForm(
            ...
            const localVarFetchArgs = AttachmentControllerApiFetchParamCreator(
                configuration
            ).uploadMultipartForm(file, contentType, filename, options);
            return (
                fetch: FetchAPI = portableFetch,
                basePath: string = BASE_PATH
            ) => {
    ...
    return {
        ...
        sendEmailSimple(
            ...
            if (sendEmailOptions === null || sendEmailOptions === undefined) {
                throw new RequiredError(
                    'sendEmailOptions',
                    'Required parameter sendEmailOptions was null or undefined when calling sendEmailSimple.'
                );
            }
...
export const CommonActionsControllerApiFp = function(
    ...
    return {
        ...
        sendEmailSimple(
            ...
            const localVarFetchArgs = CommonActionsControllerApiFetchParamCreator(
                configuration
            ).sendEmailSimple(sendEmailOptions, options);
            return (
                fetch: FetchAPI = portableFetch,
                basePath: string = BASE_PATH
            ) => {
