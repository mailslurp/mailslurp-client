 ...
 *
 * OpenAPI spec version: 9131ba2d8c8aff721bd9dd6fcbcde229d561c637
 * 
 *
 ...
 * @export
 */
export const AliasControllerApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        /**
        ...
        createAlias(createAliasOptions: CreateAliasOptions, options: any = {}): FetchArgs {
            ...
            const needsSerialization = (<any>"CreateAliasOptions" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(createAliasOptions || {}) : (createAliasOptions || "");
        ...
        replyToAliasEmail(aliasId: string, emailId: string, replyToAliasEmailOptions: ReplyToAliasEmailOptions, options: any = {}): FetchArgs {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"ReplyToAliasEmailOptions" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(replyToAliasEmailOptions || {}) : (replyToAliasEmailOptions || "");
        ...
        updateAlias(aliasId: string, updateAliasOptions: UpdateAliasOptions, options: any = {}): FetchArgs {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"UpdateAliasOptions" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(updateAliasOptions || {}) : (updateAliasOptions || "");
...
export const AliasControllerApiFp = function(configuration?: Configuration) {
    return {
        ...
        createAlias(createAliasOptions: CreateAliasOptions, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<AliasDto> {
            const localVarFetchArgs = AliasControllerApiFetchParamCreator(configuration).createAlias(createAliasOptions, options);
        ...
        deleteAlias(aliasId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
            const localVarFetchArgs = AliasControllerApiFetchParamCreator(configuration).deleteAlias(aliasId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response;
        ...
        getAlias(aliasId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<AliasDto> {
            const localVarFetchArgs = AliasControllerApiFetchParamCreator(configuration).getAlias(aliasId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getAliasEmails(aliasId: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PageEmailProjection> {
            const localVarFetchArgs = AliasControllerApiFetchParamCreator(configuration).getAliasEmails(aliasId, page, size, sort, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getAliasThreads(aliasId: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PageThreadProjection> {
            const localVarFetchArgs = AliasControllerApiFetchParamCreator(configuration).getAliasThreads(aliasId, page, size, sort, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getAliases(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PageAlias> {
            const localVarFetchArgs = AliasControllerApiFetchParamCreator(configuration).getAliases(page, size, sort, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        replyToAliasEmail(aliasId: string, emailId: string, replyToAliasEmailOptions: ReplyToAliasEmailOptions, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SentEmailDto> {
            const localVarFetchArgs = AliasControllerApiFetchParamCreator(configuration).replyToAliasEmail(aliasId, emailId, replyToAliasEmailOptions, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        sendAliasEmail(aliasId: string, sendEmailOptions?: SendEmailOptions, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SentEmailDto> {
            const localVarFetchArgs = AliasControllerApiFetchParamCreator(configuration).sendAliasEmail(aliasId, sendEmailOptions, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        updateAlias(aliasId: string, updateAliasOptions: UpdateAliasOptions, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
            const localVarFetchArgs = AliasControllerApiFetchParamCreator(configuration).updateAlias(aliasId, updateAliasOptions, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response;
 ...
 * @export
 */
export const AliasControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * Email aliases use a MailSlurp randomly generated email address (or a custom domain inbox that you provide) to mask or proxy a real email address. Emails sent to the alias address will be forwarded to the hidden email address it was created for. If you want to send a reply use the threadId attached
         * @summary Create an email alias. Must be verified by clicking link inside verification email that will be sent to the address. Once verified the alias will be active.
        ...
        createAlias(createAliasOptions: CreateAliasOptions, options?: any) {
            return AliasControllerApiFp(configuration).createAlias(createAliasOptions, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Delete an email alias
        ...
        deleteAlias(aliasId: string, options?: any) {
            return AliasControllerApiFp(configuration).deleteAlias(aliasId, options)(fetch, basePath);
        },
        /**
         * Get an email alias by ID
         * @summary Get an email alias
        ...
        getAlias(aliasId: string, options?: any) {
            return AliasControllerApiFp(configuration).getAlias(aliasId, options)(fetch, basePath);
        },
        /**
         * Get paginated emails for an alias by ID
         * @summary Get emails for an alias
         ...
         * @throws {RequiredError}
         */
        getAliasEmails(aliasId: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
            return AliasControllerApiFp(configuration).getAliasEmails(aliasId, page, size, sort, options)(fetch, basePath);
        },
        /**
         * Returns threads created for an email alias in paginated form
         * @summary Get threads created for an alias
         ...
         * @throws {RequiredError}
         */
        getAliasThreads(aliasId: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
            return AliasControllerApiFp(configuration).getAliasThreads(aliasId, page, size, sort, options)(fetch, basePath);
        },
        /**
         * Get all email aliases in paginated form
         * @summary Get all email aliases you have created
         ...
         * @throws {RequiredError}
         */
        getAliases(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
            return AliasControllerApiFp(configuration).getAliases(page, size, sort, options)(fetch, basePath);
        },
        /**
         * Send the reply to the email sender or reply-to and include same subject cc bcc etc. Reply to an email and the contents will be sent with the existing subject to the emails `to`, `cc`, and `bcc`.
         * @summary Reply to an email
         ...
         * @throws {RequiredError}
         */
        replyToAliasEmail(aliasId: string, emailId: string, replyToAliasEmailOptions: ReplyToAliasEmailOptions, options?: any) {
            return AliasControllerApiFp(configuration).replyToAliasEmail(aliasId, emailId, replyToAliasEmailOptions, options)(fetch, basePath);
        },
        /**
         * Send an email from an alias. Replies to the email will be forwarded to the alias masked email address
         * @summary Send an email from an alias inbox
         ...
         * @throws {RequiredError}
         */
        sendAliasEmail(aliasId: string, sendEmailOptions?: SendEmailOptions, options?: any) {
            return AliasControllerApiFp(configuration).sendAliasEmail(aliasId, sendEmailOptions, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Update an email alias
         ...
         * @throws {RequiredError}
         */
        updateAlias(aliasId: string, updateAliasOptions: UpdateAliasOptions, options?: any) {
            return AliasControllerApiFp(configuration).updateAlias(aliasId, updateAliasOptions, options)(fetch, basePath);
        },
    };
};
...
export class AliasControllerApi extends BaseAPI {
    ...
    public createAlias(createAliasOptions: CreateAliasOptions, options?: any) {
        return AliasControllerApiFp(this.configuration).createAlias(createAliasOptions, options)(this.fetch, this.basePath);
    }
    ...
    public deleteAlias(aliasId: string, options?: any) {
        return AliasControllerApiFp(this.configuration).deleteAlias(aliasId, options)(this.fetch, this.basePath);
    }
    ...
    public getAlias(aliasId: string, options?: any) {
        return AliasControllerApiFp(this.configuration).getAlias(aliasId, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof AliasControllerApi
     */
    public getAliasEmails(aliasId: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
        return AliasControllerApiFp(this.configuration).getAliasEmails(aliasId, page, size, sort, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof AliasControllerApi
     */
    public getAliasThreads(aliasId: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
        return AliasControllerApiFp(this.configuration).getAliasThreads(aliasId, page, size, sort, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof AliasControllerApi
     */
    public getAliases(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
        return AliasControllerApiFp(this.configuration).getAliases(page, size, sort, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof AliasControllerApi
     */
    public replyToAliasEmail(aliasId: string, emailId: string, replyToAliasEmailOptions: ReplyToAliasEmailOptions, options?: any) {
        return AliasControllerApiFp(this.configuration).replyToAliasEmail(aliasId, emailId, replyToAliasEmailOptions, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof AliasControllerApi
     */
    public sendAliasEmail(aliasId: string, sendEmailOptions?: SendEmailOptions, options?: any) {
        return AliasControllerApiFp(this.configuration).sendAliasEmail(aliasId, sendEmailOptions, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof AliasControllerApi
     */
    public updateAlias(aliasId: string, updateAliasOptions: UpdateAliasOptions, options?: any) {
        return AliasControllerApiFp(this.configuration).updateAlias(aliasId, updateAliasOptions, options)(this.fetch, this.basePath);
    }
...
export const AttachmentControllerApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getAttachments(page?: number, size?: number, sort?: 'ASC' | 'DESC', options: any = {}): FetchArgs {
        ...
        uploadAttachmentBytes(string?: string, byteArray?: string, filename?: string, options: any = {}): FetchArgs {
            ...
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(byteArray || {}) : (byteArray || "");
...
export const AttachmentControllerApiFp = function(configuration?: Configuration) {
    return {
        ...
        deleteAttachment(attachmentId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
            const localVarFetchArgs = AttachmentControllerApiFetchParamCreator(configuration).deleteAttachment(attachmentId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response;
        ...
        downloadAttachmentAsBase64Encoded(attachmentId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<DownloadAttachmentDto> {
            const localVarFetchArgs = AttachmentControllerApiFetchParamCreator(configuration).downloadAttachmentAsBase64Encoded(attachmentId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        downloadAttachmentAsBytes(attachmentId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<string> {
            const localVarFetchArgs = AttachmentControllerApiFetchParamCreator(configuration).downloadAttachmentAsBytes(attachmentId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getAttachmentInfo(attachmentId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<AttachmentMetaData> {
            const localVarFetchArgs = AttachmentControllerApiFetchParamCreator(configuration).getAttachmentInfo(attachmentId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getAttachments(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PageAttachmentEntity> {
            const localVarFetchArgs = AttachmentControllerApiFetchParamCreator(configuration).getAttachments(page, size, sort, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        uploadAttachment(uploadOptions: UploadAttachmentOptions, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<string>> {
            const localVarFetchArgs = AttachmentControllerApiFetchParamCreator(configuration).uploadAttachment(uploadOptions, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        uploadAttachmentBytes(string?: string, byteArray?: string, filename?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<string>> {
            const localVarFetchArgs = AttachmentControllerApiFetchParamCreator(configuration).uploadAttachmentBytes(string, byteArray, filename, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        uploadMultipartForm(file: any, contentType?: string, contentTypeHeader?: string, filename?: string, xFilename?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<string>> {
            const localVarFetchArgs = AttachmentControllerApiFetchParamCreator(configuration).uploadMultipartForm(file, contentType, contentTypeHeader, filename, xFilename, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const AttachmentControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        ...
        deleteAttachment(attachmentId: string, options?: any) {
            return AttachmentControllerApiFp(configuration).deleteAttachment(attachmentId, options)(fetch, basePath);
        },
        /**
         * Returns the specified attachment for a given email as a base 64 encoded string. The response type is application/json. This method is similar to the `downloadAttachment` method but allows some clients to get around issues with binary responses.
         * @summary Get email attachment as base64 encoded string as alternative to binary responses. To read the content decode the Base64 encoded contents.
        ...
        downloadAttachmentAsBase64Encoded(attachmentId: string, options?: any) {
            return AttachmentControllerApiFp(configuration).downloadAttachmentAsBase64Encoded(attachmentId, options)(fetch, basePath);
        },
        /**
         * Returns the specified attachment for a given email as a stream / array of bytes. You can find attachment ids in email responses endpoint responses. The response type is application/octet-stream.
         * @summary Download attachments. Get email attachment bytes. If you have trouble with byte responses try the `downloadAttachmentBase64` response endpoints.
        ...
        downloadAttachmentAsBytes(attachmentId: string, options?: any) {
            return AttachmentControllerApiFp(configuration).downloadAttachmentAsBytes(attachmentId, options)(fetch, basePath);
        },
        /**
         * Returns the metadata for an attachment. It is saved separately to the content of the attachment. Contains properties `name` and `content-type` and `content-length` in bytes for a given attachment.
         * @summary Get email attachment metadata information
        ...
        getAttachmentInfo(attachmentId: string, options?: any) {
            return AttachmentControllerApiFp(configuration).getAttachmentInfo(attachmentId, options)(fetch, basePath);
        },
        /**
         * Get all attachments in paginated response. Each entity contains meta data for the attachment such as `name` and `content-type`. Use the `attachmentId` and the download endpoints to get the file contents.
         * @summary Get email attachments
         ...
         * @throws {RequiredError}
         */
        getAttachments(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
            return AttachmentControllerApiFp(configuration).getAttachments(page, size, sort, options)(fetch, basePath);
        },
        /**
         * Email attachments are essentially files with meta data. Files are byte arrays and the meta data is a content type and a filename. These properties allow email clients to display the filename and icon etc. When sending emails with attachments first upload each attachment with an upload endpoint. Record the returned attachment ID and use it with subsequent email sending. For legacy reasons the ID is returned as the first element in an array. Only a single ID is ever returned. To send the attachments pass a list of attachment IDs with `SendEmailOptions` when sending an email. Using the upload endpoints prior to sending mean attachments can easily be reused.
         * @summary Upload an attachment for sending using base64 file encoding. Returns an array whose first element is the ID of the uploaded attachment.
         ...
         * @throws {RequiredError}
         */
        uploadAttachment(uploadOptions: UploadAttachmentOptions, options?: any) {
            return AttachmentControllerApiFp(configuration).uploadAttachment(uploadOptions, options)(fetch, basePath);
        },
        /**
         * Email attachments are essentially files with meta data. Files are byte arrays and the meta data is a content type and a filename. These properties allow email clients to display the filename and icon etc. When sending emails with attachments first upload each attachment with an upload endpoint. Record the returned attachment ID and use it with subsequent email sending. For legacy reasons the ID is returned as the first element in an array. Only a single ID is ever returned. To send the attachments pass a list of attachment IDs with `SendEmailOptions` when sending an email. Using the upload endpoints prior to sending mean attachments can easily be reused.
         * @summary Upload an attachment for sending using file byte stream input octet stream. Returns an array whose first element is the ID of the uploaded attachment.
         ...
         * @throws {RequiredError}
         */
        uploadAttachmentBytes(string?: string, byteArray?: string, filename?: string, options?: any) {
            return AttachmentControllerApiFp(configuration).uploadAttachmentBytes(string, byteArray, filename, options)(fetch, basePath);
        },
        /**
         * Email attachments are essentially files with meta data. Files are byte arrays and the meta data is a content type and a filename. These properties allow email clients to display the filename and icon etc. When sending emails with attachments first upload each attachment with an upload endpoint. Record the returned attachment ID and use it with subsequent email sending. For legacy reasons the ID is returned as the first element in an array. Only a single ID is ever returned. To send the attachments pass a list of attachment IDs with `SendEmailOptions` when sending an email. Using the upload endpoints prior to sending mean attachments can easily be reused.
         * @summary Upload an attachment for sending using a Multipart Form request. Returns an array whose first element is the ID of the uploaded attachment.
         ...
         * @throws {RequiredError}
         */
        uploadMultipartForm(file: any, contentType?: string, contentTypeHeader?: string, filename?: string, xFilename?: string, options?: any) {
            return AttachmentControllerApiFp(configuration).uploadMultipartForm(file, contentType, contentTypeHeader, filename, xFilename, options)(fetch, basePath);
        },
    };
};
...
export class AttachmentControllerApi extends BaseAPI {
    ...
    public deleteAttachment(attachmentId: string, options?: any) {
        return AttachmentControllerApiFp(this.configuration).deleteAttachment(attachmentId, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof AttachmentControllerApi
     */
    public downloadAttachmentAsBase64Encoded(attachmentId: string, options?: any) {
        return AttachmentControllerApiFp(this.configuration).downloadAttachmentAsBase64Encoded(attachmentId, options)(this.fetch, this.basePath);
    }
    ...
    public downloadAttachmentAsBytes(attachmentId: string, options?: any) {
        return AttachmentControllerApiFp(this.configuration).downloadAttachmentAsBytes(attachmentId, options)(this.fetch, this.basePath);
    }
    ...
    public getAttachmentInfo(attachmentId: string, options?: any) {
        return AttachmentControllerApiFp(this.configuration).getAttachmentInfo(attachmentId, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof AttachmentControllerApi
     */
    public getAttachments(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
        return AttachmentControllerApiFp(this.configuration).getAttachments(page, size, sort, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof AttachmentControllerApi
     */
    public uploadAttachment(uploadOptions: UploadAttachmentOptions, options?: any) {
        return AttachmentControllerApiFp(this.configuration).uploadAttachment(uploadOptions, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof AttachmentControllerApi
     */
    public uploadAttachmentBytes(string?: string, byteArray?: string, filename?: string, options?: any) {
        return AttachmentControllerApiFp(this.configuration).uploadAttachmentBytes(string, byteArray, filename, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof AttachmentControllerApi
     */
    public uploadMultipartForm(file: any, contentType?: string, contentTypeHeader?: string, filename?: string, xFilename?: string, options?: any) {
        return AttachmentControllerApiFp(this.configuration).uploadMultipartForm(file, contentType, contentTypeHeader, filename, xFilename, options)(this.fetch, this.basePath);
    }
...
export const BulkActionsControllerApiFp = function(configuration?: Configuration) {
    return {
        ...
        bulkDeleteInboxes(ids: Array<string>, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
            const localVarFetchArgs = BulkActionsControllerApiFetchParamCreator(configuration).bulkDeleteInboxes(ids, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response;
...
export const BulkActionsControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        ...
        bulkDeleteInboxes(ids: Array<string>, options?: any) {
            return BulkActionsControllerApiFp(configuration).bulkDeleteInboxes(ids, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Bulk Send Emails
...
export class BulkActionsControllerApi extends BaseAPI {
    ...
    public bulkDeleteInboxes(ids: Array<string>, options?: any) {
        return BulkActionsControllerApiFp(this.configuration).bulkDeleteInboxes(ids, options)(this.fetch, this.basePath);
    }
    ...
    return {
        ...
        createNewEmailAddress(allowTeamAccess?: boolean, expiresAt?: Date, expiresIn?: number, useDomainPool?: boolean, options: any = {}): FetchArgs {
            ...
            if (expiresAt !== undefined) {
                localVarQueryParameter['expiresAt'] = (expiresAt as any).toISOString();
            }
        ...
        sendEmailSimple(emailOptions: SimpleSendEmailOptions, options: any = {}): FetchArgs {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"SimpleSendEmailOptions" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(emailOptions || {}) : (emailOptions || "");
...
export const CommonActionsControllerApiFp = function(configuration?: Configuration) {
    return {
        ...
        createNewEmailAddress(allowTeamAccess?: boolean, expiresAt?: Date, expiresIn?: number, useDomainPool?: boolean, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Inbox> {
            const localVarFetchArgs = CommonActionsControllerApiFetchParamCreator(configuration).createNewEmailAddress(allowTeamAccess, expiresAt, expiresIn, useDomainPool, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        createNewEmailAddress1(allowTeamAccess?: boolean, expiresAt?: Date, expiresIn?: number, useDomainPool?: boolean, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Inbox> {
            const localVarFetchArgs = CommonActionsControllerApiFetchParamCreator(configuration).createNewEmailAddress1(allowTeamAccess, expiresAt, expiresIn, useDomainPool, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        sendEmailSimple(emailOptions: SimpleSendEmailOptions, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
            const localVarFetchArgs = CommonActionsControllerApiFetchParamCreator(configuration).sendEmailSimple(emailOptions, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response;
...
export const CommonActionsControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        createNewEmailAddress(allowTeamAccess?: boolean, expiresAt?: Date, expiresIn?: number, useDomainPool?: boolean, options?: any) {
            return CommonActionsControllerApiFp(configuration).createNewEmailAddress(allowTeamAccess, expiresAt, expiresIn, useDomainPool, options)(fetch, basePath);
        },
        /**
         * Returns an Inbox with an `id` and an `emailAddress`
         * @summary Create new random inbox
         ...
         * @throws {RequiredError}
         */
        createNewEmailAddress1(allowTeamAccess?: boolean, expiresAt?: Date, expiresIn?: number, useDomainPool?: boolean, options?: any) {
            return CommonActionsControllerApiFp(configuration).createNewEmailAddress1(allowTeamAccess, expiresAt, expiresIn, useDomainPool, options)(fetch, basePath);
        },
        /**
         * Deletes all emails
         * @summary Delete all emails in an inbox
        ...
        sendEmailSimple(emailOptions: SimpleSendEmailOptions, options?: any) {
            return CommonActionsControllerApiFp(configuration).sendEmailSimple(emailOptions, options)(fetch, basePath);
        },
    };
};
...
export class CommonActionsControllerApi extends BaseAPI {
     ...
     */
    public createNewEmailAddress(allowTeamAccess?: boolean, expiresAt?: Date, expiresIn?: number, useDomainPool?: boolean, options?: any) {
        return CommonActionsControllerApiFp(this.configuration).createNewEmailAddress(allowTeamAccess, expiresAt, expiresIn, useDomainPool, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof CommonActionsControllerApi
     */
    public createNewEmailAddress1(allowTeamAccess?: boolean, expiresAt?: Date, expiresIn?: number, useDomainPool?: boolean, options?: any) {
        return CommonActionsControllerApiFp(this.configuration).createNewEmailAddress1(allowTeamAccess, expiresAt, expiresIn, useDomainPool, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof CommonActionsControllerApi
     */
    public sendEmailSimple(emailOptions: SimpleSendEmailOptions, options?: any) {
        return CommonActionsControllerApiFp(this.configuration).sendEmailSimple(emailOptions, options)(this.fetch, this.basePath);
    }
...
export const ContactControllerApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        createContact(createContactOptions: CreateContactOptions, options: any = {}): FetchArgs {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"CreateContactOptions" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
...
export const ContactControllerApiFp = function(configuration?: Configuration) {
    return {
        ...
        createContact(createContactOptions: CreateContactOptions, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ContactDto> {
            const localVarFetchArgs = ContactControllerApiFetchParamCreator(configuration).createContact(createContactOptions, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        deleteContact(contactId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
            const localVarFetchArgs = ContactControllerApiFetchParamCreator(configuration).deleteContact(contactId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response;
        ...
        getAllContacts(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PageContactProjection> {
            const localVarFetchArgs = ContactControllerApiFetchParamCreator(configuration).getAllContacts(page, size, sort, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getContact(contactId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ContactDto> {
            const localVarFetchArgs = ContactControllerApiFetchParamCreator(configuration).getContact(contactId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getContactVCard(contactId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<string> {
            const localVarFetchArgs = ContactControllerApiFetchParamCreator(configuration).getContactVCard(contactId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getContacts(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<ContactProjection>> {
            const localVarFetchArgs = ContactControllerApiFetchParamCreator(configuration).getContacts(options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const ContactControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * 
         * @summary Create a contact
         ...
         * @throws {RequiredError}
         */
        createContact(createContactOptions: CreateContactOptions, options?: any) {
            return ContactControllerApiFp(configuration).createContact(createContactOptions, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Delete contact
        ...
        deleteContact(contactId: string, options?: any) {
            return ContactControllerApiFp(configuration).deleteContact(contactId, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get all contacts
         ...
         * @throws {RequiredError}
         */
        getAllContacts(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
            return ContactControllerApiFp(configuration).getAllContacts(page, size, sort, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get contact
        ...
        getContact(contactId: string, options?: any) {
            return ContactControllerApiFp(configuration).getContact(contactId, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get contact vCard vcf file
        ...
        getContactVCard(contactId: string, options?: any) {
            return ContactControllerApiFp(configuration).getContactVCard(contactId, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get all contacts
        ...
        getContacts(options?: any) {
            return ContactControllerApiFp(configuration).getContacts(options)(fetch, basePath);
        },
    };
};
...
export class ContactControllerApi extends BaseAPI {
     ...
     */
    public createContact(createContactOptions: CreateContactOptions, options?: any) {
        return ContactControllerApiFp(this.configuration).createContact(createContactOptions, options)(this.fetch, this.basePath);
    }
    ...
    public deleteContact(contactId: string, options?: any) {
        return ContactControllerApiFp(this.configuration).deleteContact(contactId, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof ContactControllerApi
     */
    public getAllContacts(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
        return ContactControllerApiFp(this.configuration).getAllContacts(page, size, sort, options)(this.fetch, this.basePath);
    }
    ...
    public getContact(contactId: string, options?: any) {
        return ContactControllerApiFp(this.configuration).getContact(contactId, options)(this.fetch, this.basePath);
    }
    ...
    public getContactVCard(contactId: string, options?: any) {
        return ContactControllerApiFp(this.configuration).getContactVCard(contactId, options)(this.fetch, this.basePath);
    }
    ...
    public getContacts(options?: any) {
        return ContactControllerApiFp(this.configuration).getContacts(options)(this.fetch, this.basePath);
    }
...
export const DomainControllerApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        updateDomain(id: string, updateDomainDto: UpdateDomainOptions, options: any = {}): FetchArgs {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"UpdateDomainOptions" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(updateDomainDto || {}) : (updateDomainDto || "");
...
export const DomainControllerApiFp = function(configuration?: Configuration) {
    return {
        ...
        addDomainWildcardCatchAll(id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<DomainDto> {
            const localVarFetchArgs = DomainControllerApiFetchParamCreator(configuration).addDomainWildcardCatchAll(id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        createDomain(domainOptions: CreateDomainOptions, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<DomainDto> {
            const localVarFetchArgs = DomainControllerApiFetchParamCreator(configuration).createDomain(domainOptions, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        updateDomain(id: string, updateDomainDto: UpdateDomainOptions, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<DomainDto> {
            const localVarFetchArgs = DomainControllerApiFetchParamCreator(configuration).updateDomain(id, updateDomainDto, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const DomainControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        ...
        addDomainWildcardCatchAll(id: string, options?: any) {
            return DomainControllerApiFp(configuration).addDomainWildcardCatchAll(id, options)(fetch, basePath);
        },
        /**
         * Link a domain that you own with MailSlurp so you can create email addresses using it. Endpoint returns DNS records used for validation. You must add these verification records to your host provider's DNS setup to verify the domain.
         * @summary Create Domain
        ...
        createDomain(domainOptions: CreateDomainOptions, options?: any) {
            return DomainControllerApiFp(configuration).createDomain(domainOptions, options)(fetch, basePath);
        },
        /**
         * Delete a domain. This will disable any existing inboxes that use this domain.
         * @summary Delete a domain
         ...
         * @throws {RequiredError}
         */
        updateDomain(id: string, updateDomainDto: UpdateDomainOptions, options?: any) {
            return DomainControllerApiFp(configuration).updateDomain(id, updateDomainDto, options)(fetch, basePath);
        },
    };
};
...
export class DomainControllerApi extends BaseAPI {
    ...
    public addDomainWildcardCatchAll(id: string, options?: any) {
        return DomainControllerApiFp(this.configuration).addDomainWildcardCatchAll(id, options)(this.fetch, this.basePath);
    }
    ...
    public createDomain(domainOptions: CreateDomainOptions, options?: any) {
        return DomainControllerApiFp(this.configuration).createDomain(domainOptions, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof DomainControllerApi
     */
    public updateDomain(id: string, updateDomainDto: UpdateDomainOptions, options?: any) {
        return DomainControllerApiFp(this.configuration).updateDomain(id, updateDomainDto, options)(this.fetch, this.basePath);
    }
...
export const EmailControllerApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getEmailContentMatch(contentMatchOptions: ContentMatchOptions, emailId: string, options: any = {}): FetchArgs {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"ContentMatchOptions" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(contentMatchOptions || {}) : (contentMatchOptions || "");
         ...
         * @throws {RequiredError}
         */
        getOrganizationEmailsPaginated(inboxId?: Array<string>, page?: number, size?: number, sort?: 'ASC' | 'DESC', unreadOnly?: boolean, options: any = {}): FetchArgs {
        ...
        replyToEmail(emailId: string, replyToEmailOptions: ReplyToEmailOptions, options: any = {}): FetchArgs {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"ReplyToEmailOptions" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(replyToEmailOptions || {}) : (replyToEmailOptions || "");
...
export const EmailControllerApiFp = function(configuration?: Configuration) {
    return {
        ...
        deleteAllEmails(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
            const localVarFetchArgs = EmailControllerApiFetchParamCreator(configuration).deleteAllEmails(options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response;
        ...
        deleteEmail(emailId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
            const localVarFetchArgs = EmailControllerApiFetchParamCreator(configuration).deleteEmail(emailId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response;
        ...
        downloadAttachmentBase64(attachmentId: string, emailId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<DownloadAttachmentDto> {
            const localVarFetchArgs = EmailControllerApiFetchParamCreator(configuration).downloadAttachmentBase64(attachmentId, emailId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        downloadBody(emailId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<string> {
            const localVarFetchArgs = EmailControllerApiFetchParamCreator(configuration).downloadBody(emailId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        downloadBodyBytes(emailId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<string> {
            const localVarFetchArgs = EmailControllerApiFetchParamCreator(configuration).downloadBodyBytes(emailId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getAttachments1(emailId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<AttachmentMetaData>> {
            const localVarFetchArgs = EmailControllerApiFetchParamCreator(configuration).getAttachments1(emailId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getEmail(emailId: string, decode?: boolean, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Email> {
            const localVarFetchArgs = EmailControllerApiFetchParamCreator(configuration).getEmail(emailId, decode, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getEmailContentMatch(contentMatchOptions: ContentMatchOptions, emailId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<EmailContentMatchResult> {
            const localVarFetchArgs = EmailControllerApiFetchParamCreator(configuration).getEmailContentMatch(contentMatchOptions, emailId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getEmailHTML(emailId: string, decode?: boolean, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<string> {
            const localVarFetchArgs = EmailControllerApiFetchParamCreator(configuration).getEmailHTML(emailId, decode, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getEmailHTMLQuery(emailId: string, htmlSelector?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<EmailTextLinesResult> {
            const localVarFetchArgs = EmailControllerApiFetchParamCreator(configuration).getEmailHTMLQuery(emailId, htmlSelector, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getEmailTextLines(emailId: string, decodeHtmlEntities?: boolean, lineSeparator?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<EmailTextLinesResult> {
            const localVarFetchArgs = EmailControllerApiFetchParamCreator(configuration).getEmailTextLines(emailId, decodeHtmlEntities, lineSeparator, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getEmailsPaginated(inboxId?: Array<string>, page?: number, size?: number, sort?: 'ASC' | 'DESC', unreadOnly?: boolean, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PageEmailProjection> {
            const localVarFetchArgs = EmailControllerApiFetchParamCreator(configuration).getEmailsPaginated(inboxId, page, size, sort, unreadOnly, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getLatestEmail(inboxIds?: Array<string>, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Email> {
            const localVarFetchArgs = EmailControllerApiFetchParamCreator(configuration).getLatestEmail(inboxIds, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getLatestEmailInInbox(inboxId?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Email> {
            const localVarFetchArgs = EmailControllerApiFetchParamCreator(configuration).getLatestEmailInInbox(inboxId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getOrganizationEmailsPaginated(inboxId?: Array<string>, page?: number, size?: number, sort?: 'ASC' | 'DESC', unreadOnly?: boolean, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PageEmailProjection> {
            const localVarFetchArgs = EmailControllerApiFetchParamCreator(configuration).getOrganizationEmailsPaginated(inboxId, page, size, sort, unreadOnly, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getRawEmailJson(emailId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<RawEmailJson> {
            const localVarFetchArgs = EmailControllerApiFetchParamCreator(configuration).getRawEmailJson(emailId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getUnreadEmailCount(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<UnreadCount> {
            const localVarFetchArgs = EmailControllerApiFetchParamCreator(configuration).getUnreadEmailCount(options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        replyToEmail(emailId: string, replyToEmailOptions: ReplyToEmailOptions, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SentEmailDto> {
            const localVarFetchArgs = EmailControllerApiFetchParamCreator(configuration).replyToEmail(emailId, replyToEmailOptions, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        validateEmail(emailId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ValidationDto> {
            const localVarFetchArgs = EmailControllerApiFetchParamCreator(configuration).validateEmail(emailId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const EmailControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        ...
        deleteAllEmails(options?: any) {
            return EmailControllerApiFp(configuration).deleteAllEmails(options)(fetch, basePath);
        },
        /**
         * Deletes an email and removes it from the inbox. Deleted emails cannot be recovered.
         * @summary Delete an email
        ...
        deleteEmail(emailId: string, options?: any) {
            return EmailControllerApiFp(configuration).deleteEmail(emailId, options)(fetch, basePath);
        },
        /**
         * Returns the specified attachment for a given email as a stream / array of bytes. You can find attachment ids in email responses endpoint responses. The response type is application/octet-stream.
         * @summary Get email attachment bytes. Returned as `octet-stream` with content type header. If you have trouble with byte responses try the `downloadAttachmentBase64` response endpoints and convert the base 64 encoded content to a file or string.
         ...
         * @throws {RequiredError}
         */
        downloadAttachmentBase64(attachmentId: string, emailId: string, options?: any) {
            return EmailControllerApiFp(configuration).downloadAttachmentBase64(attachmentId, emailId, options)(fetch, basePath);
        },
        /**
         * Returns the specified email body for a given email as a string
         * @summary Get email body as string. Returned as `plain/text` with content type header.
        ...
        downloadBody(emailId: string, options?: any) {
            return EmailControllerApiFp(configuration).downloadBody(emailId, options)(fetch, basePath);
        },
        /**
         * Returns the specified email body for a given email as a stream / array of bytes.
         * @summary Get email body in bytes. Returned as `octet-stream` with content type header.
        ...
        downloadBodyBytes(emailId: string, options?: any) {
            return EmailControllerApiFp(configuration).downloadBodyBytes(emailId, options)(fetch, basePath);
        },
        /**
         * Forward an existing email to new recipients.
         * @summary Forward email to recipients
        ...
        getAttachments1(emailId: string, options?: any) {
            return EmailControllerApiFp(configuration).getAttachments1(emailId, options)(fetch, basePath);
        },
        /**
         * Returns a email summary object with headers and content. To retrieve the raw unparsed email use the getRawEmail endpoints
         * @summary Get email content including headers and body. Expects email to exist by ID. For emails that may not have arrived yet use the WaitForController.
        ...
        getEmail(emailId: string, decode?: boolean, options?: any) {
            return EmailControllerApiFp(configuration).getEmail(emailId, decode, options)(fetch, basePath);
        },
        /**
         * Return the matches for a given Java style regex pattern. Do not include the typical `/` at start or end of regex in some languages. Given an example `your code is: 12345` the pattern to extract match looks like `code is: (\\d{6})`. This will return an array of matches with the first matching the entire pattern and the subsequent matching the groups: `['code is: 123456', '123456']` See https://docs.oracle.com/javase/8/docs/api/java/util/regex/Pattern.html for more information of available patterns. 
         * @summary Get email content regex pattern match results. Runs regex against email body and returns match groups.
         ...
         * @throws {RequiredError}
         */
        getEmailContentMatch(contentMatchOptions: ContentMatchOptions, emailId: string, options?: any) {
            return EmailControllerApiFp(configuration).getEmailContentMatch(contentMatchOptions, emailId, options)(fetch, basePath);
        },
        /**
         * Retrieve email content as HTML response for viewing in browsers. Decodes quoted-printable entities and converts charset to UTF-8. Pass your API KEY as a request parameter when viewing in a browser: `?apiKey=xxx`
         * @summary Get email content as HTML. For displaying emails in browser context.
        ...
        getEmailHTML(emailId: string, decode?: boolean, options?: any) {
            return EmailControllerApiFp(configuration).getEmailHTML(emailId, decode, options)(fetch, basePath);
        },
        /**
         * Parse an email body and return the content as an array of text. HTML parsing uses JSoup which supports JQuery/CSS style selectors
         * @summary Parse and return text from an email, stripping HTML and decoding encoded characters
         ...
         * @throws {RequiredError}
         */
        getEmailHTMLQuery(emailId: string, htmlSelector?: string, options?: any) {
            return EmailControllerApiFp(configuration).getEmailHTMLQuery(emailId, htmlSelector, options)(fetch, basePath);
        },
        /**
         * Parse an email body and return the content as an array of strings. HTML parsing uses JSoup and UNIX line separators.
         * @summary Parse and return text from an email, stripping HTML and decoding encoded characters
         ...
         * @throws {RequiredError}
         */
        getEmailTextLines(emailId: string, decodeHtmlEntities?: boolean, lineSeparator?: string, options?: any) {
            return EmailControllerApiFp(configuration).getEmailTextLines(emailId, decodeHtmlEntities, lineSeparator, options)(fetch, basePath);
        },
        /**
         * By default returns all emails across all inboxes sorted by ascending created at date. Responses are paginated. You can restrict results to a list of inbox IDs. You can also filter out read messages
         * @summary Get all emails in all inboxes. Email API list all.
         ...
         * @throws {RequiredError}
         */
        getEmailsPaginated(inboxId?: Array<string>, page?: number, size?: number, sort?: 'ASC' | 'DESC', unreadOnly?: boolean, options?: any) {
            return EmailControllerApiFp(configuration).getEmailsPaginated(inboxId, page, size, sort, unreadOnly, options)(fetch, basePath);
        },
        /**
         * Get the newest email in all inboxes or in a passed set of inbox IDs
         * @summary Get latest email in all inboxes. Most recently received.
        ...
        getLatestEmail(inboxIds?: Array<string>, options?: any) {
            return EmailControllerApiFp(configuration).getLatestEmail(inboxIds, options)(fetch, basePath);
        },
        /**
         * Get the newest email in all inboxes or in a passed set of inbox IDs
         * @summary Get latest email in an inbox. Use `WaitForController` to get emails that may not have arrived yet.
        ...
        getLatestEmailInInbox(inboxId?: string, options?: any) {
            return EmailControllerApiFp(configuration).getLatestEmailInInbox(inboxId, options)(fetch, basePath);
        },
        /**
         * By default returns all emails across all team inboxes sorted by ascending created at date. Responses are paginated. You can restrict results to a list of inbox IDs. You can also filter out read messages
         * @summary Get all organization emails. List team or shared test email accounts
         ...
         * @throws {RequiredError}
         */
        getOrganizationEmailsPaginated(inboxId?: Array<string>, page?: number, size?: number, sort?: 'ASC' | 'DESC', unreadOnly?: boolean, options?: any) {
            return EmailControllerApiFp(configuration).getOrganizationEmailsPaginated(inboxId, page, size, sort, unreadOnly, options)(fetch, basePath);
        },
        /**
         * Returns a raw, unparsed, and unprocessed email. If your client has issues processing the response it is likely due to the response content-type which is text/plain. If you need a JSON response content-type use the getRawEmailJson endpoint
         * @summary Get raw email string. Returns unparsed raw SMTP message with headers and body.
        ...
        getRawEmailJson(emailId: string, options?: any) {
            return EmailControllerApiFp(configuration).getRawEmailJson(emailId, options)(fetch, basePath);
        },
        /**
         * Get number of emails unread. Unread means has not been viewed in dashboard or returned in an email API response
         * @summary Get unread email count
        ...
        getUnreadEmailCount(options?: any) {
            return EmailControllerApiFp(configuration).getUnreadEmailCount(options)(fetch, basePath);
        },
        /**
         * Send the reply to the email sender or reply-to and include same subject cc bcc etc. Reply to an email and the contents will be sent with the existing subject to the emails `to`, `cc`, and `bcc`.
         * @summary Reply to an email
         ...
         * @throws {RequiredError}
         */
        replyToEmail(emailId: string, replyToEmailOptions: ReplyToEmailOptions, options?: any) {
            return EmailControllerApiFp(configuration).replyToEmail(emailId, replyToEmailOptions, options)(fetch, basePath);
        },
        /**
         * Validate the HTML content of email if HTML is found. Considered valid if no HTML.
         * @summary Validate email HTML contents
        ...
        validateEmail(emailId: string, options?: any) {
            return EmailControllerApiFp(configuration).validateEmail(emailId, options)(fetch, basePath);
        },
    };
};
...
export class EmailControllerApi extends BaseAPI {
    ...
    public deleteAllEmails(options?: any) {
        return EmailControllerApiFp(this.configuration).deleteAllEmails(options)(this.fetch, this.basePath);
    }
    ...
    public deleteEmail(emailId: string, options?: any) {
        return EmailControllerApiFp(this.configuration).deleteEmail(emailId, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof EmailControllerApi
     */
    public downloadAttachmentBase64(attachmentId: string, emailId: string, options?: any) {
        return EmailControllerApiFp(this.configuration).downloadAttachmentBase64(attachmentId, emailId, options)(this.fetch, this.basePath);
    }
    ...
    public downloadBody(emailId: string, options?: any) {
        return EmailControllerApiFp(this.configuration).downloadBody(emailId, options)(this.fetch, this.basePath);
    }
    ...
    public downloadBodyBytes(emailId: string, options?: any) {
        return EmailControllerApiFp(this.configuration).downloadBodyBytes(emailId, options)(this.fetch, this.basePath);
    }
    ...
    public getAttachments1(emailId: string, options?: any) {
        return EmailControllerApiFp(this.configuration).getAttachments1(emailId, options)(this.fetch, this.basePath);
    }
    ...
    public getEmail(emailId: string, decode?: boolean, options?: any) {
        return EmailControllerApiFp(this.configuration).getEmail(emailId, decode, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof EmailControllerApi
     */
    public getEmailContentMatch(contentMatchOptions: ContentMatchOptions, emailId: string, options?: any) {
        return EmailControllerApiFp(this.configuration).getEmailContentMatch(contentMatchOptions, emailId, options)(this.fetch, this.basePath);
    }
    ...
    public getEmailHTML(emailId: string, decode?: boolean, options?: any) {
        return EmailControllerApiFp(this.configuration).getEmailHTML(emailId, decode, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof EmailControllerApi
     */
    public getEmailHTMLQuery(emailId: string, htmlSelector?: string, options?: any) {
        return EmailControllerApiFp(this.configuration).getEmailHTMLQuery(emailId, htmlSelector, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof EmailControllerApi
     */
    public getEmailTextLines(emailId: string, decodeHtmlEntities?: boolean, lineSeparator?: string, options?: any) {
        return EmailControllerApiFp(this.configuration).getEmailTextLines(emailId, decodeHtmlEntities, lineSeparator, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof EmailControllerApi
     */
    public getEmailsPaginated(inboxId?: Array<string>, page?: number, size?: number, sort?: 'ASC' | 'DESC', unreadOnly?: boolean, options?: any) {
        return EmailControllerApiFp(this.configuration).getEmailsPaginated(inboxId, page, size, sort, unreadOnly, options)(this.fetch, this.basePath);
    }
    ...
    public getLatestEmail(inboxIds?: Array<string>, options?: any) {
        return EmailControllerApiFp(this.configuration).getLatestEmail(inboxIds, options)(this.fetch, this.basePath);
    }
    ...
    public getLatestEmailInInbox(inboxId?: string, options?: any) {
        return EmailControllerApiFp(this.configuration).getLatestEmailInInbox(inboxId, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof EmailControllerApi
     */
    public getOrganizationEmailsPaginated(inboxId?: Array<string>, page?: number, size?: number, sort?: 'ASC' | 'DESC', unreadOnly?: boolean, options?: any) {
        return EmailControllerApiFp(this.configuration).getOrganizationEmailsPaginated(inboxId, page, size, sort, unreadOnly, options)(this.fetch, this.basePath);
    }
    ...
    public getRawEmailJson(emailId: string, options?: any) {
        return EmailControllerApiFp(this.configuration).getRawEmailJson(emailId, options)(this.fetch, this.basePath);
    }
    ...
    public getUnreadEmailCount(options?: any) {
        return EmailControllerApiFp(this.configuration).getUnreadEmailCount(options)(this.fetch, this.basePath);
    }
     ...
     * @memberof EmailControllerApi
     */
    public replyToEmail(emailId: string, replyToEmailOptions: ReplyToEmailOptions, options?: any) {
        return EmailControllerApiFp(this.configuration).replyToEmail(emailId, replyToEmailOptions, options)(this.fetch, this.basePath);
    }
    ...
    public validateEmail(emailId: string, options?: any) {
        return EmailControllerApiFp(this.configuration).validateEmail(emailId, options)(this.fetch, this.basePath);
    }
 ...
 * @export
 */
export const ExpiredControllerApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        /**
...
export const ExpiredControllerApiFp = function(configuration?: Configuration) {
    return {
        ...
        getExpirationDefaults(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ExpirationDefaults> {
            const localVarFetchArgs = ExpiredControllerApiFetchParamCreator(configuration).getExpirationDefaults(options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getExpiredInboxByInboxId(inboxId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ExpiredInboxDto> {
            const localVarFetchArgs = ExpiredControllerApiFetchParamCreator(configuration).getExpiredInboxByInboxId(inboxId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getExpiredInboxRecord(expiredId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ExpiredInboxDto> {
            const localVarFetchArgs = ExpiredControllerApiFetchParamCreator(configuration).getExpiredInboxRecord(expiredId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getExpiredInboxes(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PageExpiredInboxRecordProjection> {
            const localVarFetchArgs = ExpiredControllerApiFetchParamCreator(configuration).getExpiredInboxes(page, size, sort, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const ExpiredControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * Return default times used for inbox expiration
         * @summary Get default expiration settings
        ...
        getExpirationDefaults(options?: any) {
            return ExpiredControllerApiFp(configuration).getExpirationDefaults(options)(fetch, basePath);
        },
        /**
         * Use the inboxId to return an ExpiredInboxRecord if an inbox has expired. Inboxes expire and are disabled if an expiration date is set or plan requires. Returns 404 if no expired inbox is found for the inboxId
         * @summary Get expired inbox record for a previously existing inbox
        ...
        getExpiredInboxByInboxId(inboxId: string, options?: any) {
            return ExpiredControllerApiFp(configuration).getExpiredInboxByInboxId(inboxId, options)(fetch, basePath);
        },
        /**
         * Inboxes created with an expiration date will expire after the given date and be moved to an ExpiredInbox entity. You can still read emails in the inbox but it can no longer send or receive emails. Fetch the expired inboxes to view the old inboxes properties
         * @summary Get an expired inbox record
        ...
        getExpiredInboxRecord(expiredId: string, options?: any) {
            return ExpiredControllerApiFp(configuration).getExpiredInboxRecord(expiredId, options)(fetch, basePath);
        },
        /**
         * Inboxes created with an expiration date will expire after the given date. An ExpiredInboxRecord is created that records the inboxes old ID and email address. You can still read emails in the inbox (using the inboxes old ID) but the email address associated with the inbox can no longer send or receive emails. Fetch expired inbox records to view the old inboxes properties
         * @summary List records of expired inboxes
         ...
         * @throws {RequiredError}
         */
        getExpiredInboxes(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
            return ExpiredControllerApiFp(configuration).getExpiredInboxes(page, size, sort, options)(fetch, basePath);
        },
    };
};
...
export class ExpiredControllerApi extends BaseAPI {
    ...
    public getExpirationDefaults(options?: any) {
        return ExpiredControllerApiFp(this.configuration).getExpirationDefaults(options)(this.fetch, this.basePath);
    }
    ...
    public getExpiredInboxByInboxId(inboxId: string, options?: any) {
        return ExpiredControllerApiFp(this.configuration).getExpiredInboxByInboxId(inboxId, options)(this.fetch, this.basePath);
    }
    ...
    public getExpiredInboxRecord(expiredId: string, options?: any) {
        return ExpiredControllerApiFp(this.configuration).getExpiredInboxRecord(expiredId, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof ExpiredControllerApi
     */
    public getExpiredInboxes(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
        return ExpiredControllerApiFp(this.configuration).getExpiredInboxes(page, size, sort, options)(this.fetch, this.basePath);
    }
 ...
 * @export
 */
export const FormControllerApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        /**
        ...
        submitForm(emailAddress?: string, redirectTo?: string, spamCheck?: string, subject?: string, successMessage?: string, to?: string, otherParameters?: string, options: any = {}): FetchArgs {
            ...
            if (successMessage !== undefined) {
                localVarFormParams.set('_successMessage', successMessage as any);
            }
            ...
            if (otherParameters !== undefined) {
                localVarFormParams.set('otherParameters', otherParameters as any);
            }
...
export const FormControllerApiFp = function(configuration?: Configuration) {
    return {
        ...
        submitForm(emailAddress?: string, redirectTo?: string, spamCheck?: string, subject?: string, successMessage?: string, to?: string, otherParameters?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<string> {
            const localVarFetchArgs = FormControllerApiFetchParamCreator(configuration).submitForm(emailAddress, redirectTo, spamCheck, subject, successMessage, to, otherParameters, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const FormControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * This endpoint allows you to submit HTML forms and receive the field values and files via email.   #### Parameters The endpoint looks for special meta parameters in the form fields OR in the URL request parameters. The meta parameters can be used to specify the behaviour of the email.   You must provide at-least a `_to` email address to tell the endpoint where the form should be emailed. These can be submitted as hidden HTML input fields with the corresponding `name` attributes or as URL query parameters such as `?_to=test@example.com`  The endpoint takes all other form fields that are named and includes them in the message body of the email. Files are sent as attachments.  #### Submitting This endpoint accepts form submission via POST method. It accepts `application/x-www-form-urlencoded`, and `multipart/form-data` content-types.  #### HTML Example ```html <form    action=\"https://api.mailslurp.com/forms\"   method=\"post\" >   <input name=\"_to\" type=\"hidden\" value=\"test@example.com\"/>   <textarea name=\"feedback\"></textarea>   <button type=\"submit\">Submit</button> </form> ```  #### URL Example ```html <form    action=\"https://api.mailslurp.com/forms?_to=test@example.com\"   method=\"post\" >   <textarea name=\"feedback\"></textarea>   <button type=\"submit\">Submit</button> </form> ```    The email address is specified by a `_to` field OR is extracted from an email alias specified by a `_toAlias` field (see the alias controller for more information).  Endpoint accepts .  You can specify a content type in HTML forms using the `enctype` attribute, for instance: `<form enctype=\"multipart/form-data\">`.  
         * @summary Submit a form to be parsed and sent as an email to an address determined by the form fields
         ...
         * @throws {RequiredError}
         */
        submitForm(emailAddress?: string, redirectTo?: string, spamCheck?: string, subject?: string, successMessage?: string, to?: string, otherParameters?: string, options?: any) {
            return FormControllerApiFp(configuration).submitForm(emailAddress, redirectTo, spamCheck, subject, successMessage, to, otherParameters, options)(fetch, basePath);
        },
    };
};
...
export class FormControllerApi extends BaseAPI {
     ...
     */
    public submitForm(emailAddress?: string, redirectTo?: string, spamCheck?: string, subject?: string, successMessage?: string, to?: string, otherParameters?: string, options?: any) {
        return FormControllerApiFp(this.configuration).submitForm(emailAddress, redirectTo, spamCheck, subject, successMessage, to, otherParameters, options)(this.fetch, this.basePath);
    }
 ...
 * @export
 */
export const GroupControllerApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
        ...
        addContactsToGroup(groupId: string, updateGroupContactsOption: UpdateGroupContacts, options: any = {}): FetchArgs {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"UpdateGroupContacts" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
        ...
        createGroup(createGroupOptions: CreateGroupOptions, options: any = {}): FetchArgs {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"CreateGroupOptions" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
...
export const GroupControllerApiFp = function(configuration?: Configuration) {
    return {
        ...
        addContactsToGroup(groupId: string, updateGroupContactsOption: UpdateGroupContacts, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<GroupContactsDto> {
            const localVarFetchArgs = GroupControllerApiFetchParamCreator(configuration).addContactsToGroup(groupId, updateGroupContactsOption, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        createGroup(createGroupOptions: CreateGroupOptions, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<GroupDto> {
            const localVarFetchArgs = GroupControllerApiFetchParamCreator(configuration).createGroup(createGroupOptions, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        deleteGroup(groupId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
            const localVarFetchArgs = GroupControllerApiFetchParamCreator(configuration).deleteGroup(groupId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response;
        ...
        getAllGroups(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PageGroupProjection> {
            const localVarFetchArgs = GroupControllerApiFetchParamCreator(configuration).getAllGroups(page, size, sort, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getGroup(groupId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<GroupDto> {
            const localVarFetchArgs = GroupControllerApiFetchParamCreator(configuration).getGroup(groupId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getGroupWithContacts(groupId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<GroupContactsDto> {
            const localVarFetchArgs = GroupControllerApiFetchParamCreator(configuration).getGroupWithContacts(groupId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getGroupWithContactsPaginated(groupId: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PageContactProjection> {
            const localVarFetchArgs = GroupControllerApiFetchParamCreator(configuration).getGroupWithContactsPaginated(groupId, page, size, sort, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getGroups(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<GroupProjection>> {
            const localVarFetchArgs = GroupControllerApiFetchParamCreator(configuration).getGroups(options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        removeContactsFromGroup(groupId: string, updateGroupContactsOption: UpdateGroupContacts, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<GroupContactsDto> {
            const localVarFetchArgs = GroupControllerApiFetchParamCreator(configuration).removeContactsFromGroup(groupId, updateGroupContactsOption, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const GroupControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * 
         * @summary Add contacts to a group
         ...
         * @throws {RequiredError}
         */
        addContactsToGroup(groupId: string, updateGroupContactsOption: UpdateGroupContacts, options?: any) {
            return GroupControllerApiFp(configuration).addContactsToGroup(groupId, updateGroupContactsOption, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Create a group
        ...
        createGroup(createGroupOptions: CreateGroupOptions, options?: any) {
            return GroupControllerApiFp(configuration).createGroup(createGroupOptions, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Delete group
        ...
        deleteGroup(groupId: string, options?: any) {
            return GroupControllerApiFp(configuration).deleteGroup(groupId, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get all Contact Groups in paginated format
         ...
         * @throws {RequiredError}
         */
        getAllGroups(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
            return GroupControllerApiFp(configuration).getAllGroups(page, size, sort, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get group
        ...
        getGroup(groupId: string, options?: any) {
            return GroupControllerApiFp(configuration).getGroup(groupId, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get group and contacts belonging to it
        ...
        getGroupWithContacts(groupId: string, options?: any) {
            return GroupControllerApiFp(configuration).getGroupWithContacts(groupId, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get group and paginated contacts belonging to it
         ...
         * @throws {RequiredError}
         */
        getGroupWithContactsPaginated(groupId: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
            return GroupControllerApiFp(configuration).getGroupWithContactsPaginated(groupId, page, size, sort, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get all groups
        ...
        getGroups(options?: any) {
            return GroupControllerApiFp(configuration).getGroups(options)(fetch, basePath);
        },
        /**
         * 
         * @summary Remove contacts from a group
         ...
         * @throws {RequiredError}
         */
        removeContactsFromGroup(groupId: string, updateGroupContactsOption: UpdateGroupContacts, options?: any) {
            return GroupControllerApiFp(configuration).removeContactsFromGroup(groupId, updateGroupContactsOption, options)(fetch, basePath);
        },
    };
};
...
export class GroupControllerApi extends BaseAPI {
     ...
     */
    public addContactsToGroup(groupId: string, updateGroupContactsOption: UpdateGroupContacts, options?: any) {
        return GroupControllerApiFp(this.configuration).addContactsToGroup(groupId, updateGroupContactsOption, options)(this.fetch, this.basePath);
    }
    ...
    public createGroup(createGroupOptions: CreateGroupOptions, options?: any) {
        return GroupControllerApiFp(this.configuration).createGroup(createGroupOptions, options)(this.fetch, this.basePath);
    }
    ...
    public deleteGroup(groupId: string, options?: any) {
        return GroupControllerApiFp(this.configuration).deleteGroup(groupId, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof GroupControllerApi
     */
    public getAllGroups(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
        return GroupControllerApiFp(this.configuration).getAllGroups(page, size, sort, options)(this.fetch, this.basePath);
    }
    ...
    public getGroup(groupId: string, options?: any) {
        return GroupControllerApiFp(this.configuration).getGroup(groupId, options)(this.fetch, this.basePath);
    }
    ...
    public getGroupWithContacts(groupId: string, options?: any) {
        return GroupControllerApiFp(this.configuration).getGroupWithContacts(groupId, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof GroupControllerApi
     */
    public getGroupWithContactsPaginated(groupId: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
        return GroupControllerApiFp(this.configuration).getGroupWithContactsPaginated(groupId, page, size, sort, options)(this.fetch, this.basePath);
    }
    ...
    public getGroups(options?: any) {
        return GroupControllerApiFp(this.configuration).getGroups(options)(this.fetch, this.basePath);
    }
     ...
     * @memberof GroupControllerApi
     */
    public removeContactsFromGroup(groupId: string, updateGroupContactsOption: UpdateGroupContacts, options?: any) {
        return GroupControllerApiFp(this.configuration).removeContactsFromGroup(groupId, updateGroupContactsOption, options)(this.fetch, this.basePath);
    }
...
export const InboxControllerApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        ...
        createInboxWithOptions(createInboxDto: CreateInboxDto, options: any = {}): FetchArgs {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"CreateInboxDto" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(createInboxDto || {}) : (createInboxDto || "");
         ...
         * @throws {RequiredError}
         */
        getOrganizationInboxes(page?: number, size?: number, sort?: 'ASC' | 'DESC', options: any = {}): FetchArgs {
        ...
        setInboxFavourited(inboxId: string, setInboxFavouritedOptions: SetInboxFavouritedOptions, options: any = {}): FetchArgs {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"SetInboxFavouritedOptions" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
        ...
        updateInbox(inboxId: string, updateInboxOptions: UpdateInboxOptions, options: any = {}): FetchArgs {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"UpdateInboxOptions" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
...
export const InboxControllerApiFp = function(configuration?: Configuration) {
    return {
        ...
        createInbox(allowTeamAccess?: boolean, description?: string, emailAddress?: string, expiresAt?: Date, expiresIn?: number, favourite?: boolean, inboxType?: 'HTTP_INBOX' | 'SMTP_INBOX', name?: string, tags?: Array<string>, useDomainPool?: boolean, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Inbox> {
            const localVarFetchArgs = InboxControllerApiFetchParamCreator(configuration).createInbox(allowTeamAccess, description, emailAddress, expiresAt, expiresIn, favourite, inboxType, name, tags, useDomainPool, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        createInboxWithDefaults(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Inbox> {
            const localVarFetchArgs = InboxControllerApiFetchParamCreator(configuration).createInboxWithDefaults(options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        createInboxWithOptions(createInboxDto: CreateInboxDto, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Inbox> {
            const localVarFetchArgs = InboxControllerApiFetchParamCreator(configuration).createInboxWithOptions(createInboxDto, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        deleteAllInboxes(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
            const localVarFetchArgs = InboxControllerApiFetchParamCreator(configuration).deleteAllInboxes(options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response;
        ...
        getAllInboxes(favourite?: boolean, page?: number, search?: string, size?: number, sort?: 'ASC' | 'DESC', tag?: string, teamAccess?: boolean, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PageInboxProjection> {
            const localVarFetchArgs = InboxControllerApiFetchParamCreator(configuration).getAllInboxes(favourite, page, search, size, sort, tag, teamAccess, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getEmails(inboxId: string, limit?: number, minCount?: number, retryTimeout?: number, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<EmailPreview>> {
            const localVarFetchArgs = InboxControllerApiFetchParamCreator(configuration).getEmails(inboxId, limit, minCount, retryTimeout, since, size, sort, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getInboxEmailsPaginated(inboxId: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PageEmailPreview> {
            const localVarFetchArgs = InboxControllerApiFetchParamCreator(configuration).getInboxEmailsPaginated(inboxId, page, size, sort, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getInboxSentEmails(inboxId: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PageSentEmailProjection> {
            const localVarFetchArgs = InboxControllerApiFetchParamCreator(configuration).getInboxSentEmails(inboxId, page, size, sort, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getInboxTags(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<string>> {
            const localVarFetchArgs = InboxControllerApiFetchParamCreator(configuration).getInboxTags(options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getInboxes(size?: number, sort?: 'ASC' | 'DESC', options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<Inbox>> {
            const localVarFetchArgs = InboxControllerApiFetchParamCreator(configuration).getInboxes(size, sort, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getOrganizationInboxes(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PageOrganizationInboxProjection> {
            const localVarFetchArgs = InboxControllerApiFetchParamCreator(configuration).getOrganizationInboxes(page, size, sort, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        sendEmailAndConfirm(inboxId: string, sendEmailOptions?: SendEmailOptions, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SentEmailDto> {
            const localVarFetchArgs = InboxControllerApiFetchParamCreator(configuration).sendEmailAndConfirm(inboxId, sendEmailOptions, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        sendTestEmail(inboxId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
            const localVarFetchArgs = InboxControllerApiFetchParamCreator(configuration).sendTestEmail(inboxId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response;
        ...
        setInboxFavourited(inboxId: string, setInboxFavouritedOptions: SetInboxFavouritedOptions, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Inbox> {
            const localVarFetchArgs = InboxControllerApiFetchParamCreator(configuration).setInboxFavourited(inboxId, setInboxFavouritedOptions, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        updateInbox(inboxId: string, updateInboxOptions: UpdateInboxOptions, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Inbox> {
            const localVarFetchArgs = InboxControllerApiFetchParamCreator(configuration).updateInbox(inboxId, updateInboxOptions, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const InboxControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        createInbox(allowTeamAccess?: boolean, description?: string, emailAddress?: string, expiresAt?: Date, expiresIn?: number, favourite?: boolean, inboxType?: 'HTTP_INBOX' | 'SMTP_INBOX', name?: string, tags?: Array<string>, useDomainPool?: boolean, options?: any) {
            return InboxControllerApiFp(configuration).createInbox(allowTeamAccess, description, emailAddress, expiresAt, expiresIn, favourite, inboxType, name, tags, useDomainPool, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Create an inbox with default options. Uses MailSlurp domain pool address and is private.
        ...
        createInboxWithDefaults(options?: any) {
            return InboxControllerApiFp(configuration).createInboxWithDefaults(options)(fetch, basePath);
        },
        /**
         * Additional endpoint that allows inbox creation with request body options. Can be more flexible that other methods for some clients.
         * @summary Create an inbox with options. Extended options for inbox creation.
        ...
        createInboxWithOptions(createInboxDto: CreateInboxDto, options?: any) {
            return InboxControllerApiFp(configuration).createInboxWithOptions(createInboxDto, options)(fetch, basePath);
        },
        /**
         * Permanently delete all inboxes and associated email addresses. This will also delete all emails within the inboxes. Be careful as inboxes cannot be recovered once deleted. Note: deleting inboxes will not impact your usage limits. Monthly inbox creation limits are based on how many inboxes were created in the last 30 days, not how many inboxes you currently have.
         * @summary Delete all inboxes
        ...
        deleteAllInboxes(options?: any) {
            return InboxControllerApiFp(configuration).deleteAllInboxes(options)(fetch, basePath);
        },
        /**
         * Permanently delete an inbox and associated email address as well as all emails within the given inbox. This action cannot be undone. Note: deleting an inbox will not affect your account usage. Monthly inbox usage is based on how many inboxes you create within 30 days, not how many exist at time of request.
         * @summary Delete inbox
         ...
         * @throws {RequiredError}
         */
        getAllInboxes(favourite?: boolean, page?: number, search?: string, size?: number, sort?: 'ASC' | 'DESC', tag?: string, teamAccess?: boolean, options?: any) {
            return InboxControllerApiFp(configuration).getAllInboxes(favourite, page, search, size, sort, tag, teamAccess, options)(fetch, basePath);
        },
        /**
         * List emails that an inbox has received. Only emails that are sent to the inbox's email address will appear in the inbox. It may take several seconds for any email you send to an inbox's email address to appear in the inbox. To make this endpoint wait for a minimum number of emails use the `minCount` parameter. The server will retry the inbox database until the `minCount` is satisfied or the `retryTimeout` is reached
         * @summary Get emails in an Inbox. This method is not idempotent as it allows retries and waits if you want certain conditions to be met before returning. For simple listing and sorting of known emails use the email controller instead.
         ...
         * @throws {RequiredError}
         */
        getEmails(inboxId: string, limit?: number, minCount?: number, retryTimeout?: number, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
            return InboxControllerApiFp(configuration).getEmails(inboxId, limit, minCount, retryTimeout, since, size, sort, options)(fetch, basePath);
        },
        /**
         * Returns an inbox's properties, including its email address and ID.
         * @summary Get Inbox. Returns properties of an inbox.
         ...
         * @throws {RequiredError}
         */
        getInboxEmailsPaginated(inboxId: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
            return InboxControllerApiFp(configuration).getInboxEmailsPaginated(inboxId, page, size, sort, options)(fetch, basePath);
        },
        /**
         * Returns an inbox's sent email receipts. Call individual sent email endpoints for more details. Note for privacy reasons the full body of sent emails is never stored. An MD5 hash hex is available for comparison instead.
         * @summary Get Inbox Sent Emails
         ...
         * @throws {RequiredError}
         */
        getInboxSentEmails(inboxId: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
            return InboxControllerApiFp(configuration).getInboxSentEmails(inboxId, page, size, sort, options)(fetch, basePath);
        },
        /**
         * Get all inbox tags
         * @summary Get inbox tags
        ...
        getInboxTags(options?: any) {
            return InboxControllerApiFp(configuration).getInboxTags(options)(fetch, basePath);
        },
        /**
         * List the inboxes you have created. Note use of the more advanced `getAllEmails` is recommended. You can provide a limit and sort parameter.
         * @summary List Inboxes and email eddresses
        ...
        getInboxes(size?: number, sort?: 'ASC' | 'DESC', options?: any) {
            return InboxControllerApiFp(configuration).getInboxes(size, sort, options)(fetch, basePath);
        },
        /**
         * List organization inboxes in paginated form. These are inboxes created with `allowTeamAccess` flag enabled. Organization inboxes are `readOnly` for non-admin users. The results are available on the `content` property of the returned object. This method allows for page index (zero based), page size (how many results to return), and a sort direction (based on createdAt time). 
         * @summary List Organization Inboxes Paginated
         ...
         * @throws {RequiredError}
         */
        getOrganizationInboxes(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
            return InboxControllerApiFp(configuration).getOrganizationInboxes(page, size, sort, options)(fetch, basePath);
        },
        /**
         * Send an email from an inbox's email address.  The request body should contain the `SendEmailOptions` that include recipients, attachments, body etc. See `SendEmailOptions` for all available properties. Note the `inboxId` refers to the inbox's id not the inbox's email address. See https://www.mailslurp.com/guides/ for more information on how to send emails. This method does not return a sent email entity due to legacy reasons. To send and get a sent email as returned response use the sister method `sendEmailAndConfirm`.
         * @summary Send Email
         ...
         * @throws {RequiredError}
         */
        sendEmailAndConfirm(inboxId: string, sendEmailOptions?: SendEmailOptions, options?: any) {
            return InboxControllerApiFp(configuration).sendEmailAndConfirm(inboxId, sendEmailOptions, options)(fetch, basePath);
        },
        /**
         * Send an inbox a test email to test email receiving is working
         * @summary Send a test email to inbox
        ...
        sendTestEmail(inboxId: string, options?: any) {
            return InboxControllerApiFp(configuration).sendTestEmail(inboxId, options)(fetch, basePath);
        },
        /**
         * Set and return new favourite state for an inbox
         * @summary Set inbox favourited state
         ...
         * @throws {RequiredError}
         */
        setInboxFavourited(inboxId: string, setInboxFavouritedOptions: SetInboxFavouritedOptions, options?: any) {
            return InboxControllerApiFp(configuration).setInboxFavourited(inboxId, setInboxFavouritedOptions, options)(fetch, basePath);
        },
        /**
         * Update editable fields on an inbox
         * @summary Update Inbox. Change name and description. Email address is not editable.
         ...
         * @throws {RequiredError}
         */
        updateInbox(inboxId: string, updateInboxOptions: UpdateInboxOptions, options?: any) {
            return InboxControllerApiFp(configuration).updateInbox(inboxId, updateInboxOptions, options)(fetch, basePath);
        },
    };
};
...
export class InboxControllerApi extends BaseAPI {
     ...
     */
    public createInbox(allowTeamAccess?: boolean, description?: string, emailAddress?: string, expiresAt?: Date, expiresIn?: number, favourite?: boolean, inboxType?: 'HTTP_INBOX' | 'SMTP_INBOX', name?: string, tags?: Array<string>, useDomainPool?: boolean, options?: any) {
        return InboxControllerApiFp(this.configuration).createInbox(allowTeamAccess, description, emailAddress, expiresAt, expiresIn, favourite, inboxType, name, tags, useDomainPool, options)(this.fetch, this.basePath);
    }
    ...
    public createInboxWithDefaults(options?: any) {
        return InboxControllerApiFp(this.configuration).createInboxWithDefaults(options)(this.fetch, this.basePath);
    }
     ...
     * @memberof InboxControllerApi
     */
    public createInboxWithOptions(createInboxDto: CreateInboxDto, options?: any) {
        return InboxControllerApiFp(this.configuration).createInboxWithOptions(createInboxDto, options)(this.fetch, this.basePath);
    }
    ...
    public deleteAllInboxes(options?: any) {
        return InboxControllerApiFp(this.configuration).deleteAllInboxes(options)(this.fetch, this.basePath);
    }
     ...
     * @memberof InboxControllerApi
     */
    public getAllInboxes(favourite?: boolean, page?: number, search?: string, size?: number, sort?: 'ASC' | 'DESC', tag?: string, teamAccess?: boolean, options?: any) {
        return InboxControllerApiFp(this.configuration).getAllInboxes(favourite, page, search, size, sort, tag, teamAccess, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof InboxControllerApi
     */
    public getEmails(inboxId: string, limit?: number, minCount?: number, retryTimeout?: number, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
        return InboxControllerApiFp(this.configuration).getEmails(inboxId, limit, minCount, retryTimeout, since, size, sort, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof InboxControllerApi
     */
    public getInboxEmailsPaginated(inboxId: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
        return InboxControllerApiFp(this.configuration).getInboxEmailsPaginated(inboxId, page, size, sort, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof InboxControllerApi
     */
    public getInboxSentEmails(inboxId: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
        return InboxControllerApiFp(this.configuration).getInboxSentEmails(inboxId, page, size, sort, options)(this.fetch, this.basePath);
    }
    ...
    public getInboxTags(options?: any) {
        return InboxControllerApiFp(this.configuration).getInboxTags(options)(this.fetch, this.basePath);
    }
    ...
    public getInboxes(size?: number, sort?: 'ASC' | 'DESC', options?: any) {
        return InboxControllerApiFp(this.configuration).getInboxes(size, sort, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof InboxControllerApi
     */
    public getOrganizationInboxes(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
        return InboxControllerApiFp(this.configuration).getOrganizationInboxes(page, size, sort, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof InboxControllerApi
     */
    public sendEmailAndConfirm(inboxId: string, sendEmailOptions?: SendEmailOptions, options?: any) {
        return InboxControllerApiFp(this.configuration).sendEmailAndConfirm(inboxId, sendEmailOptions, options)(this.fetch, this.basePath);
    }
    ...
    public sendTestEmail(inboxId: string, options?: any) {
        return InboxControllerApiFp(this.configuration).sendTestEmail(inboxId, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof InboxControllerApi
     */
    public setInboxFavourited(inboxId: string, setInboxFavouritedOptions: SetInboxFavouritedOptions, options?: any) {
        return InboxControllerApiFp(this.configuration).setInboxFavourited(inboxId, setInboxFavouritedOptions, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof InboxControllerApi
     */
    public updateInbox(inboxId: string, updateInboxOptions: UpdateInboxOptions, options?: any) {
        return InboxControllerApiFp(this.configuration).updateInbox(inboxId, updateInboxOptions, options)(this.fetch, this.basePath);
    }
 ...
 * @export
 */
export const MailServerControllerApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
        ...
        describeMailServerDomain(describeOptions: DescribeDomainOptions, options: any = {}): FetchArgs {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"DescribeDomainOptions" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(describeOptions || {}) : (describeOptions || "");
        ...
        getDnsLookup(dnsLookupOptions: DNSLookupOptions, options: any = {}): FetchArgs {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"DNSLookupOptions" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(dnsLookupOptions || {}) : (dnsLookupOptions || "");
        ...
        verifyEmailAddress(verifyOptions: VerifyEmailAddressOptions, options: any = {}): FetchArgs {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"VerifyEmailAddressOptions" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(verifyOptions || {}) : (verifyOptions || "");
 ...
 * @export
 */
export const MailServerControllerApiFp = function(configuration?: Configuration) {
    return {
        /**
         * 
         * @summary Get DNS Mail Server records for a domain
        ...
        describeMailServerDomain(describeOptions: DescribeDomainOptions, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<DescribeMailServerDomainResult> {
            const localVarFetchArgs = MailServerControllerApiFetchParamCreator(configuration).describeMailServerDomain(describeOptions, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getDnsLookup(dnsLookupOptions: DNSLookupOptions, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<DNSLookupResults> {
            const localVarFetchArgs = MailServerControllerApiFetchParamCreator(configuration).getDnsLookup(dnsLookupOptions, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getIpAddress(name: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<IPAddressResult> {
            const localVarFetchArgs = MailServerControllerApiFetchParamCreator(configuration).getIpAddress(name, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        verifyEmailAddress(verifyOptions: VerifyEmailAddressOptions, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<EmailVerificationResult> {
            const localVarFetchArgs = MailServerControllerApiFetchParamCreator(configuration).verifyEmailAddress(verifyOptions, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const MailServerControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * 
         * @summary Get DNS Mail Server records for a domain
         ...
         * @throws {RequiredError}
         */
        describeMailServerDomain(describeOptions: DescribeDomainOptions, options?: any) {
            return MailServerControllerApiFp(configuration).describeMailServerDomain(describeOptions, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Lookup DNS records for a domain
        ...
        getDnsLookup(dnsLookupOptions: DNSLookupOptions, options?: any) {
            return MailServerControllerApiFp(configuration).getDnsLookup(dnsLookupOptions, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get IP address for a domain
        ...
        getIpAddress(name: string, options?: any) {
            return MailServerControllerApiFp(configuration).getIpAddress(name, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Verify the existence of an email address at a given mail server.
         ...
         * @throws {RequiredError}
         */
        verifyEmailAddress(verifyOptions: VerifyEmailAddressOptions, options?: any) {
            return MailServerControllerApiFp(configuration).verifyEmailAddress(verifyOptions, options)(fetch, basePath);
        },
    };
};
...
export class MailServerControllerApi extends BaseAPI {
     ...
     */
    public describeMailServerDomain(describeOptions: DescribeDomainOptions, options?: any) {
        return MailServerControllerApiFp(this.configuration).describeMailServerDomain(describeOptions, options)(this.fetch, this.basePath);
    }
    ...
    public getDnsLookup(dnsLookupOptions: DNSLookupOptions, options?: any) {
        return MailServerControllerApiFp(this.configuration).getDnsLookup(dnsLookupOptions, options)(this.fetch, this.basePath);
    }
    ...
    public getIpAddress(name: string, options?: any) {
        return MailServerControllerApiFp(this.configuration).getIpAddress(name, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof MailServerControllerApi
     */
    public verifyEmailAddress(verifyOptions: VerifyEmailAddressOptions, options?: any) {
        return MailServerControllerApiFp(this.configuration).verifyEmailAddress(verifyOptions, options)(this.fetch, this.basePath);
    }
 ...
 * @export
 */
export const MissedEmailControllerApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        getAllMissedEmails(page?: number, size?: number, sort?: 'ASC' | 'DESC', options: any = {}): FetchArgs {
 ...
 * @export
 */
export const MissedEmailControllerApiFp = function(configuration?: Configuration) {
    return {
        /**
         * 
         * @summary Get all MissedEmails in paginated format
         ...
         * @throws {RequiredError}
         */
        getAllMissedEmails(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PageMissedEmailProjection> {
            const localVarFetchArgs = MissedEmailControllerApiFetchParamCreator(configuration).getAllMissedEmails(page, size, sort, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getMissedEmail(missedEmailId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<MissedEmail> {
            const localVarFetchArgs = MissedEmailControllerApiFetchParamCreator(configuration).getMissedEmail(missedEmailId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const MissedEmailControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * 
         * @summary Get all MissedEmails in paginated format
         ...
         * @throws {RequiredError}
         */
        getAllMissedEmails(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
            return MissedEmailControllerApiFp(configuration).getAllMissedEmails(page, size, sort, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get MissedEmail
        ...
        getMissedEmail(missedEmailId: string, options?: any) {
            return MissedEmailControllerApiFp(configuration).getMissedEmail(missedEmailId, options)(fetch, basePath);
        },
    };
};
...
export class MissedEmailControllerApi extends BaseAPI {
     ...
     */
    public getAllMissedEmails(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
        return MissedEmailControllerApiFp(this.configuration).getAllMissedEmails(page, size, sort, options)(this.fetch, this.basePath);
    }
    ...
    public getMissedEmail(missedEmailId: string, options?: any) {
        return MissedEmailControllerApiFp(this.configuration).getMissedEmail(missedEmailId, options)(this.fetch, this.basePath);
    }
 ...
 * @export
 */
export const SentEmailsControllerApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        getSentOrganizationEmails(inboxId?: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options: any = {}): FetchArgs {
 ...
 * @export
 */
export const SentEmailsControllerApiFp = function(configuration?: Configuration) {
    return {
        /**
         * 
         * @summary Get sent email receipt
        ...
        getSentEmail(id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SentEmailDto> {
            const localVarFetchArgs = SentEmailsControllerApiFetchParamCreator(configuration).getSentEmail(id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getSentEmails(inboxId?: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PageSentEmailProjection> {
            const localVarFetchArgs = SentEmailsControllerApiFetchParamCreator(configuration).getSentEmails(inboxId, page, size, sort, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getSentOrganizationEmails(inboxId?: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PageSentEmailProjection> {
            const localVarFetchArgs = SentEmailsControllerApiFetchParamCreator(configuration).getSentOrganizationEmails(inboxId, page, size, sort, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const SentEmailsControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * 
         * @summary Get sent email receipt
        ...
        getSentEmail(id: string, options?: any) {
            return SentEmailsControllerApiFp(configuration).getSentEmail(id, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get all sent emails in paginated form
         ...
         * @throws {RequiredError}
         */
        getSentEmails(inboxId?: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
            return SentEmailsControllerApiFp(configuration).getSentEmails(inboxId, page, size, sort, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get all sent organization emails in paginated form
         ...
         * @throws {RequiredError}
         */
        getSentOrganizationEmails(inboxId?: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
            return SentEmailsControllerApiFp(configuration).getSentOrganizationEmails(inboxId, page, size, sort, options)(fetch, basePath);
        },
    };
};
...
export class SentEmailsControllerApi extends BaseAPI {
    ...
    public getSentEmail(id: string, options?: any) {
        return SentEmailsControllerApiFp(this.configuration).getSentEmail(id, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof SentEmailsControllerApi
     */
    public getSentEmails(inboxId?: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
        return SentEmailsControllerApiFp(this.configuration).getSentEmails(inboxId, page, size, sort, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof SentEmailsControllerApi
     */
    public getSentOrganizationEmails(inboxId?: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
        return SentEmailsControllerApiFp(this.configuration).getSentOrganizationEmails(inboxId, page, size, sort, options)(this.fetch, this.basePath);
    }
 ...
 * @export
 */
export const TemplateControllerApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
        ...
        createTemplate(createTemplateOptions: CreateTemplateOptions, options: any = {}): FetchArgs {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"CreateTemplateOptions" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
...
export const TemplateControllerApiFp = function(configuration?: Configuration) {
    return {
        ...
        createTemplate(createTemplateOptions: CreateTemplateOptions, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<TemplateDto> {
            const localVarFetchArgs = TemplateControllerApiFetchParamCreator(configuration).createTemplate(createTemplateOptions, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        deleteTemplate(templateId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
            const localVarFetchArgs = TemplateControllerApiFetchParamCreator(configuration).deleteTemplate(templateId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response;
        ...
        getAllTemplates(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PageTemplateProjection> {
            const localVarFetchArgs = TemplateControllerApiFetchParamCreator(configuration).getAllTemplates(page, size, sort, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getTemplate(templateId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<TemplateDto> {
            const localVarFetchArgs = TemplateControllerApiFetchParamCreator(configuration).getTemplate(templateId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getTemplates(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<TemplateProjection>> {
            const localVarFetchArgs = TemplateControllerApiFetchParamCreator(configuration).getTemplates(options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const TemplateControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * 
         * @summary Create a Template
         ...
         * @throws {RequiredError}
         */
        createTemplate(createTemplateOptions: CreateTemplateOptions, options?: any) {
            return TemplateControllerApiFp(configuration).createTemplate(createTemplateOptions, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Delete Template
        ...
        deleteTemplate(templateId: string, options?: any) {
            return TemplateControllerApiFp(configuration).deleteTemplate(templateId, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get all Templates in paginated format
         ...
         * @throws {RequiredError}
         */
        getAllTemplates(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
            return TemplateControllerApiFp(configuration).getAllTemplates(page, size, sort, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get Template
        ...
        getTemplate(templateId: string, options?: any) {
            return TemplateControllerApiFp(configuration).getTemplate(templateId, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get all Templates
        ...
        getTemplates(options?: any) {
            return TemplateControllerApiFp(configuration).getTemplates(options)(fetch, basePath);
        },
    };
};
...
export class TemplateControllerApi extends BaseAPI {
     ...
     */
    public createTemplate(createTemplateOptions: CreateTemplateOptions, options?: any) {
        return TemplateControllerApiFp(this.configuration).createTemplate(createTemplateOptions, options)(this.fetch, this.basePath);
    }
    ...
    public deleteTemplate(templateId: string, options?: any) {
        return TemplateControllerApiFp(this.configuration).deleteTemplate(templateId, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof TemplateControllerApi
     */
    public getAllTemplates(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
        return TemplateControllerApiFp(this.configuration).getAllTemplates(page, size, sort, options)(this.fetch, this.basePath);
    }
    ...
    public getTemplate(templateId: string, options?: any) {
        return TemplateControllerApiFp(this.configuration).getTemplate(templateId, options)(this.fetch, this.basePath);
    }
    ...
    public getTemplates(options?: any) {
        return TemplateControllerApiFp(this.configuration).getTemplates(options)(this.fetch, this.basePath);
    }
 ...
 * @export
 */
export const WaitForControllerApiFetchParamCreator = function (configuration?: Configuration) {
    return {
        /**
        ...
        waitFor(waitForConditions?: WaitForConditions, options: any = {}): FetchArgs {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"WaitForConditions" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
...
export const WaitForControllerApiFp = function(configuration?: Configuration) {
    return {
        ...
        waitFor(waitForConditions?: WaitForConditions, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<EmailPreview>> {
            const localVarFetchArgs = WaitForControllerApiFetchParamCreator(configuration).waitFor(waitForConditions, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        waitForEmailCount(count?: number, inboxId?: string, timeout?: number, unreadOnly?: boolean, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<EmailPreview>> {
            const localVarFetchArgs = WaitForControllerApiFetchParamCreator(configuration).waitForEmailCount(count, inboxId, timeout, unreadOnly, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        waitForLatestEmail(inboxId?: string, timeout?: number, unreadOnly?: boolean, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Email> {
            const localVarFetchArgs = WaitForControllerApiFetchParamCreator(configuration).waitForLatestEmail(inboxId, timeout, unreadOnly, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        waitForMatchingEmail(matchOptions: MatchOptions, count?: number, inboxId?: string, timeout?: number, unreadOnly?: boolean, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<EmailPreview>> {
            const localVarFetchArgs = WaitForControllerApiFetchParamCreator(configuration).waitForMatchingEmail(matchOptions, count, inboxId, timeout, unreadOnly, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        waitForMatchingFirstEmail(matchOptions: MatchOptions, inboxId?: string, timeout?: number, unreadOnly?: boolean, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Email> {
            const localVarFetchArgs = WaitForControllerApiFetchParamCreator(configuration).waitForMatchingFirstEmail(matchOptions, inboxId, timeout, unreadOnly, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        waitForNthEmail(inboxId?: string, index?: number, timeout?: number, unreadOnly?: boolean, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Email> {
            const localVarFetchArgs = WaitForControllerApiFetchParamCreator(configuration).waitForNthEmail(inboxId, index, timeout, unreadOnly, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const WaitForControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * Generic waitFor method that will wait until an inbox meets given conditions or return immediately if already met
         * @summary Wait for an email to match the provided filter conditions such as subject contains keyword.
        ...
        waitFor(waitForConditions?: WaitForConditions, options?: any) {
            return WaitForControllerApiFp(configuration).waitFor(waitForConditions, options)(fetch, basePath);
        },
        /**
         * If inbox contains count or more emails at time of request then return count worth of emails. If not wait until the count is reached and return those or return an error if timeout is exceeded.
         * @summary Wait for and return count number of emails. Hold connection until inbox count matches expected or timeout occurs
         ...
         * @throws {RequiredError}
         */
        waitForEmailCount(count?: number, inboxId?: string, timeout?: number, unreadOnly?: boolean, options?: any) {
            return WaitForControllerApiFp(configuration).waitForEmailCount(count, inboxId, timeout, unreadOnly, options)(fetch, basePath);
        },
        /**
         * Will return either the last received email or wait for an email to arrive and return that. If you need to wait for an email for a non-empty inbox set `unreadOnly=true` or see the other receive methods such as `waitForNthEmail` or `waitForEmailCount`.
         * @summary Fetch inbox's latest email or if empty wait for an email to arrive
         ...
         * @throws {RequiredError}
         */
        waitForLatestEmail(inboxId?: string, timeout?: number, unreadOnly?: boolean, options?: any) {
            return WaitForControllerApiFp(configuration).waitForLatestEmail(inboxId, timeout, unreadOnly, options)(fetch, basePath);
        },
        /**
         * Perform a search of emails in an inbox with the given patterns. If results match expected count then return or else retry the search until results are found or timeout is reached. Match options allow simple CONTAINS or EQUALS filtering on SUBJECT, TO, BCC, CC, and FROM. See the `MatchOptions` object for options. An example payload is `{ matches: [{field: 'SUBJECT',should:'CONTAIN',value:'needle'}] }`. You can use an array of matches and they will be applied sequentially to filter out emails. If you want to perform matches and extractions of content using Regex patterns see the EmailController `getEmailContentMatch` method.
         * @summary Wait or return list of emails that match simple matching patterns
         ...
         * @throws {RequiredError}
         */
        waitForMatchingEmail(matchOptions: MatchOptions, count?: number, inboxId?: string, timeout?: number, unreadOnly?: boolean, options?: any) {
            return WaitForControllerApiFp(configuration).waitForMatchingEmail(matchOptions, count, inboxId, timeout, unreadOnly, options)(fetch, basePath);
        },
        /**
         * Perform a search of emails in an inbox with the given patterns. If a result if found then return or else retry the search until a result is found or timeout is reached. Match options allow simple CONTAINS or EQUALS filtering on SUBJECT, TO, BCC, CC, and FROM. See the `MatchOptions` object for options. An example payload is `{ matches: [{field: 'SUBJECT',should:'CONTAIN',value:'needle'}] }`. You can use an array of matches and they will be applied sequentially to filter out emails. If you want to perform matches and extractions of content using Regex patterns see the EmailController `getEmailContentMatch` method.
         * @summary Wait for or return the first email that matches proved MatchOptions array
         ...
         * @throws {RequiredError}
         */
        waitForMatchingFirstEmail(matchOptions: MatchOptions, inboxId?: string, timeout?: number, unreadOnly?: boolean, options?: any) {
            return WaitForControllerApiFp(configuration).waitForMatchingFirstEmail(matchOptions, inboxId, timeout, unreadOnly, options)(fetch, basePath);
        },
        /**
         * If nth email is already present in inbox then return it. If not hold the connection open until timeout expires or the nth email is received and returned.
         * @summary Wait for or fetch the email with a given index in the inbox specified. IF indx doesn't exist waits for it to exist or timeout to occur.
         ...
         * @throws {RequiredError}
         */
        waitForNthEmail(inboxId?: string, index?: number, timeout?: number, unreadOnly?: boolean, options?: any) {
            return WaitForControllerApiFp(configuration).waitForNthEmail(inboxId, index, timeout, unreadOnly, options)(fetch, basePath);
        },
    };
};
...
export class WaitForControllerApi extends BaseAPI {
    ...
    public waitFor(waitForConditions?: WaitForConditions, options?: any) {
        return WaitForControllerApiFp(this.configuration).waitFor(waitForConditions, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof WaitForControllerApi
     */
    public waitForEmailCount(count?: number, inboxId?: string, timeout?: number, unreadOnly?: boolean, options?: any) {
        return WaitForControllerApiFp(this.configuration).waitForEmailCount(count, inboxId, timeout, unreadOnly, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof WaitForControllerApi
     */
    public waitForLatestEmail(inboxId?: string, timeout?: number, unreadOnly?: boolean, options?: any) {
        return WaitForControllerApiFp(this.configuration).waitForLatestEmail(inboxId, timeout, unreadOnly, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof WaitForControllerApi
     */
    public waitForMatchingEmail(matchOptions: MatchOptions, count?: number, inboxId?: string, timeout?: number, unreadOnly?: boolean, options?: any) {
        return WaitForControllerApiFp(this.configuration).waitForMatchingEmail(matchOptions, count, inboxId, timeout, unreadOnly, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof WaitForControllerApi
     */
    public waitForMatchingFirstEmail(matchOptions: MatchOptions, inboxId?: string, timeout?: number, unreadOnly?: boolean, options?: any) {
        return WaitForControllerApiFp(this.configuration).waitForMatchingFirstEmail(matchOptions, inboxId, timeout, unreadOnly, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof WaitForControllerApi
     */
    public waitForNthEmail(inboxId?: string, index?: number, timeout?: number, unreadOnly?: boolean, options?: any) {
        return WaitForControllerApiFp(this.configuration).waitForNthEmail(inboxId, index, timeout, unreadOnly, options)(this.fetch, this.basePath);
    }
...
export const WebhookControllerApiFp = function(configuration?: Configuration) {
    return {
        ...
        createWebhook(inboxId: string, webhookOptions: CreateWebhookOptions, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<WebhookDto> {
            const localVarFetchArgs = WebhookControllerApiFetchParamCreator(configuration).createWebhook(inboxId, webhookOptions, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        deleteWebhook(inboxId: string, webhookId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
            const localVarFetchArgs = WebhookControllerApiFetchParamCreator(configuration).deleteWebhook(inboxId, webhookId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response;
        ...
        getAllWebhooks(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PageWebhookProjection> {
            const localVarFetchArgs = WebhookControllerApiFetchParamCreator(configuration).getAllWebhooks(page, size, sort, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getTestWebhookPayload(eventName?: 'EMAIL_RECEIVED' | 'NEW_EMAIL' | 'NEW_CONTACT' | 'NEW_ATTACHMENT', options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<AbstractWebhookPayload> {
            const localVarFetchArgs = WebhookControllerApiFetchParamCreator(configuration).getTestWebhookPayload(eventName, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getWebhook(webhookId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<WebhookDto> {
            const localVarFetchArgs = WebhookControllerApiFetchParamCreator(configuration).getWebhook(webhookId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        getWebhooks(inboxId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<WebhookDto>> {
            const localVarFetchArgs = WebhookControllerApiFetchParamCreator(configuration).getWebhooks(inboxId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
        ...
        sendTestData(webhookId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<WebhookTestResult> {
            const localVarFetchArgs = WebhookControllerApiFetchParamCreator(configuration).sendTestData(webhookId, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const WebhookControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * Get notified whenever an inbox receives an email via a WebHook URL. An emailID will be posted to this URL every time an email is received for this inbox. The URL must be publicly reachable by the MailSlurp server. You can provide basicAuth values if you wish to secure this endpoint.
         * @summary Attach a WebHook URL to an inbox
         ...
         * @throws {RequiredError}
         */
        createWebhook(inboxId: string, webhookOptions: CreateWebhookOptions, options?: any) {
            return WebhookControllerApiFp(configuration).createWebhook(inboxId, webhookOptions, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Delete and disable a Webhook for an Inbox
        ...
        deleteWebhook(inboxId: string, webhookId: string, options?: any) {
            return WebhookControllerApiFp(configuration).deleteWebhook(inboxId, webhookId, options)(fetch, basePath);
        },
        /**
         * List webhooks in paginated form. Allows for page index, page size, and sort direction.
         * @summary List Webhooks Paginated
         ...
         * @throws {RequiredError}
         */
        getAllWebhooks(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
            return WebhookControllerApiFp(configuration).getAllWebhooks(page, size, sort, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get test webhook payload example. Response content depends on eventName passed. Uses `EMAIL_RECEIVED` as default.
         ...
         * @throws {RequiredError}
         */
        getTestWebhookPayload(eventName?: 'EMAIL_RECEIVED' | 'NEW_EMAIL' | 'NEW_CONTACT' | 'NEW_ATTACHMENT', options?: any) {
            return WebhookControllerApiFp(configuration).getTestWebhookPayload(eventName, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get a webhook for an Inbox
        ...
        getWebhook(webhookId: string, options?: any) {
            return WebhookControllerApiFp(configuration).getWebhook(webhookId, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get all webhooks for an Inbox
        ...
        getWebhooks(inboxId: string, options?: any) {
            return WebhookControllerApiFp(configuration).getWebhooks(inboxId, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Send webhook test data
        ...
        sendTestData(webhookId: string, options?: any) {
            return WebhookControllerApiFp(configuration).sendTestData(webhookId, options)(fetch, basePath);
        },
    };
};
...
export class WebhookControllerApi extends BaseAPI {
     ...
     */
    public createWebhook(inboxId: string, webhookOptions: CreateWebhookOptions, options?: any) {
        return WebhookControllerApiFp(this.configuration).createWebhook(inboxId, webhookOptions, options)(this.fetch, this.basePath);
    }
    ...
    public deleteWebhook(inboxId: string, webhookId: string, options?: any) {
        return WebhookControllerApiFp(this.configuration).deleteWebhook(inboxId, webhookId, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof WebhookControllerApi
     */
    public getAllWebhooks(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any) {
        return WebhookControllerApiFp(this.configuration).getAllWebhooks(page, size, sort, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof WebhookControllerApi
     */
    public getTestWebhookPayload(eventName?: 'EMAIL_RECEIVED' | 'NEW_EMAIL' | 'NEW_CONTACT' | 'NEW_ATTACHMENT', options?: any) {
        return WebhookControllerApiFp(this.configuration).getTestWebhookPayload(eventName, options)(this.fetch, this.basePath);
    }
    ...
    public getWebhook(webhookId: string, options?: any) {
        return WebhookControllerApiFp(this.configuration).getWebhook(webhookId, options)(this.fetch, this.basePath);
    }
    ...
    public getWebhooks(inboxId: string, options?: any) {
        return WebhookControllerApiFp(this.configuration).getWebhooks(inboxId, options)(this.fetch, this.basePath);
    }
    ...
    public sendTestData(webhookId: string, options?: any) {
        return WebhookControllerApiFp(this.configuration).sendTestData(webhookId, options)(this.fetch, this.basePath);
    }
