    ...
    return {
        ...
        describeDomain(
            ...
            if (describeOptions === null || describeOptions === undefined) {
                throw new RequiredError(
                    'describeOptions',
                    'Required parameter describeOptions was null or undefined when calling describeDomain.'
                );
            }
            const localVarPath = `/mail-server/describe/domain-mx-records`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign(
                { method: 'POST' },
                options
    ...
    return {
        ...
        describeDomain(
            ...
            const localVarFetchArgs = MailServerControllerApiFetchParamCreator(
                configuration
            ).describeDomain(describeOptions, options);
            return (
                fetch: FetchAPI = portableFetch,
                basePath: string = BASE_PATH
            ) => {
...
export const MailServerControllerApiFactory = function(
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        describeDomain(describeOptions: DescribeDomainOptions, options?: any) {
            return MailServerControllerApiFp(configuration).describeDomain(
                describeOptions,
                options
            )(fetch, basePath);
        },
...
export class MailServerControllerApi extends BaseAPI {
    ...
    public describeDomain(
        ...
        return MailServerControllerApiFp(this.configuration).describeDomain(
            describeOptions,
            options
        )(this.fetch, this.basePath);
    }
