    ...
    return {
        ...
        getAliasVerification(
            ...
            if (aliasId === null || aliasId === undefined) {
                throw new RequiredError(
                    'aliasId',
                    'Required parameter aliasId was null or undefined when calling getAliasVerification.'
                );
            }
            ...
            if (emailAddress === null || emailAddress === undefined) {
                throw new RequiredError(
                    'emailAddress',
                    'Required parameter emailAddress was null or undefined when calling getAliasVerification.'
                );
            }
            ...
            if (verificationToken === null || verificationToken === undefined) {
                throw new RequiredError(
                    'verificationToken',
                    'Required parameter verificationToken was null or undefined when calling getAliasVerification.'
                );
            }
            const localVarPath = `/aliases/{aliasId}/verification`.replace(
                `{${'aliasId'}}`,
                encodeURIComponent(String(aliasId))
            );
            const localVarUrlObj = url.parse(localVarPath, true);
...
export const AliasControllerApiFactory = function(
    ...
    return {
        ...
        getAliasVerification(
            ...
            return AliasControllerApiFp(configuration).getAliasVerification(
                aliasId,
                emailAddress,
                verificationToken,
                options
...
export class AliasControllerApi extends BaseAPI {
     ...
     * @memberof AliasControllerApi
     */
    public getAliasVerification(
        aliasId: string,
        emailAddress: string,
        verificationToken: string,
        options?: any
    ) {
        return AliasControllerApiFp(this.configuration).getAliasVerification(
            aliasId,
            emailAddress,
            verificationToken,
            options
