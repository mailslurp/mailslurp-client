[MailSlurp JS](../README.md) › [Globals](../globals.md) › ["node_modules/@types/node/crypto.d"](../modules/_node_modules__types_node_crypto_d_.md) › ["crypto"](../modules/_node_modules__types_node_crypto_d_._crypto_.md) › [Hmac](_node_modules__types_node_crypto_d_._crypto_.hmac.md)
...
* [constructor](_node_modules__types_node_crypto_d_._crypto_.hmac.md#private-constructor)

### Properties

* [readable](_node_modules__types_node_crypto_d_._crypto_.hmac.md#readable)
* [readableHighWaterMark](_node_modules__types_node_crypto_d_._crypto_.hmac.md#readablehighwatermark)
* [readableLength](_node_modules__types_node_crypto_d_._crypto_.hmac.md#readablelength)
* [writable](_node_modules__types_node_crypto_d_._crypto_.hmac.md#writable)
* [writableFinished](_node_modules__types_node_crypto_d_._crypto_.hmac.md#writablefinished)
* [writableHighWaterMark](_node_modules__types_node_crypto_d_._crypto_.hmac.md#writablehighwatermark)
* [writableLength](_node_modules__types_node_crypto_d_._crypto_.hmac.md#writablelength)
* [defaultMaxListeners](_node_modules__types_node_crypto_d_._crypto_.hmac.md#static-defaultmaxlisteners)

### Methods

* [__@asyncIterator](_node_modules__types_node_crypto_d_._crypto_.hmac.md#__@asynciterator)
* [_destroy](_node_modules__types_node_crypto_d_._crypto_.hmac.md#_destroy)
* [_final](_node_modules__types_node_crypto_d_._crypto_.hmac.md#_final)
* [_flush](_node_modules__types_node_crypto_d_._crypto_.hmac.md#_flush)
* [_read](_node_modules__types_node_crypto_d_._crypto_.hmac.md#_read)
* [_transform](_node_modules__types_node_crypto_d_._crypto_.hmac.md#_transform)
* [_write](_node_modules__types_node_crypto_d_._crypto_.hmac.md#_write)
* [_writev](_node_modules__types_node_crypto_d_._crypto_.hmac.md#optional-_writev)
* [addListener](_node_modules__types_node_crypto_d_._crypto_.hmac.md#addlistener)
* [cork](_node_modules__types_node_crypto_d_._crypto_.hmac.md#cork)
* [destroy](_node_modules__types_node_crypto_d_._crypto_.hmac.md#destroy)
* [digest](_node_modules__types_node_crypto_d_._crypto_.hmac.md#digest)
* [emit](_node_modules__types_node_crypto_d_._crypto_.hmac.md#emit)
* [end](_node_modules__types_node_crypto_d_._crypto_.hmac.md#end)
* [eventNames](_node_modules__types_node_crypto_d_._crypto_.hmac.md#eventnames)
* [getMaxListeners](_node_modules__types_node_crypto_d_._crypto_.hmac.md#getmaxlisteners)
* [isPaused](_node_modules__types_node_crypto_d_._crypto_.hmac.md#ispaused)
* [listenerCount](_node_modules__types_node_crypto_d_._crypto_.hmac.md#listenercount)
* [listeners](_node_modules__types_node_crypto_d_._crypto_.hmac.md#listeners)
* [off](_node_modules__types_node_crypto_d_._crypto_.hmac.md#off)
* [on](_node_modules__types_node_crypto_d_._crypto_.hmac.md#on)
* [once](_node_modules__types_node_crypto_d_._crypto_.hmac.md#once)
* [pause](_node_modules__types_node_crypto_d_._crypto_.hmac.md#pause)
* [pipe](_node_modules__types_node_crypto_d_._crypto_.hmac.md#pipe)
* [prependListener](_node_modules__types_node_crypto_d_._crypto_.hmac.md#prependlistener)
* [prependOnceListener](_node_modules__types_node_crypto_d_._crypto_.hmac.md#prependoncelistener)
* [push](_node_modules__types_node_crypto_d_._crypto_.hmac.md#push)
* [rawListeners](_node_modules__types_node_crypto_d_._crypto_.hmac.md#rawlisteners)
* [read](_node_modules__types_node_crypto_d_._crypto_.hmac.md#read)
* [removeAllListeners](_node_modules__types_node_crypto_d_._crypto_.hmac.md#removealllisteners)
* [removeListener](_node_modules__types_node_crypto_d_._crypto_.hmac.md#removelistener)
* [resume](_node_modules__types_node_crypto_d_._crypto_.hmac.md#resume)
* [setDefaultEncoding](_node_modules__types_node_crypto_d_._crypto_.hmac.md#setdefaultencoding)
* [setEncoding](_node_modules__types_node_crypto_d_._crypto_.hmac.md#setencoding)
* [setMaxListeners](_node_modules__types_node_crypto_d_._crypto_.hmac.md#setmaxlisteners)
* [uncork](_node_modules__types_node_crypto_d_._crypto_.hmac.md#uncork)
* [unpipe](_node_modules__types_node_crypto_d_._crypto_.hmac.md#unpipe)
* [unshift](_node_modules__types_node_crypto_d_._crypto_.hmac.md#unshift)
* [update](_node_modules__types_node_crypto_d_._crypto_.hmac.md#update)
* [wrap](_node_modules__types_node_crypto_d_._crypto_.hmac.md#wrap)
* [write](_node_modules__types_node_crypto_d_._crypto_.hmac.md#write)
* [from](_node_modules__types_node_crypto_d_._crypto_.hmac.md#static-from)
* [listenerCount](_node_modules__types_node_crypto_d_._crypto_.hmac.md#static-listenercount)

## Constructors

### `Private` constructor

\+ **new Hmac**(): *[Hmac](_node_modules__types_node_crypto_d_._crypto_.hmac.md)*

*Overrides [Transform](_node_modules__types_node_stream_d_._stream_.internal.transform.md).[constructor](_node_modules__types_node_stream_d_._stream_.internal.transform.md#constructor)*

Defined in node_modules/@types/node/crypto.d.ts:128

**Returns:** *[Hmac](_node_modules__types_node_crypto_d_._crypto_.hmac.md)*
...
▸ **digest**(`encoding`: [HexBase64Latin1Encoding](../modules/_node_modules__types_node_crypto_d_._crypto_.md#hexbase64latin1encoding)): *string*
...
▸ **update**(`data`: [BinaryLike](../modules/_node_modules__types_node_crypto_d_._crypto_.md#binarylike)): *[Hmac](_node_modules__types_node_crypto_d_._crypto_.hmac.md)*

Defined in node_modules/@types/node/crypto.d.ts:130
...
▸ **update**(`data`: string, `input_encoding`: [Utf8AsciiLatin1Encoding](../modules/_node_modules__types_node_crypto_d_._crypto_.md#utf8asciilatin1encoding)): *[Hmac](_node_modules__types_node_crypto_d_._crypto_.hmac.md)*
