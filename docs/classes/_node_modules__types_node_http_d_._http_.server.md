[MailSlurp JS](../README.md) › [Globals](../globals.md) › ["node_modules/@types/node/http.d"](../modules/_node_modules__types_node_http_d_.md) › ["http"](../modules/_node_modules__types_node_http_d_._http_.md) › [Server](_node_modules__types_node_http_d_._http_.server.md)
...
* [constructor](_node_modules__types_node_http_d_._http_.server.md#constructor)

### Properties

* [connections](_node_modules__types_node_http_d_._http_.server.md#connections)
* [headersTimeout](_node_modules__types_node_http_d_._http_.server.md#headerstimeout)
* [keepAliveTimeout](_node_modules__types_node_http_d_._http_.server.md#keepalivetimeout)
* [listening](_node_modules__types_node_http_d_._http_.server.md#listening)
* [maxConnections](_node_modules__types_node_http_d_._http_.server.md#maxconnections)
* [maxHeadersCount](_node_modules__types_node_http_d_._http_.server.md#maxheaderscount)
* [timeout](_node_modules__types_node_http_d_._http_.server.md#timeout)
* [defaultMaxListeners](_node_modules__types_node_http_d_._http_.server.md#static-defaultmaxlisteners)

### Methods

* [addListener](_node_modules__types_node_http_d_._http_.server.md#addlistener)
* [address](_node_modules__types_node_http_d_._http_.server.md#address)
* [close](_node_modules__types_node_http_d_._http_.server.md#close)
* [emit](_node_modules__types_node_http_d_._http_.server.md#emit)
* [eventNames](_node_modules__types_node_http_d_._http_.server.md#eventnames)
* [getConnections](_node_modules__types_node_http_d_._http_.server.md#getconnections)
* [getMaxListeners](_node_modules__types_node_http_d_._http_.server.md#getmaxlisteners)
* [listen](_node_modules__types_node_http_d_._http_.server.md#listen)
* [listenerCount](_node_modules__types_node_http_d_._http_.server.md#listenercount)
* [listeners](_node_modules__types_node_http_d_._http_.server.md#listeners)
* [off](_node_modules__types_node_http_d_._http_.server.md#off)
* [on](_node_modules__types_node_http_d_._http_.server.md#on)
* [once](_node_modules__types_node_http_d_._http_.server.md#once)
* [prependListener](_node_modules__types_node_http_d_._http_.server.md#prependlistener)
* [prependOnceListener](_node_modules__types_node_http_d_._http_.server.md#prependoncelistener)
* [rawListeners](_node_modules__types_node_http_d_._http_.server.md#rawlisteners)
* [ref](_node_modules__types_node_http_d_._http_.server.md#ref)
* [removeAllListeners](_node_modules__types_node_http_d_._http_.server.md#removealllisteners)
* [removeListener](_node_modules__types_node_http_d_._http_.server.md#removelistener)
* [setMaxListeners](_node_modules__types_node_http_d_._http_.server.md#setmaxlisteners)
* [setTimeout](_node_modules__types_node_http_d_._http_.server.md#settimeout)
* [unref](_node_modules__types_node_http_d_._http_.server.md#unref)
* [listenerCount](_node_modules__types_node_http_d_._http_.server.md#static-listenercount)

## Constructors

###  constructor

\+ **new Server**(`requestListener?`: [RequestListener](../modules/_node_modules__types_node_http_d_._http_.md#requestlistener)): *[Server](_node_modules__types_node_http_d_._http_.server.md)*
...
Name | Type |
------ | ------ |
`requestListener?` | [RequestListener](../modules/_node_modules__types_node_http_d_._http_.md#requestlistener) |

**Returns:** *[Server](_node_modules__types_node_http_d_._http_.server.md)*

\+ **new Server**(`options`: [ServerOptions](../interfaces/_node_modules__types_node_http_d_._http_.serveroptions.md), `requestListener?`: [RequestListener](../modules/_node_modules__types_node_http_d_._http_.md#requestlistener)): *[Server](_node_modules__types_node_http_d_._http_.server.md)*
...
*Inherited from [Server](_node_modules__types_node_net_d_._net_.server.md).[addListener](_node_modules__types_node_net_d_._net_.server.md#addlistener)*
...
*Inherited from [Server](_node_modules__types_node_net_d_._net_.server.md).[emit](_node_modules__types_node_net_d_._net_.server.md#emit)*
...
*Inherited from [Server](_node_modules__types_node_net_d_._net_.server.md).[on](_node_modules__types_node_net_d_._net_.server.md#on)*
...
*Inherited from [Server](_node_modules__types_node_net_d_._net_.server.md).[once](_node_modules__types_node_net_d_._net_.server.md#once)*
...
*Inherited from [Server](_node_modules__types_node_net_d_._net_.server.md).[prependListener](_node_modules__types_node_net_d_._net_.server.md#prependlistener)*
...
*Inherited from [Server](_node_modules__types_node_net_d_._net_.server.md).[prependOnceListener](_node_modules__types_node_net_d_._net_.server.md#prependoncelistener)*
