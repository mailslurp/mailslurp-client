...
export declare const MailServerControllerApiFetchParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    describeDomain(describeOptions: DescribeDomainOptions, options?: any): FetchArgs;
    /**
     *
...
export declare const MailServerControllerApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    describeDomain(describeOptions: DescribeDomainOptions, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response>;
    /**
     *
     * @summary Verify the existence of an email address at a given mail server.
     * @param {VerifyEmailAddressOptions} verifyOptions verifyOptions
     ...
     * @throws {RequiredError}
     */
    verifyEmailAddress(verifyOptions: VerifyEmailAddressOptions, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response>;
};
/**
...
export declare const MailServerControllerApiFactory: (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) => {
     ...
     * @throws {RequiredError}
     */
    describeDomain(describeOptions: DescribeDomainOptions, options?: any): Promise<Response>;
    /**
     *
     * @summary Verify the existence of an email address at a given mail server.
     * @param {VerifyEmailAddressOptions} verifyOptions verifyOptions
     ...
     * @throws {RequiredError}
     */
    verifyEmailAddress(verifyOptions: VerifyEmailAddressOptions, options?: any): Promise<Response>;
};
/**
...
export declare const SentEmailsControllerApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getSentEmail(id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SentEmail>;
    /**
     *
     * @summary Get all sent emails in paginated form
     * @param {string} [inboxId] Optional inboxId to filter sender of sent emails by
...
export declare const SentEmailsControllerApiFactory: (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) => {
     ...
     * @throws {RequiredError}
     */
    getSentEmail(id: string, options?: any): Promise<SentEmail>;
    /**
     *
     * @summary Get all sent emails in paginated form
     * @param {string} [inboxId] Optional inboxId to filter sender of sent emails by
