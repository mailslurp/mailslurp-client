...
export declare const InboxControllerApiFetchParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getExpiredInboxRecordById(expiredId: string, options?: any): FetchArgs;
    /**
     ...
     * @throws {RequiredError}
     */
    getExpiredInboxRecordByInboxId(inboxId: string, options?: any): FetchArgs;
    /**
     ...
     * @throws {RequiredError}
     */
    getExpiredInboxRecords(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any): FetchArgs;
    /**
...
export declare const InboxControllerApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getExpiredInboxRecordById(expiredId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ExpiredInboxDto>;
    /**
     * Use the inboxId to return an ExpiredInboxRecord if an inbox has expired. Inboxes expire and are disabled if an expiration date is set or plan requires. Returns 404 if no expired inbox is found for the inboxId
     * @summary Get expired inbox record for a previously existing inbox
     * @param {string} inboxId ID of inbox you want to retrieve (not the inbox ID)
     ...
     * @throws {RequiredError}
     */
    getExpiredInboxRecordByInboxId(inboxId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ExpiredInboxDto>;
    /**
     * Inboxes created with an expiration date will expire after the given date. An ExpiredInboxRecord is created that records the inboxes old ID and email address. You can still read emails in the inbox (using the inboxes old ID) but the email address associated with the inbox can no longer send or receive emails. Fetch expired inbox records to view the old inboxes properties
     * @summary List records of expired inboxes
     * @param {number} [page] Optional page index in inbox sent email list pagination
     ...
     * @throws {RequiredError}
     */
    getExpiredInboxRecords(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PageExpiredInboxRecordProjection>;
    /**
     * Returns an inbox's properties, including its email address and ID.
     * @summary Get Inbox
     * @param {string} inboxId inboxId
...
export declare const InboxControllerApiFactory: (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) => {
     ...
     * @throws {RequiredError}
     */
    getExpiredInboxRecordById(expiredId: string, options?: any): Promise<ExpiredInboxDto>;
    /**
     * Use the inboxId to return an ExpiredInboxRecord if an inbox has expired. Inboxes expire and are disabled if an expiration date is set or plan requires. Returns 404 if no expired inbox is found for the inboxId
     * @summary Get expired inbox record for a previously existing inbox
     * @param {string} inboxId ID of inbox you want to retrieve (not the inbox ID)
     ...
     * @throws {RequiredError}
     */
    getExpiredInboxRecordByInboxId(inboxId: string, options?: any): Promise<ExpiredInboxDto>;
    /**
     * Inboxes created with an expiration date will expire after the given date. An ExpiredInboxRecord is created that records the inboxes old ID and email address. You can still read emails in the inbox (using the inboxes old ID) but the email address associated with the inbox can no longer send or receive emails. Fetch expired inbox records to view the old inboxes properties
     * @summary List records of expired inboxes
     * @param {number} [page] Optional page index in inbox sent email list pagination
     ...
     * @throws {RequiredError}
     */
    getExpiredInboxRecords(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any): Promise<PageExpiredInboxRecordProjection>;
    /**
     * Returns an inbox's properties, including its email address and ID.
     * @summary Get Inbox
     * @param {string} inboxId inboxId
