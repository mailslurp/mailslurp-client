...
export declare const EmailControllerApiFactory: (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) => {
     ...
     * @throws {RequiredError}
     */
    getOrganizationEmailsPaginated(inboxId?: Array<string>, page?: number, size?: number, sort?: 'ASC' | 'DESC', unreadOnly?: boolean, options?: any): Promise<PageEmailProjection>;
    /**
     * Returns a raw, unparsed, and unprocessed email. If your client has issues processing the response it is likely due to the response content-type which is text/plain. If you need a JSON response content-type use the getRawEmailJson endpoint
     * @summary Get raw email string. Returns unparsed raw SMTP message with headers and body.
     * @param {string} emailId ID of email
...
export declare const InboxControllerApiFactory: (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) => {
     ...
     * @throws {RequiredError}
     */
    getOrganizationInboxes(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any): Promise<PageOrganizationInboxProjection>;
    /**
     * Send an email from an inbox's email address.  The request body should contain the `SendEmailOptions` that include recipients, attachments, body etc. See `SendEmailOptions` for all available properties. Note the `inboxId` refers to the inbox's id not the inbox's email address. See https://www.mailslurp.com/guides/ for more information on how to send emails. This method does not return a sent email entity due to legacy reasons. To send and get a sent email as returned response use the sister method `sendEmailAndConfirm`.
     * @summary Send Email
     * @param {string} inboxId ID of the inbox you want to send the email from
...
export declare const MissedEmailControllerApiFactory: (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) => {
     ...
     * @throws {RequiredError}
     */
    getAllMissedEmails(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any): Promise<PageMissedEmailProjection>;
    /**
     *
     * @summary Get MissedEmail
     * @param {string} missedEmailId MissedEmailId
...
export declare const SentEmailsControllerApiFactory: (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) => {
     ...
     * @throws {RequiredError}
     */
    getSentOrganizationEmails(inboxId?: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any): Promise<PageSentEmailProjection>;
};
/**
...
export declare const WebhookControllerApiFetchParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getAllWebhookResults(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any): FetchArgs;
    /**
     ...
     * @throws {RequiredError}
     */
    getWebhookResults(webhookId: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any): FetchArgs;
    /**
     *
...
export declare const WebhookControllerApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getAllWebhookResults(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PageWebhookResult>;
    /**
     * List webhooks in paginated form. Allows for page index, page size, and sort direction.
     * @summary List Webhooks Paginated
     * @param {number} [page] Optional page index in list pagination
     ...
     * @throws {RequiredError}
     */
    getWebhookResults(webhookId: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<PageWebhookResult>;
    /**
     *
     * @summary Get all webhooks for an Inbox
     * @param {string} inboxId inboxId
