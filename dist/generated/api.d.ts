 ...
 *
 * OpenAPI spec version: 5540a3fed5023519913914316d2368678b76d5ef
 *
 *
...
export declare const InboxControllerApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    sendEmailAndConfirm(inboxId: string, sendEmailOptions?: SendEmailOptions, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<SentEmail>;
    /**
     * Set and return new favourite state for an inbox
     * @summary Set inbox favourited state
     * @param {string} inboxId inboxId
...
export declare const InboxControllerApiFactory: (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) => {
     ...
     * @throws {RequiredError}
     */
    sendEmailAndConfirm(inboxId: string, sendEmailOptions?: SendEmailOptions, options?: any): Promise<SentEmail>;
    /**
     * Set and return new favourite state for an inbox
     * @summary Set inbox favourited state
     * @param {string} inboxId inboxId
