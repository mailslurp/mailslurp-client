...
export interface WebhookPayload {
     ...
     * @memberof WebhookPayload
     */
    eventName?: WebhookPayload.EventNameEnum;
    /**
     * Who the email was sent from
     * @type {string}
     * @memberof WebhookPayload
...
export declare const InboxControllerApiFetchParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    createInbox(allowTeamAccess?: boolean, description?: string, emailAddress?: string, expiresAt?: Date, expiresIn?: number, favourite?: boolean, name?: string, tags?: Array<string>, useDomainPool?: boolean, options?: any): FetchArgs;
    /**
     *
...
export declare const InboxControllerApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    createInbox(allowTeamAccess?: boolean, description?: string, emailAddress?: string, expiresAt?: Date, expiresIn?: number, favourite?: boolean, name?: string, tags?: Array<string>, useDomainPool?: boolean, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Inbox>;
    /**
     *
     * @summary Create an inbox with default options. Uses MailSlurp domain pool address and is private.
     * @param {*} [options] Override http request option.
...
export declare const InboxControllerApiFactory: (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) => {
     ...
     * @throws {RequiredError}
     */
    createInbox(allowTeamAccess?: boolean, description?: string, emailAddress?: string, expiresAt?: Date, expiresIn?: number, favourite?: boolean, name?: string, tags?: Array<string>, useDomainPool?: boolean, options?: any): Promise<Inbox>;
    /**
     *
     * @summary Create an inbox with default options. Uses MailSlurp domain pool address and is private.
     * @param {*} [options] Override http request option.
...
export declare const WebhookControllerApiFetchParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getTestWebhookPayload(options?: any): FetchArgs;
    /**
     *
...
export declare const WebhookControllerApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getTestWebhookPayload(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<WebhookPayload>;
    /**
     *
     * @summary Get a webhook for an Inbox
     * @param {string} webhookId webhookId
...
export declare const WebhookControllerApiFactory: (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) => {
     ...
     * @throws {RequiredError}
     */
    getTestWebhookPayload(options?: any): Promise<WebhookPayload>;
    /**
     *
     * @summary Get a webhook for an Inbox
     * @param {string} webhookId webhookId
