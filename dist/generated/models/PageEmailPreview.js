...
exports.instanceOfPageEmailPreview = instanceOfPageEmailPreview;
...
exports.PageEmailPreviewToJSONTyped = PageEmailPreviewToJSONTyped;
var PageableObject_1 = require("./PageableObject");
var SortObject_1 = require("./SortObject");
var EmailPreview_1 = require("./EmailPreview");
/**
 * Check if a given object implements the PageEmailPreview interface.
 */
function instanceOfPageEmailPreview(value) {
...
function PageEmailPreviewFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'content': json['content'] == null ? undefined : (json['content'].map(EmailPreview_1.EmailPreviewFromJSON)),
...
function PageEmailPreviewToJSON(json) {
    return PageEmailPreviewToJSONTyped(json, false);
}
function PageEmailPreviewToJSONTyped(value, ignoreDiscriminator) {
    if (ignoreDiscriminator === void 0) { ignoreDiscriminator = false; }
    if (value == null) {
        return value;
    }
    return {
        'content': value['content'] == null ? undefined : (value['content'].map(EmailPreview_1.EmailPreviewToJSON)),
