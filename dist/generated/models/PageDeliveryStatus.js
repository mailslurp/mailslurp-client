...
function PageDeliveryStatusFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'content': !(0, runtime_1.exists)(json, 'content') ? undefined : (json['content'].map(_1.DeliveryStatusDtoFromJSON)),
...
function PageDeliveryStatusToJSON(value) {
    ...
    return {
        'content': value.content === undefined ? undefined : (value.content.map(_1.DeliveryStatusDtoToJSON)),
