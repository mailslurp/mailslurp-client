...
exports.instanceOfPageDeliveryStatus = instanceOfPageDeliveryStatus;
...
exports.PageDeliveryStatusToJSONTyped = PageDeliveryStatusToJSONTyped;
var PageableObject_1 = require("./PageableObject");
var DeliveryStatusDto_1 = require("./DeliveryStatusDto");
var SortObject_1 = require("./SortObject");
/**
 * Check if a given object implements the PageDeliveryStatus interface.
 */
function instanceOfPageDeliveryStatus(value) {
...
function PageDeliveryStatusFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'content': json['content'] == null ? undefined : (json['content'].map(DeliveryStatusDto_1.DeliveryStatusDtoFromJSON)),
...
function PageDeliveryStatusToJSON(json) {
    return PageDeliveryStatusToJSONTyped(json, false);
}
function PageDeliveryStatusToJSONTyped(value, ignoreDiscriminator) {
    if (ignoreDiscriminator === void 0) { ignoreDiscriminator = false; }
    if (value == null) {
        return value;
    }
    return {
        'content': value['content'] == null ? undefined : (value['content'].map(DeliveryStatusDto_1.DeliveryStatusDtoToJSON)),
