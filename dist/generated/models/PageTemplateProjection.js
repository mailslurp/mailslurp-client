...
exports.PageTemplateProjectionToJSON = exports.PageTemplateProjectionFromJSONTyped = exports.PageTemplateProjectionFromJSON = void 0;
...
function PageTemplateProjectionFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'content': !(0, runtime_1.exists)(json, 'content') ? undefined : (json['content'].map(_1.TemplateProjectionFromJSON)),
...
function PageTemplateProjectionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        'content': value.content === undefined ? undefined : (value.content.map(_1.TemplateProjectionToJSON)),
        'empty': value.empty,
        'first': value.first,
        'last': value.last,
        'number': value.number,
