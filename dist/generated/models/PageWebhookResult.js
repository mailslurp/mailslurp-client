...
exports.instanceOfPageWebhookResult = instanceOfPageWebhookResult;
...
exports.PageWebhookResultToJSONTyped = PageWebhookResultToJSONTyped;
var PageableObject_1 = require("./PageableObject");
var SortObject_1 = require("./SortObject");
var WebhookResultDto_1 = require("./WebhookResultDto");
/**
 * Check if a given object implements the PageWebhookResult interface.
 */
function instanceOfPageWebhookResult(value) {
...
function PageWebhookResultFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'content': json['content'] == null ? undefined : (json['content'].map(WebhookResultDto_1.WebhookResultDtoFromJSON)),
...
function PageWebhookResultToJSON(json) {
    return PageWebhookResultToJSONTyped(json, false);
}
function PageWebhookResultToJSONTyped(value, ignoreDiscriminator) {
    if (ignoreDiscriminator === void 0) { ignoreDiscriminator = false; }
    if (value == null) {
        return value;
    }
    return {
        'content': value['content'] == null ? undefined : (value['content'].map(WebhookResultDto_1.WebhookResultDtoToJSON)),
