...
exports.ImapServerListResultToJSON = exports.ImapServerListResultFromJSONTyped = exports.ImapServerListResultFromJSON = void 0;
var _1 = require("./");
...
function ImapServerListResultToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
