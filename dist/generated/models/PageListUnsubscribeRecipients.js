...
exports.PageListUnsubscribeRecipientsToJSON = exports.PageListUnsubscribeRecipientsFromJSONTyped = exports.PageListUnsubscribeRecipientsFromJSON = void 0;
...
function PageListUnsubscribeRecipientsFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'content': !(0, runtime_1.exists)(json, 'content') ? undefined : (json['content'].map(_1.ListUnsubscribeRecipientProjectionFromJSON)),
...
function PageListUnsubscribeRecipientsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        'content': value.content === undefined ? undefined : (value.content.map(_1.ListUnsubscribeRecipientProjectionToJSON)),
