...
exports.EmailFeatureOverviewStatusesEnum = exports.EmailFeatureOverviewCategoryEnum = exports.EmailFeatureOverviewFeatureEnum = void 0;
exports.instanceOfEmailFeatureOverview = instanceOfEmailFeatureOverview;
...
exports.EmailFeatureOverviewToJSONTyped = EmailFeatureOverviewToJSONTyped;
var EmailFeatureFamilyStatistics_1 = require("./EmailFeatureFamilyStatistics");
/**
 * @export
 */
exports.EmailFeatureOverviewFeatureEnum = {
    amp: 'amp',
 ...
 * @export
 */
exports.EmailFeatureOverviewCategoryEnum = {
    css: 'css',
    html: 'html',
    image: 'image',
    others: 'others'
 ...
 * @export
 */
exports.EmailFeatureOverviewStatusesEnum = {
    SUPPORTED: 'SUPPORTED',
    PARTIAL: 'PARTIAL',
 ...
 */
function instanceOfEmailFeatureOverview(value) {
...
function EmailFeatureOverviewFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'featureStatistics': json['featureStatistics'] == null ? undefined : (json['featureStatistics'].map(EmailFeatureFamilyStatistics_1.EmailFeatureFamilyStatisticsFromJSON)),
        'statuses': new Set(json['statuses']),
    };
}
function EmailFeatureOverviewToJSON(json) {
    return EmailFeatureOverviewToJSONTyped(json, false);
}
function EmailFeatureOverviewToJSONTyped(value, ignoreDiscriminator) {
    ...
    return {
        ...
        'featureStatistics': value['featureStatistics'] == null ? undefined : (value['featureStatistics'].map(EmailFeatureFamilyStatistics_1.EmailFeatureFamilyStatisticsToJSON)),
