...
function ExportOptionsFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'createdEarliestTime': !(0, runtime_1.exists)(json, 'createdEarliestTime') ? undefined : (new Date(json['createdEarliestTime'])),
        'createdOldestTime': !(0, runtime_1.exists)(json, 'createdOldestTime') ? undefined : (new Date(json['createdOldestTime'])),
