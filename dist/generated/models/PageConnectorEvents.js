...
exports.PageConnectorEventsToJSON = exports.PageConnectorEventsFromJSONTyped = exports.PageConnectorEventsFromJSON = void 0;
...
function PageConnectorEventsFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'content': !(0, runtime_1.exists)(json, 'content') ? undefined : (json['content'].map(_1.ConnectorEventProjectionFromJSON)),
...
function PageConnectorEventsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        'content': value.content === undefined ? undefined : (value.content.map(_1.ConnectorEventProjectionToJSON)),
