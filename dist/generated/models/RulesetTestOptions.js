...
exports.RulesetTestOptionsToJSON = exports.RulesetTestOptionsFromJSONTyped = exports.RulesetTestOptionsFromJSON = void 0;
function RulesetTestOptionsFromJSON(json) {
...
function RulesetTestOptionsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
