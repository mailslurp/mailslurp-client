...
exports.EmailFeatureFamilyStatisticsFamilyEnum = exports.EmailFeatureFamilyStatisticsFeatureEnum = void 0;
exports.instanceOfEmailFeatureFamilyStatistics = instanceOfEmailFeatureFamilyStatistics;
...
exports.EmailFeatureFamilyStatisticsToJSONTyped = EmailFeatureFamilyStatisticsToJSONTyped;
var EmailFeaturePlatformStatistics_1 = require("./EmailFeaturePlatformStatistics");
/**
 * @export
 */
exports.EmailFeatureFamilyStatisticsFeatureEnum = {
    amp: 'amp',
 ...
 * @export
 */
exports.EmailFeatureFamilyStatisticsFamilyEnum = {
    aol: 'aol',
 ...
 */
function instanceOfEmailFeatureFamilyStatistics(value) {
...
function EmailFeatureFamilyStatisticsFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'family': json['family'],
        'platforms': (json['platforms'].map(EmailFeaturePlatformStatistics_1.EmailFeaturePlatformStatisticsFromJSON)),
    };
}
function EmailFeatureFamilyStatisticsToJSON(json) {
    return EmailFeatureFamilyStatisticsToJSONTyped(json, false);
}
function EmailFeatureFamilyStatisticsToJSONTyped(value, ignoreDiscriminator) {
    ...
    return {
        ...
        'family': value['family'],
        'platforms': (value['platforms'].map(EmailFeaturePlatformStatistics_1.EmailFeaturePlatformStatisticsToJSON)),
    };
}
