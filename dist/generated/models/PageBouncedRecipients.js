...
function PageBouncedRecipientsFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'content': !(0, runtime_1.exists)(json, 'content') ? undefined : (json['content'].map(_1.BounceRecipientFromJSON)),
...
function PageBouncedRecipientsToJSON(value) {
    ...
    return {
        'content': value.content === undefined ? undefined : (value.content.map(_1.BounceRecipientToJSON)),
        'empty': value.empty,
        'first': value.first,
        'last': value.last,
        'number': value.number,
