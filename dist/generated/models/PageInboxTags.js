...
exports.instanceOfPageInboxTags = instanceOfPageInboxTags;
exports.PageInboxTagsFromJSON = PageInboxTagsFromJSON;
exports.PageInboxTagsFromJSONTyped = PageInboxTagsFromJSONTyped;
exports.PageInboxTagsToJSON = PageInboxTagsToJSON;
exports.PageInboxTagsToJSONTyped = PageInboxTagsToJSONTyped;
 ...
 */
function instanceOfPageInboxTags(value) {
...
function PageInboxTagsFromJSON(json) {
    return PageInboxTagsFromJSONTyped(json, false);
}
function PageInboxTagsFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PageInboxTagsToJSON(json) {
    return PageInboxTagsToJSONTyped(json, false);
}
function PageInboxTagsToJSONTyped(value, ignoreDiscriminator) {
