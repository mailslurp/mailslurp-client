...
exports.CreateOAuthConnectionResultToJSON = exports.CreateOAuthConnectionResultFromJSONTyped = exports.CreateOAuthConnectionResultFromJSON = void 0;
function CreateOAuthConnectionResultFromJSON(json) {
...
function CreateOAuthConnectionResultToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
