...
exports.EmailAvailableResultToJSON = exports.EmailAvailableResultFromJSONTyped = exports.EmailAvailableResultFromJSON = void 0;
...
function EmailAvailableResultToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
