 ...
 * @enum {string}
 */
export declare enum InboxInboxTypeEnum {
    HTTP_INBOX = "HTTP_INBOX",
    SMTP_INBOX = "SMTP_INBOX"
}
export declare function InboxFromJSON(json: any): Inbox;
export declare function InboxFromJSONTyped(json: any, ignoreDiscriminator: boolean): Inbox;
export declare function InboxToJSON(value?: Inbox | null): any;
