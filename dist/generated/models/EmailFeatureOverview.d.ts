 ...
 * @export
 */
export declare const EmailFeatureOverviewFeatureEnum: {
    readonly amp: "amp";
 ...
 * @export
 */
export declare const EmailFeatureOverviewCategoryEnum: {
    readonly css: "css";
    readonly html: "html";
 ...
 * @export
 */
export declare const EmailFeatureOverviewStatusesEnum: {
 ...
 */
export declare function instanceOfEmailFeatureOverview(value: object): value is EmailFeatureOverview;
export declare function EmailFeatureOverviewFromJSON(json: any): EmailFeatureOverview;
export declare function EmailFeatureOverviewFromJSONTyped(json: any, ignoreDiscriminator: boolean): EmailFeatureOverview;
export declare function EmailFeatureOverviewToJSON(json: any): EmailFeatureOverview;
export declare function EmailFeatureOverviewToJSONTyped(value?: EmailFeatureOverview | null, ignoreDiscriminator?: boolean): any;
