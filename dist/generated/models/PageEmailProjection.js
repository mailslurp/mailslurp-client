...
exports.instanceOfPageEmailProjection = instanceOfPageEmailProjection;
...
exports.PageEmailProjectionToJSONTyped = PageEmailProjectionToJSONTyped;
var PageableObject_1 = require("./PageableObject");
var SortObject_1 = require("./SortObject");
var EmailProjection_1 = require("./EmailProjection");
/**
 * Check if a given object implements the PageEmailProjection interface.
 */
function instanceOfPageEmailProjection(value) {
...
function PageEmailProjectionFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'content': json['content'] == null ? undefined : (json['content'].map(EmailProjection_1.EmailProjectionFromJSON)),
...
function PageEmailProjectionToJSON(json) {
    return PageEmailProjectionToJSONTyped(json, false);
}
function PageEmailProjectionToJSONTyped(value, ignoreDiscriminator) {
    if (ignoreDiscriminator === void 0) { ignoreDiscriminator = false; }
    if (value == null) {
        return value;
    }
    return {
        'content': value['content'] == null ? undefined : (value['content'].map(EmailProjection_1.EmailProjectionToJSON)),
