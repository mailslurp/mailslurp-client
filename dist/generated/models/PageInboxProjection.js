...
exports.PageInboxProjectionToJSON = exports.PageInboxProjectionFromJSONTyped = exports.PageInboxProjectionFromJSON = void 0;
...
function PageInboxProjectionFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'content': !(0, runtime_1.exists)(json, 'content') ? undefined : (json['content'].map(_1.InboxPreviewFromJSON)),
...
function PageInboxProjectionToJSON(value) {
    ...
    return {
        'content': value.content === undefined ? undefined : (value.content.map(_1.InboxPreviewToJSON)),
        'empty': value.empty,
        'first': value.first,
        'last': value.last,
        'number': value.number,
