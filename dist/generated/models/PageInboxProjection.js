...
function PageInboxProjectionFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'content': !runtime_1.exists(json, 'content') ? undefined : (json['content'].map(_1.InboxProjectionFromJSON)),
...
function PageInboxProjectionToJSON(value) {
    ...
    return {
        'content': value.content === undefined ? undefined : (value.content.map(_1.InboxProjectionToJSON)),
        'empty': value.empty,
        'first': value.first,
        'last': value.last,
        'number': value.number,
