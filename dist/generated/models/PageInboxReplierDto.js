...
function PageInboxReplierDtoFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'content': !(0, runtime_1.exists)(json, 'content') ? undefined : (json['content'].map(_1.InboxReplierDtoFromJSON)),
...
function PageInboxReplierDtoToJSON(value) {
    ...
    return {
        'content': value.content === undefined ? undefined : (value.content.map(_1.InboxReplierDtoToJSON)),
