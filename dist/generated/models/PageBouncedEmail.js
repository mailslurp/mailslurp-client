...
exports.PageBouncedEmailToJSON = exports.PageBouncedEmailFromJSONTyped = exports.PageBouncedEmailFromJSON = void 0;
...
function PageBouncedEmailFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'content': !(0, runtime_1.exists)(json, 'content') ? undefined : (json['content'].map(_1.BounceProjectionFromJSON)),
...
function PageBouncedEmailToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        'content': value.content === undefined ? undefined : (value.content.map(_1.BounceProjectionToJSON)),
        'empty': value.empty,
        'first': value.first,
        'last': value.last,
        'number': value.number,
