...
exports.PageConnectorToJSON = exports.PageConnectorFromJSONTyped = exports.PageConnectorFromJSON = void 0;
...
function PageConnectorFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'content': !(0, runtime_1.exists)(json, 'content') ? undefined : (json['content'].map(_1.ConnectorProjectionFromJSON)),
...
function PageConnectorToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        'content': value.content === undefined ? undefined : (value.content.map(_1.ConnectorProjectionToJSON)),
