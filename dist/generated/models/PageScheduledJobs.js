...
function PageScheduledJobsFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'content': !(0, runtime_1.exists)(json, 'content') ? undefined : (json['content'].map(_1.ScheduledJobFromJSON)),
...
function PageScheduledJobsToJSON(value) {
    ...
    return {
        'content': value.content === undefined ? undefined : (value.content.map(_1.ScheduledJobToJSON)),
