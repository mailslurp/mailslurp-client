...
exports.instanceOfPageContactProjection = instanceOfPageContactProjection;
...
exports.PageContactProjectionToJSONTyped = PageContactProjectionToJSONTyped;
var PageableObject_1 = require("./PageableObject");
var ContactProjection_1 = require("./ContactProjection");
var SortObject_1 = require("./SortObject");
/**
 * Check if a given object implements the PageContactProjection interface.
 */
function instanceOfPageContactProjection(value) {
...
function PageContactProjectionFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'content': json['content'] == null ? undefined : (json['content'].map(ContactProjection_1.ContactProjectionFromJSON)),
...
function PageContactProjectionToJSON(json) {
    return PageContactProjectionToJSONTyped(json, false);
}
function PageContactProjectionToJSONTyped(value, ignoreDiscriminator) {
    if (ignoreDiscriminator === void 0) { ignoreDiscriminator = false; }
    if (value == null) {
        return value;
    }
    return {
        'content': value['content'] == null ? undefined : (value['content'].map(ContactProjection_1.ContactProjectionToJSON)),
