...
function PageComplaintFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'content': !(0, runtime_1.exists)(json, 'content') ? undefined : (json['content'].map(_1.ComplaintFromJSON)),
...
function PageComplaintToJSON(value) {
    ...
    return {
        'content': value.content === undefined ? undefined : (value.content.map(_1.ComplaintToJSON)),
