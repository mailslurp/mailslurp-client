...
exports.PageGuestPortalUsersToJSON = exports.PageGuestPortalUsersFromJSONTyped = exports.PageGuestPortalUsersFromJSON = void 0;
...
function PageGuestPortalUsersFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'content': !(0, runtime_1.exists)(json, 'content') ? undefined : (json['content'].map(_1.GuestPortalUserProjectionFromJSON)),
...
function PageGuestPortalUsersToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        'content': value.content === undefined ? undefined : (value.content.map(_1.GuestPortalUserProjectionToJSON)),
