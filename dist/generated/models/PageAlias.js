...
exports.PageAliasToJSON = exports.PageAliasFromJSONTyped = exports.PageAliasFromJSON = void 0;
...
function PageAliasFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'content': !(0, runtime_1.exists)(json, 'content') ? undefined : (json['content'].map(_1.AliasProjectionFromJSON)),
...
function PageAliasToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        'content': value.content === undefined ? undefined : (value.content.map(_1.AliasProjectionToJSON)),
