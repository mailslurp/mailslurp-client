...
function PageSmsProjectionFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'content': !(0, runtime_1.exists)(json, 'content') ? undefined : (json['content'].map(_1.SmsProjectionFromJSON)),
...
function PageSmsProjectionToJSON(value) {
    ...
    return {
        'content': value.content === undefined ? undefined : (value.content.map(_1.SmsProjectionToJSON)),
