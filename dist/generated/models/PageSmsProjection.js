...
exports.instanceOfPageSmsProjection = instanceOfPageSmsProjection;
...
exports.PageSmsProjectionToJSONTyped = PageSmsProjectionToJSONTyped;
var PageableObject_1 = require("./PageableObject");
var SortObject_1 = require("./SortObject");
var SmsProjection_1 = require("./SmsProjection");
/**
 * Check if a given object implements the PageSmsProjection interface.
 */
function instanceOfPageSmsProjection(value) {
...
function PageSmsProjectionFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'content': json['content'] == null ? undefined : (json['content'].map(SmsProjection_1.SmsProjectionFromJSON)),
...
function PageSmsProjectionToJSON(json) {
    return PageSmsProjectionToJSONTyped(json, false);
}
function PageSmsProjectionToJSONTyped(value, ignoreDiscriminator) {
    if (ignoreDiscriminator === void 0) { ignoreDiscriminator = false; }
    if (value == null) {
        return value;
    }
    return {
        'content': value['content'] == null ? undefined : (value['content'].map(SmsProjection_1.SmsProjectionToJSON)),
