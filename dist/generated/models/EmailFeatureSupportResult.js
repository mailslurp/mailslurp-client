...
exports.EmailFeatureSupportResultDetectedFeaturesEnum = void 0;
exports.instanceOfEmailFeatureSupportResult = instanceOfEmailFeatureSupportResult;
...
exports.EmailFeatureSupportResultToJSONTyped = EmailFeatureSupportResultToJSONTyped;
var EmailFeatureNames_1 = require("./EmailFeatureNames");
var EmailFeatureOverview_1 = require("./EmailFeatureOverview");
var EmailFeatureSupportStatusPercentage_1 = require("./EmailFeatureSupportStatusPercentage");
/**
 * @export
 */
exports.EmailFeatureSupportResultDetectedFeaturesEnum = {
    amp: 'amp',
 ...
 */
function instanceOfEmailFeatureSupportResult(value) {
    if (!('names' in value) || value['names'] === undefined)
        return false;
    if (!('detectedFeatures' in value) || value['detectedFeatures'] === undefined)
        return false;
    if (!('featureOverviews' in value) || value['featureOverviews'] === undefined)
        return false;
    if (!('featurePercentages' in value) || value['featurePercentages'] === undefined)
        return false;
    return true;
}
...
function EmailFeatureSupportResultFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'names': (0, EmailFeatureNames_1.EmailFeatureNamesFromJSON)(json['names']),
        'detectedFeatures': new Set(json['detectedFeatures']),
        'featureOverviews': (json['featureOverviews'].map(EmailFeatureOverview_1.EmailFeatureOverviewFromJSON)),
        'featurePercentages': (json['featurePercentages'].map(EmailFeatureSupportStatusPercentage_1.EmailFeatureSupportStatusPercentageFromJSON)),
    };
}
function EmailFeatureSupportResultToJSON(json) {
    return EmailFeatureSupportResultToJSONTyped(json, false);
}
function EmailFeatureSupportResultToJSONTyped(value, ignoreDiscriminator) {
    if (ignoreDiscriminator === void 0) { ignoreDiscriminator = false; }
    if (value == null) {
        return value;
    }
    return {
        'names': (0, EmailFeatureNames_1.EmailFeatureNamesToJSON)(value['names']),
        'detectedFeatures': Array.from(value['detectedFeatures']),
        'featureOverviews': (value['featureOverviews'].map(EmailFeatureOverview_1.EmailFeatureOverviewToJSON)),
        'featurePercentages': (value['featurePercentages'].map(EmailFeatureSupportStatusPercentage_1.EmailFeatureSupportStatusPercentageToJSON)),
    };
}
