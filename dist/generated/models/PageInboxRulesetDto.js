...
exports.PageInboxRulesetDtoToJSON = exports.PageInboxRulesetDtoFromJSONTyped = exports.PageInboxRulesetDtoFromJSON = void 0;
...
function PageInboxRulesetDtoFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'content': !(0, runtime_1.exists)(json, 'content') ? undefined : (json['content'].map(_1.InboxRulesetDtoFromJSON)),
...
function PageInboxRulesetDtoToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        'content': value.content === undefined ? undefined : (value.content.map(_1.InboxRulesetDtoToJSON)),
