...
var ContactControllerApi = /** @class */ (function (_super) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                ...
                                body: (0, models_1.CreateContactOptionsToJSON)(requestParameters.createContactOptions),
                            }, initOverrides)];
                    case 1:
                        response = _a.sent();
     ...
     * Get all contacts
     */
    ContactControllerApi.prototype.getAllContacts = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
