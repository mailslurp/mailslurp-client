...
var EmailVerificationControllerApi = /** @class */ (function (_super) {
     ...
     */
    EmailVerificationControllerApi.prototype.checkEmailDomainReputationRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (requestParameters.emailDomainReputationOptions === null ||
                            requestParameters.emailDomainReputationOptions === undefined) {
                            throw new runtime.RequiredError('emailDomainReputationOptions', 'Required parameter requestParameters.emailDomainReputationOptions was null or undefined when calling checkEmailDomainReputation.');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        ...
                        return [4 /*yield*/, this.request({
                                ...
                                body: (0, models_1.EmailDomainReputationOptionsToJSON)(requestParameters.emailDomainReputationOptions),
                            }, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) {
                                return (0, models_1.EmailDomainReputationResultFromJSON)(jsonValue);
                            })];
                }
            });
        });
     ...
     * Check email/domain reputation signals including configured DNS blacklists.
     */
    EmailVerificationControllerApi.prototype.checkEmailDomainReputation = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.checkEmailDomainReputationRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                ...
                switch (_a.label) {
                    case 0:
                        if (requestParameters.id === null || requestParameters.id === undefined) {
                            throw new runtime.RequiredError('id', 'Required parameter requestParameters.id was null or undefined when calling deleteValidationRequest.');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        if (this.configuration && this.configuration.apiKey) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                ...
                                headers: headerParameters,
                                query: queryParameters,
                                body: (0, models_1.ValidateEmailAddressListOptionsToJSON)(requestParameters.validateEmailAddressListOptions),
                            }, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) {
...
(function (GetValidationRequestsSortEnum) {
    ...
    GetValidationRequestsSortEnum["DESC"] = "DESC";
})(GetValidationRequestsSortEnum = exports.GetValidationRequestsSortEnum || (exports.GetValidationRequestsSortEnum = {}));
