...
exports.CreateOAuthConnectionOAuthConnectionTypeEnum = exports.OAuthConnectionApi = void 0;
var runtime = __importStar(require("../runtime"));
var models_1 = require("../models");
/**
 *
 */
var OAuthConnectionApi = /** @class */ (function (_super) {
    __extends(OAuthConnectionApi, _super);
    function OAuthConnectionApi() {
     ...
     */
    OAuthConnectionApi.prototype.createOAuthConnectionRaw = function (requestParameters, initOverrides) {
     ...
     * Create an OAuth connection
     */
    OAuthConnectionApi.prototype.createOAuthConnection = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.createOAuthConnectionRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
     ...
     */
    OAuthConnectionApi.prototype.exchangeAuthorizationTokenAndCreateOrUpdateInboxRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * Exchange authorization code for access token and create inbox
     */
    OAuthConnectionApi.prototype.exchangeAuthorizationTokenAndCreateOrUpdateInbox = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.exchangeAuthorizationTokenAndCreateOrUpdateInboxRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
...
(function (CreateOAuthConnectionOAuthConnectionTypeEnum) {
    ...
    CreateOAuthConnectionOAuthConnectionTypeEnum["MICROSOFT"] = "MICROSOFT";
})(CreateOAuthConnectionOAuthConnectionTypeEnum = exports.CreateOAuthConnectionOAuthConnectionTypeEnum || (exports.CreateOAuthConnectionOAuthConnectionTypeEnum = {}));
