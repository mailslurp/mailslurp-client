...
export declare class ContactControllerApi extends runtime.BaseAPI {
     ...
     */
    getContactVCardRaw(requestParameters: GetContactVCardRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<string>>;
    /**
     * Get contact vCard vcf file
     */
    getContactVCard(requestParameters: GetContactVCardRequest, initOverrides?: RequestInit): Promise<string>;
    /**
     * Get all contacts
     */
