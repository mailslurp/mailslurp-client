...
var GuestPortalControllerApi = /** @class */ (function (_super) {
                ...
                switch (_c.label) {
                    case 0:
                        if (requestParameters['createPortalOptions'] == null) {
                            throw new runtime.RequiredError('createPortalOptions', 'Required parameter "createPortalOptions" was null or undefined when calling createGuestPortal().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                    ...
                    case 2: return [4 /*yield*/, this.request({
                            ...
                            body: (0, index_1.CreatePortalOptionsToJSON)(requestParameters['createPortalOptions']),
                        }, initOverrides)];
                    case 3:
                        response = _c.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, index_1.GuestPortalDtoFromJSON)(jsonValue); })];
                }
            });
        });
    };
                ...
                switch (_c.label) {
                    case 0:
                        if (requestParameters['portalId'] == null) {
                            throw new runtime.RequiredError('portalId', 'Required parameter "portalId" was null or undefined when calling createGuestPortalUser().');
                        }
                        if (requestParameters['createPortalUserOptions'] == null) {
                            throw new runtime.RequiredError('createPortalUserOptions', 'Required parameter "createPortalUserOptions" was null or undefined when calling createGuestPortalUser().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        headerParameters['Content-Type'] = 'application/json';
                    ...
                    case 2: return [4 /*yield*/, this.request({
                            ...
                            headers: headerParameters,
                            query: queryParameters,
                            body: (0, index_1.CreatePortalUserOptionsToJSON)(requestParameters['createPortalUserOptions']),
                        }, initOverrides)];
                    case 3:
                        response = _c.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, index_1.GuestPortalUserCreateDtoFromJSON)(jsonValue); })];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        response = _c.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, index_1.PageGuestPortalUsersFromJSON)(jsonValue); })];
                }
            });
        });
    };
     ...
     * Get all guest users for portal
     */
    GuestPortalControllerApi.prototype.getAllGuestPortalUsers = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (requestParameters['portalId'] == null) {
                            throw new runtime.RequiredError('portalId', 'Required parameter "portalId" was null or undefined when calling getGuestPortal().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        if (!(this.configuration && this.configuration.apiKey)) return [3 /*break*/, 2];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (requestParameters['portalId'] == null) {
                            throw new runtime.RequiredError('portalId', 'Required parameter "portalId" was null or undefined when calling getGuestPortalUser().');
                        }
                        if (requestParameters['guestId'] == null) {
                            throw new runtime.RequiredError('guestId', 'Required parameter "guestId" was null or undefined when calling getGuestPortalUser().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        if (!(this.configuration && this.configuration.apiKey)) return [3 /*break*/, 2];
                    ...
                    case 3:
                        response = _c.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, index_1.GuestPortalUserDtoFromJSON)(jsonValue); })];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (requestParameters['guestId'] == null) {
                            throw new runtime.RequiredError('guestId', 'Required parameter "guestId" was null or undefined when calling getGuestPortalUserById().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        if (!(this.configuration && this.configuration.apiKey)) return [3 /*break*/, 2];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (requestParameters['portalId'] == null) {
                            throw new runtime.RequiredError('portalId', 'Required parameter "portalId" was null or undefined when calling getGuestPortalUsers().');
                        }
                        queryParameters = {};
                        if (requestParameters['search'] != null) {
                            queryParameters['search'] = requestParameters['search'];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        response = _c.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return jsonValue.map(index_1.GuestPortalDtoFromJSON); })];
                }
            });
        });
    };
 ...
 * @export
 */
exports.GetAllGuestPortalUsersSortEnum = {
    ASC: 'ASC',
    DESC: 'DESC'
};
/**
 * @export
 */
exports.GetGuestPortalUsersSortEnum = {
    ASC: 'ASC',
    DESC: 'DESC'
};
