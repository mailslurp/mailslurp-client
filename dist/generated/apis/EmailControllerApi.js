...
var EmailControllerApi = /** @class */ (function (_super) {
     ...
     */
    EmailControllerApi.prototype.getAttachments1Raw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * Get all email attachment metadata. Metadata includes name and size of attachments.
     */
    EmailControllerApi.prototype.getAttachments1 = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
