...
var InboxControllerApi = /** @class */ (function (_super) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters.createRulesetOptions === null ||
                            ...
                            throw new runtime.RequiredError('createRulesetOptions', 'Required parameter requestParameters.createRulesetOptions was null or undefined when calling createInboxRuleset.');
                        }
                        queryParameters = {};
                        headerParameters = {};
     ...
     * Delete all inboxes
     */
    InboxControllerApi.prototype.deleteAllInboxesRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * Delete all inboxes
     */
    InboxControllerApi.prototype.deleteAllInboxes = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.deleteAllInboxesRaw(requestParameters, initOverrides)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
     ...
     * Get all sub address plus address aliases for an inbox
     */
    InboxControllerApi.prototype.getAllPlusAddresses = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * Get inbox tags
     */
    InboxControllerApi.prototype.getInboxTags = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * Get inbox tags paginated
     */
    InboxControllerApi.prototype.getInboxTagsPaginated = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (requestParameters.inboxId === null ||
                            requestParameters.inboxId === undefined) {
                            throw new runtime.RequiredError('inboxId', 'Required parameter requestParameters.inboxId was null or undefined when calling getOrCreateInboxPlusAddress.');
                        }
                        if (requestParameters.fullAddress === null ||
                            requestParameters.fullAddress === undefined) {
                            throw new runtime.RequiredError('fullAddress', 'Required parameter requestParameters.fullAddress was null or undefined when calling getOrCreateInboxPlusAddress.');
                        }
                        queryParameters = {};
                        ...
                        return [4 /*yield*/, this.request({
                                path: "/inboxes/{inboxId}/plus-addresses/get-or-create".replace("{".concat('inboxId', "}"), encodeURIComponent(String(requestParameters.inboxId))),
                                method: 'POST',
                                headers: headerParameters,
                                query: queryParameters,
                            }, initOverrides)];
    ...
    InboxControllerApi.prototype.getOrCreateInboxPlusAddress = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getOrCreateInboxPlusAddressRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (requestParameters.fullAddress === null ||
                            requestParameters.fullAddress === undefined) {
                            throw new runtime.RequiredError('fullAddress', 'Required parameter requestParameters.fullAddress was null or undefined when calling getOrCreatePlusAddressByFullAddress.');
                        }
                        queryParameters = {};
                        if (requestParameters.fullAddress !== undefined) {
                            queryParameters['fullAddress'] = requestParameters.fullAddress;
    ...
    InboxControllerApi.prototype.getOrCreatePlusAddressByFullAddress = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getOrCreatePlusAddressByFullAddressRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     * List all inboxes with sent emails
     */
    InboxControllerApi.prototype.getOutboxes = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                ...
                                headers: headerParameters,
                                query: queryParameters,
                                body: (0, models_1.UpdateImapAccessOptionsToJSON)(requestParameters.updateImapAccessOptions),
                            }, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.VoidApiResponse(response)];
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                ...
                                headers: headerParameters,
                                query: queryParameters,
                                body: (0, models_1.UpdateSmtpAccessOptionsToJSON)(requestParameters.updateSmtpAccessOptions),
                            }, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.VoidApiResponse(response)];
