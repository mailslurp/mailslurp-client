...
var BounceControllerApi = /** @class */ (function (_super) {
     ...
     */
    BounceControllerApi.prototype.getReputationItemsRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * Get paginated list of reputation items.
     */
    BounceControllerApi.prototype.getReputationItems = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getReputationItemsRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
...
(function (GetTenantReputationFindingsAccountRegionEnum) {
    ...
    GetTenantReputationFindingsAccountRegionEnum["US_WEST_2_ACCOUNT_SES_3"] = "US_WEST_2_ACCOUNT_SES_3";
...
(function (GetTenantReputationStatusSummaryAccountRegionEnum) {
    ...
    GetTenantReputationStatusSummaryAccountRegionEnum["US_WEST_2_ACCOUNT_SES_3"] = "US_WEST_2_ACCOUNT_SES_3";
