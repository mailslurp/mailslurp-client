...
export declare class EmailControllerApi extends runtime.BaseAPI {
     ...
     */
    getAttachments1Raw(requestParameters: GetAttachments1Request, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Array<AttachmentMetaData>>>;
    /**
     * Returns an array of attachment metadata such as name and content-type for a given email if present.
     * Get all email attachment metadata. Metadata includes name and size of attachments.
     */
    getAttachments1(requestParameters: GetAttachments1Request, initOverrides?: RequestInit): Promise<Array<AttachmentMetaData>>;
    /**
