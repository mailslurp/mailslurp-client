    ...
    WebhookControllerApi.prototype.createWebhookForAITransformerRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (requestParameters.transformerId === null ||
                            requestParameters.transformerId === undefined) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) {
                                return (0, models_1.WebhookNewAITransformResultPayloadFromJSON)(jsonValue);
                            })];
                }
            });
        });
