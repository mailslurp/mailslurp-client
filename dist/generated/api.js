...
var MissedEmailControllerApiFetchParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getAllMissedEmails: function (page, searchFilter, size, sort, options) {
            if (options === void 0) { options = {}; }
...
var MissedEmailControllerApiFp = function (configuration) {
    return {
         ...
         */
        getAllMissedEmails: function (page, searchFilter, size, sort, options) {
            var localVarFetchArgs = exports.MissedEmailControllerApiFetchParamCreator(configuration).getAllMissedEmails(page, searchFilter, size, sort, options);
            return function (fetch, basePath) {
                if (fetch === void 0) { fetch = portableFetch; }
                if (basePath === void 0) { basePath = BASE_PATH; }
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then(function (response) {
...
var MissedEmailControllerApiFactory = function (configuration, fetch, basePath) {
    return {
         ...
         */
        getAllMissedEmails: function (page, searchFilter, size, sort, options) {
            return exports.MissedEmailControllerApiFp(configuration).getAllMissedEmails(page, searchFilter, size, sort, options)(fetch, basePath);
        },
        /**
         *
         * @summary Get MissedEmail
...
var MissedEmailControllerApi = /** @class */ (function (_super) {
     ...
     */
    MissedEmailControllerApi.prototype.getAllMissedEmails = function (page, searchFilter, size, sort, options) {
        return exports.MissedEmailControllerApiFp(this.configuration).getAllMissedEmails(page, searchFilter, size, sort, options)(this.fetch, this.basePath);
    };
    /**
     *
     * @summary Get MissedEmail
