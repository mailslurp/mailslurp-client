 ...
 *
 * OpenAPI spec version: 30fdf976ae9b0f55910759b72495e3f4cba1407c
 *
 *
...
var WebhookControllerApiFetchParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getAllWebhookResults: function (page, size, sort, options) {
            if (options === void 0) { options = {}; }
         ...
         * @throws {RequiredError}
         */
        getWebhookResults: function (webhookId, page, size, sort, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'webhookId' is not null or undefined
            if (webhookId === null || webhookId === undefined) {
...
var WebhookControllerApiFp = function (configuration) {
    return {
         ...
         */
        getAllWebhookResults: function (page, size, sort, options) {
            var localVarFetchArgs = exports.WebhookControllerApiFetchParamCreator(configuration).getAllWebhookResults(page, size, sort, options);
            return function (fetch, basePath) {
                if (fetch === void 0) { fetch = portableFetch; }
                if (basePath === void 0) { basePath = BASE_PATH; }
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then(function (response) {
         ...
         */
        getWebhookResults: function (webhookId, page, size, sort, options) {
            var localVarFetchArgs = exports.WebhookControllerApiFetchParamCreator(configuration).getWebhookResults(webhookId, page, size, sort, options);
            return function (fetch, basePath) {
                if (fetch === void 0) { fetch = portableFetch; }
                if (basePath === void 0) { basePath = BASE_PATH; }
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then(function (response) {
...
var WebhookControllerApiFactory = function (configuration, fetch, basePath) {
    return {
         ...
         */
        getAllWebhookResults: function (page, size, sort, options) {
            return exports.WebhookControllerApiFp(configuration).getAllWebhookResults(page, size, sort, options)(fetch, basePath);
        },
        /**
         * List webhooks in paginated form. Allows for page index, page size, and sort direction.
         * @summary List Webhooks Paginated
         ...
         */
        getWebhookResults: function (webhookId, page, size, sort, options) {
            return exports.WebhookControllerApiFp(configuration).getWebhookResults(webhookId, page, size, sort, options)(fetch, basePath);
        },
        /**
         *
         * @summary Get all webhooks for an Inbox
...
var WebhookControllerApi = /** @class */ (function (_super) {
     ...
     * @memberof WebhookControllerApi
     */
    WebhookControllerApi.prototype.getAllWebhookResults = function (page, size, sort, options) {
        return exports.WebhookControllerApiFp(this.configuration).getAllWebhookResults(page, size, sort, options)(this.fetch, this.basePath);
    };
    /**
     * List webhooks in paginated form. Allows for page index, page size, and sort direction.
     * @summary List Webhooks Paginated
     ...
     * @memberof WebhookControllerApi
     */
    WebhookControllerApi.prototype.getWebhookResults = function (webhookId, page, size, sort, options) {
        return exports.WebhookControllerApiFp(this.configuration).getWebhookResults(webhookId, page, size, sort, options)(this.fetch, this.basePath);
    };
    /**
     *
     * @summary Get all webhooks for an Inbox
