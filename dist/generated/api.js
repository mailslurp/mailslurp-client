 ...
 *
 * OpenAPI spec version: e6e8c3940f62aef7ec27007fbe31bc69683a2df2
 *
 *
...
exports.MailServerControllerApiFetchParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        describeDomain: function (describeOptions, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'describeOptions' is not null or undefined
            if (describeOptions === null || describeOptions === undefined) {
                throw new RequiredError('describeOptions', 'Required parameter describeOptions was null or undefined when calling describeDomain.');
            }
            var localVarPath = "/mail-server/describe/domain-mx-records";
            var localVarUrlObj = url.parse(localVarPath, true);
            var localVarRequestOptions = Object.assign({ method: 'POST' }, options);
            var localVarHeaderParameter = {};
            var localVarQueryParameter = {};
...
exports.MailServerControllerApiFp = function (configuration) {
    return {
         ...
         */
        describeDomain: function (describeOptions, options) {
            var localVarFetchArgs = exports.MailServerControllerApiFetchParamCreator(configuration).describeDomain(describeOptions, options);
            return function (fetch, basePath) {
                if (fetch === void 0) { fetch = portableFetch; }
                if (basePath === void 0) { basePath = BASE_PATH; }
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then(function (response) {
...
exports.MailServerControllerApiFactory = function (configuration, fetch, basePath) {
    return {
         ...
         */
        describeDomain: function (describeOptions, options) {
            return exports.MailServerControllerApiFp(configuration).describeDomain(describeOptions, options)(fetch, basePath);
        },
        /**
         *
         * @summary Verify the existence of an email address at a given mail server.
...
var MailServerControllerApi = /** @class */ (function (_super) {
     ...
     */
    MailServerControllerApi.prototype.describeDomain = function (describeOptions, options) {
        return exports.MailServerControllerApiFp(this.configuration).describeDomain(describeOptions, options)(this.fetch, this.basePath);
    };
    /**
     *
     * @summary Verify the existence of an email address at a given mail server.
