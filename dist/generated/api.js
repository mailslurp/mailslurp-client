...
exports.WebhookControllerApi = exports.WebhookControllerApiFactory = exports.WebhookControllerApiFp = exports.WebhookControllerApiFetchParamCreator = exports.WaitForControllerApi = exports.WaitForControllerApiFactory = exports.WaitForControllerApiFp = void 0;
...
(function (CreateInboxRulesetOptions) {
    ...
    (function (ActionEnum) {
        ...
        ActionEnum[ActionEnum["FORWARD"] = 'FORWARD'] = "FORWARD";
 ...
 */
var InboxRulesetProjection;
(function (InboxRulesetProjection) {
    /**
     * @export
     * @enum {string}
     */
    ...
    (function (ActionEnum) {
        ...
        ActionEnum[ActionEnum["FILTERREMOVE"] = 'FILTER_REMOVE'] = "FILTERREMOVE";
        ActionEnum[ActionEnum["FORWARD"] = 'FORWARD'] = "FORWARD";
    })(ActionEnum = InboxRulesetProjection.ActionEnum || (InboxRulesetProjection.ActionEnum = {}));
    /**
     * @export
     * @enum {string}
     */
    ...
    (function (HandlerEnum) {
        HandlerEnum[HandlerEnum["EXCEPTION"] = 'EXCEPTION'] = "EXCEPTION";
    })(HandlerEnum = InboxRulesetProjection.HandlerEnum || (InboxRulesetProjection.HandlerEnum = {}));
    /**
     * @export
     * @enum {string}
     */
    ...
    (function (ScopeEnum) {
        ScopeEnum[ScopeEnum["RECEIVINGEMAILS"] = 'RECEIVING_EMAILS'] = "RECEIVINGEMAILS";
        ScopeEnum[ScopeEnum["SENDINGEMAILS"] = 'SENDING_EMAILS'] = "SENDINGEMAILS";
    })(ScopeEnum = InboxRulesetProjection.ScopeEnum || (InboxRulesetProjection.ScopeEnum = {}));
})(InboxRulesetProjection = exports.InboxRulesetProjection || (exports.InboxRulesetProjection = {}));
/**
 * @export
...
var InboxControllerApiFetchParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listInboxRulesets: function (inboxId, page, size, sort, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'inboxId' is not null or undefined
            if (inboxId === null || inboxId === undefined) {
...
var InboxControllerApiFp = function (configuration) {
    return {
         ...
         */
        listInboxRulesets: function (inboxId, page, size, sort, options) {
            var localVarFetchArgs = exports.InboxControllerApiFetchParamCreator(configuration).listInboxRulesets(inboxId, page, size, sort, options);
            return function (fetch, basePath) {
                if (fetch === void 0) { fetch = portableFetch; }
                if (basePath === void 0) { basePath = BASE_PATH; }
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then(function (response) {
...
var InboxControllerApiFactory = function (configuration, fetch, basePath) {
    return {
         ...
         */
        listInboxRulesets: function (inboxId, page, size, sort, options) {
            return exports.InboxControllerApiFp(configuration).listInboxRulesets(inboxId, page, size, sort, options)(fetch, basePath);
        },
        /**
         * Send an email from an inbox's email address.  The request body should contain the `SendEmailOptions` that include recipients, attachments, body etc. See `SendEmailOptions` for all available properties. Note the `inboxId` refers to the inbox's id not the inbox's email address. See https://www.mailslurp.com/guides/ for more information on how to send emails. This method does not return a sent email entity due to legacy reasons. To send and get a sent email as returned response use the sister method `sendEmailAndConfirm`.
         * @summary Send Email
...
var InboxControllerApi = /** @class */ (function (_super) {
     ...
     * @memberof InboxControllerApi
     */
    InboxControllerApi.prototype.listInboxRulesets = function (inboxId, page, size, sort, options) {
        return exports.InboxControllerApiFp(this.configuration).listInboxRulesets(inboxId, page, size, sort, options)(this.fetch, this.basePath);
    };
    /**
     * Send an email from an inbox's email address.  The request body should contain the `SendEmailOptions` that include recipients, attachments, body etc. See `SendEmailOptions` for all available properties. Note the `inboxId` refers to the inbox's id not the inbox's email address. See https://www.mailslurp.com/guides/ for more information on how to send emails. This method does not return a sent email entity due to legacy reasons. To send and get a sent email as returned response use the sister method `sendEmailAndConfirm`.
     * @summary Send Email
...
var InboxRulesetControllerApiFetchParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getInboxRulesets: function (inboxId, page, size, sort, options) {
            if (options === void 0) { options = {}; }
            var localVarPath = "/rulesets";
            var localVarUrlObj = url.parse(localVarPath, true);
            var localVarRequestOptions = Object.assign({ method: 'GET' }, options);
...
var InboxRulesetControllerApiFp = function (configuration) {
    return {
         ...
         */
        getInboxRulesets: function (inboxId, page, size, sort, options) {
            var localVarFetchArgs = exports.InboxRulesetControllerApiFetchParamCreator(configuration).getInboxRulesets(inboxId, page, size, sort, options);
            return function (fetch, basePath) {
                if (fetch === void 0) { fetch = portableFetch; }
                if (basePath === void 0) { basePath = BASE_PATH; }
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then(function (response) {
...
var InboxRulesetControllerApiFactory = function (configuration, fetch, basePath) {
    return {
         ...
         */
        getInboxRulesets: function (inboxId, page, size, sort, options) {
            return exports.InboxRulesetControllerApiFp(configuration).getInboxRulesets(inboxId, page, size, sort, options)(fetch, basePath);
        },
    };
};
...
var InboxRulesetControllerApi = /** @class */ (function (_super) {
     ...
     * @memberof InboxRulesetControllerApi
     */
    InboxRulesetControllerApi.prototype.getInboxRulesets = function (inboxId, page, size, sort, options) {
        return exports.InboxRulesetControllerApiFp(this.configuration).getInboxRulesets(inboxId, page, size, sort, options)(this.fetch, this.basePath);
    };
