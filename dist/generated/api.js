...
/**
 * ApiFormControllerApi - fetch parameter creator
 * @export
 */
exports.ApiFormControllerApiFetchParamCreator = function (configuration) {
    return {
        /**
         * Submit a URL encoded form to be used to send an email
         * @summary Send email from form inputs
         * @param {string} to Email recipient email address
         * @param {string} [bcc] BCC recipient email address
         * @param {string} [body] Email body
         * @param {string} [cc] CC recipient email address
         * @param {string} [confirmationMessage] Message to display once submitted. Alternatively use redirectTo.
         * @param {Array<any>} [files] Email attachments
         * @param {string} [from] Email sent from email address
         * @param {string} [redirectTo] Redirect URL. Redirect successful form submission to this URL.
         * @param {string} [replyTo] Email reply-to email address
         * @param {string} [spamCheck] Empty field for catching bots. Leave blank but include the input in your form to catch spammers.
         * @param {string} [subject]
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        submitForm: function (to, bcc, body, cc, confirmationMessage, files, from, redirectTo, replyTo, spamCheck, subject, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'to' is not null or undefined
            if (to === null || to === undefined) {
                throw new RequiredError('to', 'Required parameter to was null or undefined when calling submitForm.');
            }
            ...
            if (bcc !== undefined) {
                localVarFormParams.set('bcc', bcc);
            }
            if (body !== undefined) {
                localVarFormParams.set('body', body);
            }
            if (cc !== undefined) {
                localVarFormParams.set('cc', cc);
            }
            if (confirmationMessage !== undefined) {
                localVarFormParams.set('confirmationMessage', confirmationMessage);
            }
            if (files) {
            ...
            if (redirectTo !== undefined) {
                localVarFormParams.set('redirectTo', redirectTo);
            }
            if (replyTo !== undefined) {
                localVarFormParams.set('replyTo', replyTo);
            }
            if (spamCheck !== undefined) {
                localVarFormParams.set('spamCheck', spamCheck);
            }
...
/**
 * ApiFormControllerApi - functional programming interface
 * @export
 */
exports.ApiFormControllerApiFp = function (configuration) {
    return {
        /**
         * Submit a URL encoded form to be used to send an email
         * @summary Send email from form inputs
         ...
         */
        submitForm: function (to, bcc, body, cc, confirmationMessage, files, from, redirectTo, replyTo, spamCheck, subject, options) {
            var localVarFetchArgs = exports.ApiFormControllerApiFetchParamCreator(configuration).submitForm(to, bcc, body, cc, confirmationMessage, files, from, redirectTo, replyTo, spamCheck, subject, options);
...
/**
 * ApiFormControllerApi - factory interface
 * @export
 */
exports.ApiFormControllerApiFactory = function (configuration, fetch, basePath) {
    return {
        /**
         * Submit a URL encoded form to be used to send an email
         * @summary Send email from form inputs
         ...
         */
        submitForm: function (to, bcc, body, cc, confirmationMessage, files, from, redirectTo, replyTo, spamCheck, subject, options) {
            return exports.ApiFormControllerApiFp(configuration).submitForm(to, bcc, body, cc, confirmationMessage, files, from, redirectTo, replyTo, spamCheck, subject, options)(fetch, basePath);
        },
    };
};
/**
 ...
 * @extends {BaseAPI}
 */
var ApiFormControllerApi = /** @class */ (function (_super) {
    __extends(ApiFormControllerApi, _super);
    function ApiFormControllerApi() {
     ...
     */
    ApiFormControllerApi.prototype.submitForm = function (to, bcc, body, cc, confirmationMessage, files, from, redirectTo, replyTo, spamCheck, subject, options) {
        return exports.ApiFormControllerApiFp(this.configuration).submitForm(to, bcc, body, cc, confirmationMessage, files, from, redirectTo, replyTo, spamCheck, subject, options)(this.fetch, this.basePath);
    };
    return ApiFormControllerApi;
}(BaseAPI));
exports.ApiFormControllerApi = ApiFormControllerApi;
/**
 ...
 * @export
 */
exports.ContactControllerApiFetchParamCreator = function (configuration) {
    return {
        /**
         *
 ...
 * @export
 */
exports.ContactControllerApiFp = function (configuration) {
    return {
        /**
         *
         * @summary Create a contact
 ...
 * @export
 */
exports.ContactControllerApiFactory = function (configuration, fetch, basePath) {
    return {
        /**
         *
         * @summary Create a contact
 ...
 * @export
 */
exports.GroupControllerApiFetchParamCreator = function (configuration) {
    return {
        /**
         *
 ...
 * @export
 */
exports.GroupControllerApiFp = function (configuration) {
    return {
        /**
         *
         * @summary Add contacts to a group
 ...
 * @export
 */
exports.GroupControllerApiFactory = function (configuration, fetch, basePath) {
    return {
        /**
         *
         * @summary Add contacts to a group
 ...
 * @export
 */
exports.TemplateControllerApiFetchParamCreator = function (configuration) {
    return {
        /**
         *
 ...
 * @export
 */
exports.TemplateControllerApiFp = function (configuration) {
    return {
        /**
         *
         * @summary Create a Template
 ...
 * @export
 */
exports.TemplateControllerApiFactory = function (configuration, fetch, basePath) {
    return {
        /**
         *
         * @summary Create a Template
 ...
 * @export
 */
exports.WaitForControllerApiFetchParamCreator = function (configuration) {
    return {
        /**
 ...
 * @export
 */
exports.WaitForControllerApiFp = function (configuration) {
    return {
        /**
         * Generic waitFor method that will wait until an inbox meets given conditions or return immediately if already met
         * @summary Wait for conditions to be met
 ...
 * @export
 */
exports.WaitForControllerApiFactory = function (configuration, fetch, basePath) {
    return {
        /**
         * Generic waitFor method that will wait until an inbox meets given conditions or return immediately if already met
         * @summary Wait for conditions to be met
 ...
 * @export
 */
exports.WebhookControllerApiFetchParamCreator = function (configuration) {
    return {
        /**
 ...
 * @export
 */
exports.WebhookControllerApiFp = function (configuration) {
    return {
        /**
         * Get notified whenever an inbox receives an email via a WebHook URL. An emailID will be posted to this URL every time an email is received for this inbox. The URL must be publicly reachable by the MailSlurp server. You can provide basicAuth values if you wish to secure this endpoint.
         * @summary Attach a WebHook URL to an inbox
 ...
 * @export
 */
exports.WebhookControllerApiFactory = function (configuration, fetch, basePath) {
    return {
        /**
         * Get notified whenever an inbox receives an email via a WebHook URL. An emailID will be posted to this URL every time an email is received for this inbox. The URL must be publicly reachable by the MailSlurp server. You can provide basicAuth values if you wish to secure this endpoint.
         * @summary Attach a WebHook URL to an inbox
