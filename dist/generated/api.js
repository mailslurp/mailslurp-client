 ...
 *
 * OpenAPI spec version: 57d28186434973b5a1da7a8ad49c55c493e4ec30
 *
 *
...
var AliasControllerApiFetchParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getAliasVerification: function (aliasId, emailAddress, verificationToken, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'aliasId' is not null or undefined
            if (aliasId === null || aliasId === undefined) {
                throw new RequiredError('aliasId', 'Required parameter aliasId was null or undefined when calling getAliasVerification.');
            }
            // verify required parameter 'emailAddress' is not null or undefined
            if (emailAddress === null || emailAddress === undefined) {
                throw new RequiredError('emailAddress', 'Required parameter emailAddress was null or undefined when calling getAliasVerification.');
            }
            ...
            if (verificationToken === null || verificationToken === undefined) {
                throw new RequiredError('verificationToken', 'Required parameter verificationToken was null or undefined when calling getAliasVerification.');
            }
            var localVarPath = "/aliases/{aliasId}/verification".replace("{" + 'aliasId' + "}", encodeURIComponent(String(aliasId)));
            var localVarUrlObj = url.parse(localVarPath, true);
            var localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            var localVarHeaderParameter = {};
            var localVarQueryParameter = {};
...
var AliasControllerApiFp = function (configuration) {
    return {
         ...
         */
        getAliasVerification: function (aliasId, emailAddress, verificationToken, options) {
            var localVarFetchArgs = exports.AliasControllerApiFetchParamCreator(configuration).getAliasVerification(aliasId, emailAddress, verificationToken, options);
            return function (fetch, basePath) {
                if (fetch === void 0) { fetch = portableFetch; }
                if (basePath === void 0) { basePath = BASE_PATH; }
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then(function (response) {
...
var AliasControllerApiFactory = function (configuration, fetch, basePath) {
    return {
         ...
         */
        getAliasVerification: function (aliasId, emailAddress, verificationToken, options) {
            return exports.AliasControllerApiFp(configuration).getAliasVerification(aliasId, emailAddress, verificationToken, options)(fetch, basePath);
        },
        /**
         * Get all email aliases in paginated form
         * @summary Get all email aliases you have created
...
var AliasControllerApi = /** @class */ (function (_super) {
     ...
     * @memberof AliasControllerApi
     */
    AliasControllerApi.prototype.getAliasVerification = function (aliasId, emailAddress, verificationToken, options) {
        return exports.AliasControllerApiFp(this.configuration).getAliasVerification(aliasId, emailAddress, verificationToken, options)(this.fetch, this.basePath);
    };
    /**
     * Get all email aliases in paginated form
     * @summary Get all email aliases you have created
