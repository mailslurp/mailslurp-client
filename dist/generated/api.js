 ...
 *
 * OpenAPI spec version: f6bb5b4dc2a9e5fd267bb8f503ad6bac7bea944e
 *
 *
...
var CommonActionsControllerApiFetchParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createNewEmailAddress: function (expiresAt, expiresIn, useDomainPool, options) {
            if (options === void 0) { options = {}; }
         ...
         * @throws {RequiredError}
         */
        createNewEmailAddress1: function (expiresAt, expiresIn, useDomainPool, options) {
            if (options === void 0) { options = {}; }
...
var CommonActionsControllerApiFp = function (configuration) {
    return {
         ...
         */
        createNewEmailAddress: function (expiresAt, expiresIn, useDomainPool, options) {
            var localVarFetchArgs = exports.CommonActionsControllerApiFetchParamCreator(configuration).createNewEmailAddress(expiresAt, expiresIn, useDomainPool, options);
            return function (fetch, basePath) {
                if (fetch === void 0) { fetch = portableFetch; }
                if (basePath === void 0) { basePath = BASE_PATH; }
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then(function (response) {
         ...
         */
        createNewEmailAddress1: function (expiresAt, expiresIn, useDomainPool, options) {
            var localVarFetchArgs = exports.CommonActionsControllerApiFetchParamCreator(configuration).createNewEmailAddress1(expiresAt, expiresIn, useDomainPool, options);
            return function (fetch, basePath) {
                if (fetch === void 0) { fetch = portableFetch; }
                if (basePath === void 0) { basePath = BASE_PATH; }
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then(function (response) {
...
var CommonActionsControllerApiFactory = function (configuration, fetch, basePath) {
    return {
         ...
         */
        createNewEmailAddress: function (expiresAt, expiresIn, useDomainPool, options) {
            return exports.CommonActionsControllerApiFp(configuration).createNewEmailAddress(expiresAt, expiresIn, useDomainPool, options)(fetch, basePath);
        },
        /**
         * Returns an Inbox with an `id` and an `emailAddress`
         * @summary Create new random inbox
         ...
         */
        createNewEmailAddress1: function (expiresAt, expiresIn, useDomainPool, options) {
            return exports.CommonActionsControllerApiFp(configuration).createNewEmailAddress1(expiresAt, expiresIn, useDomainPool, options)(fetch, basePath);
        },
        /**
         * Deletes all emails
         * @summary Delete all emails in an inbox
...
var CommonActionsControllerApi = /** @class */ (function (_super) {
     ...
     */
    CommonActionsControllerApi.prototype.createNewEmailAddress = function (expiresAt, expiresIn, useDomainPool, options) {
        return exports.CommonActionsControllerApiFp(this.configuration).createNewEmailAddress(expiresAt, expiresIn, useDomainPool, options)(this.fetch, this.basePath);
    };
    /**
     * Returns an Inbox with an `id` and an `emailAddress`
     * @summary Create new random inbox
     ...
     * @memberof CommonActionsControllerApi
     */
    CommonActionsControllerApi.prototype.createNewEmailAddress1 = function (expiresAt, expiresIn, useDomainPool, options) {
        return exports.CommonActionsControllerApiFp(this.configuration).createNewEmailAddress1(expiresAt, expiresIn, useDomainPool, options)(this.fetch, this.basePath);
    };
    /**
     * Deletes all emails
     * @summary Delete all emails in an inbox
...
var InboxControllerApiFetchParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createInbox: function (description, emailAddress, expiresAt, expiresIn, favourite, name, tags, useDomainPool, options) {
            if (options === void 0) { options = {}; }
         ...
         * @throws {RequiredError}
         */
        getExpiredInboxRecordById: function (expiredId, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'expiredId' is not null or undefined
            if (expiredId === null || expiredId === undefined) {
                throw new RequiredError('expiredId', 'Required parameter expiredId was null or undefined when calling getExpiredInboxRecordById.');
            }
            var localVarPath = "/inboxes/expired-records/{expiredId}".replace("{" + 'expiredId' + "}", encodeURIComponent(String(expiredId)));
            var localVarUrlObj = url.parse(localVarPath, true);
            var localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            var localVarHeaderParameter = {};
            var localVarQueryParameter = {};
         ...
         * @throws {RequiredError}
         */
        getExpiredInboxRecordByInboxId: function (inboxId, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'inboxId' is not null or undefined
            if (inboxId === null || inboxId === undefined) {
                throw new RequiredError('inboxId', 'Required parameter inboxId was null or undefined when calling getExpiredInboxRecordByInboxId.');
            }
            var localVarPath = "/inboxes/{inboxId}/expired-record".replace("{" + 'inboxId' + "}", encodeURIComponent(String(inboxId)));
            var localVarUrlObj = url.parse(localVarPath, true);
            var localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            var localVarHeaderParameter = {};
            var localVarQueryParameter = {};
         ...
         * @throws {RequiredError}
         */
        getExpiredInboxRecords: function (page, size, sort, options) {
            if (options === void 0) { options = {}; }
            var localVarPath = "/inboxes/expired-records";
            var localVarUrlObj = url.parse(localVarPath, true);
            var localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            var localVarHeaderParameter = {};
            var localVarQueryParameter = {};
...
var InboxControllerApiFp = function (configuration) {
    return {
         ...
         */
        createInbox: function (description, emailAddress, expiresAt, expiresIn, favourite, name, tags, useDomainPool, options) {
            var localVarFetchArgs = exports.InboxControllerApiFetchParamCreator(configuration).createInbox(description, emailAddress, expiresAt, expiresIn, favourite, name, tags, useDomainPool, options);
            return function (fetch, basePath) {
                if (fetch === void 0) { fetch = portableFetch; }
                if (basePath === void 0) { basePath = BASE_PATH; }
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then(function (response) {
         ...
         */
        getExpiredInboxRecordById: function (expiredId, options) {
            var localVarFetchArgs = exports.InboxControllerApiFetchParamCreator(configuration).getExpiredInboxRecordById(expiredId, options);
            return function (fetch, basePath) {
                if (fetch === void 0) { fetch = portableFetch; }
                if (basePath === void 0) { basePath = BASE_PATH; }
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then(function (response) {
         ...
         */
        getExpiredInboxRecordByInboxId: function (inboxId, options) {
            var localVarFetchArgs = exports.InboxControllerApiFetchParamCreator(configuration).getExpiredInboxRecordByInboxId(inboxId, options);
            return function (fetch, basePath) {
                if (fetch === void 0) { fetch = portableFetch; }
                if (basePath === void 0) { basePath = BASE_PATH; }
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then(function (response) {
         ...
         */
        getExpiredInboxRecords: function (page, size, sort, options) {
            var localVarFetchArgs = exports.InboxControllerApiFetchParamCreator(configuration).getExpiredInboxRecords(page, size, sort, options);
            return function (fetch, basePath) {
                if (fetch === void 0) { fetch = portableFetch; }
                if (basePath === void 0) { basePath = BASE_PATH; }
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then(function (response) {
...
var InboxControllerApiFactory = function (configuration, fetch, basePath) {
    return {
         ...
         */
        createInbox: function (description, emailAddress, expiresAt, expiresIn, favourite, name, tags, useDomainPool, options) {
            return exports.InboxControllerApiFp(configuration).createInbox(description, emailAddress, expiresAt, expiresIn, favourite, name, tags, useDomainPool, options)(fetch, basePath);
        },
        /**
         * Additional endpoint that allows inbox creation with request body options. Can be more flexible that other methods for some clients.
         * @summary Create an inbox with additional options
         ...
         */
        getExpiredInboxRecordById: function (expiredId, options) {
            return exports.InboxControllerApiFp(configuration).getExpiredInboxRecordById(expiredId, options)(fetch, basePath);
        },
        /**
         * Use the inboxId to return an ExpiredInboxRecord if an inbox has expired. Inboxes expire and are disabled if an expiration date is set or plan requires. Returns 404 if no expired inbox is found for the inboxId
         * @summary Get expired inbox record for a previously existing inbox
         ...
         */
        getExpiredInboxRecordByInboxId: function (inboxId, options) {
            return exports.InboxControllerApiFp(configuration).getExpiredInboxRecordByInboxId(inboxId, options)(fetch, basePath);
        },
        /**
         * Inboxes created with an expiration date will expire after the given date. An ExpiredInboxRecord is created that records the inboxes old ID and email address. You can still read emails in the inbox (using the inboxes old ID) but the email address associated with the inbox can no longer send or receive emails. Fetch expired inbox records to view the old inboxes properties
         * @summary List records of expired inboxes
         ...
         */
        getExpiredInboxRecords: function (page, size, sort, options) {
            return exports.InboxControllerApiFp(configuration).getExpiredInboxRecords(page, size, sort, options)(fetch, basePath);
        },
        /**
         * Returns an inbox's properties, including its email address and ID.
         * @summary Get Inbox
...
var InboxControllerApi = /** @class */ (function (_super) {
     ...
     */
    InboxControllerApi.prototype.createInbox = function (description, emailAddress, expiresAt, expiresIn, favourite, name, tags, useDomainPool, options) {
        return exports.InboxControllerApiFp(this.configuration).createInbox(description, emailAddress, expiresAt, expiresIn, favourite, name, tags, useDomainPool, options)(this.fetch, this.basePath);
    };
    /**
     * Additional endpoint that allows inbox creation with request body options. Can be more flexible that other methods for some clients.
     * @summary Create an inbox with additional options
     ...
     * @memberof InboxControllerApi
     */
    InboxControllerApi.prototype.getExpiredInboxRecordById = function (expiredId, options) {
        return exports.InboxControllerApiFp(this.configuration).getExpiredInboxRecordById(expiredId, options)(this.fetch, this.basePath);
    };
    /**
     * Use the inboxId to return an ExpiredInboxRecord if an inbox has expired. Inboxes expire and are disabled if an expiration date is set or plan requires. Returns 404 if no expired inbox is found for the inboxId
     * @summary Get expired inbox record for a previously existing inbox
     ...
     * @memberof InboxControllerApi
     */
    InboxControllerApi.prototype.getExpiredInboxRecordByInboxId = function (inboxId, options) {
        return exports.InboxControllerApiFp(this.configuration).getExpiredInboxRecordByInboxId(inboxId, options)(this.fetch, this.basePath);
    };
    /**
     * Inboxes created with an expiration date will expire after the given date. An ExpiredInboxRecord is created that records the inboxes old ID and email address. You can still read emails in the inbox (using the inboxes old ID) but the email address associated with the inbox can no longer send or receive emails. Fetch expired inbox records to view the old inboxes properties
     * @summary List records of expired inboxes
     ...
     * @memberof InboxControllerApi
     */
    InboxControllerApi.prototype.getExpiredInboxRecords = function (page, size, sort, options) {
        return exports.InboxControllerApiFp(this.configuration).getExpiredInboxRecords(page, size, sort, options)(this.fetch, this.basePath);
    };
    /**
     * Returns an inbox's properties, including its email address and ID.
     * @summary Get Inbox
