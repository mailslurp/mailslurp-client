...
function JsonNodeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        bigDecimal: !runtime_1.exists(json, 'bigDecimal')
            ? undefined
            : json['bigDecimal'],
        bigInteger: !runtime_1.exists(json, 'bigInteger')
            ? undefined
            : json['bigInteger'],
        binary: !runtime_1.exists(json, 'binary') ? undefined : json['binary'],
        _boolean: !runtime_1.exists(json, 'boolean') ? undefined : json['boolean'],
        containerNode: !runtime_1.exists(json, 'containerNode')
            ? undefined
            : json['containerNode'],
        ...
        floatingPointNumber: !runtime_1.exists(json, 'floatingPointNumber')
            ? undefined
            : json['floatingPointNumber'],
        _int: !runtime_1.exists(json, 'int') ? undefined : json['int'],
        integralNumber: !runtime_1.exists(json, 'integralNumber')
            ? undefined
            : json['integralNumber'],
        _long: !runtime_1.exists(json, 'long') ? undefined : json['long'],
        missingNode: !runtime_1.exists(json, 'missingNode')
            ? undefined
            : json['missingNode'],
